...
{
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty Name \"\" }", "FuseChannelBasic", "TcoPneumatics", TypeComplexityEnum.Complex)]
	public partial class FuseChannelBasic : Vortex.Connector.IVortexObject, IFuseChannelBasic, IShadowFuseChannelBasic, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		public void FlushPlainToOnline(TcoPneumatics.PlainFuseChannelBasic source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(TcoPneumatics.PlainFuseChannelBasic source)
		{
		...
		public void FlushOnlineToPlain(TcoPneumatics.PlainFuseChannelBasic source)
		{
			this.Read();
	...
	public partial interface IFuseChannelBasic : Vortex.Connector.IVortexOnlineObject
	{
		...
		TcoPneumatics.PlainFuseChannelBasic CreatePlainerType();
		void FlushOnlineToShadow();
		void FlushPlainToOnline(TcoPneumatics.PlainFuseChannelBasic source);
		void FlushOnlineToPlain(TcoPneumatics.PlainFuseChannelBasic source);
	}
	...
	public partial interface IShadowFuseChannelBasic : Vortex.Connector.IVortexShadowObject
	{
		...
		void CopyPlainToShadow(TcoPneumatics.PlainFuseChannelBasic source);
	}
	...
	public partial class PlainFuseChannelBasic : System.ComponentModel.INotifyPropertyChanged, Vortex.Connector.IPlain
	{
		...
		public void CopyPlainToCyclic(TcoPneumatics.FuseChannelBasic target)
		{
			_Chn.CopyPlainToCyclic(target._Chn);
		}

		public void CopyPlainToCyclic(TcoPneumatics.IFuseChannelBasic target)
		{
			this.CopyPlainToCyclic((TcoPneumatics.FuseChannelBasic)target);
		}

		public void CopyPlainToShadow(TcoPneumatics.FuseChannelBasic target)
		{
			_Chn.CopyPlainToShadow(target._Chn);
		}

		public void CopyPlainToShadow(TcoPneumatics.IShadowFuseChannelBasic target)
		{
			this.CopyPlainToShadow((TcoPneumatics.FuseChannelBasic)target);
		}

		public void CopyCyclicToPlain(TcoPneumatics.FuseChannelBasic source)
		{
			_Chn.CopyCyclicToPlain(source._Chn);
		}

		public void CopyCyclicToPlain(TcoPneumatics.IFuseChannelBasic source)
		{
			this.CopyCyclicToPlain((TcoPneumatics.FuseChannelBasic)source);
		}

		public void CopyShadowToPlain(TcoPneumatics.FuseChannelBasic source)
		{
			_Chn.CopyShadowToPlain(source._Chn);
		}

		public void CopyShadowToPlain(TcoPneumatics.IShadowFuseChannelBasic source)
		{
			this.CopyShadowToPlain((TcoPneumatics.FuseChannelBasic)source);
		}
