...
{
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty Name \"\" }", "EL922x_ChannelExtended", "TcoPneumatics", TypeComplexityEnum.Complex)]
	public partial class EL922x_ChannelExtended : Vortex.Connector.IVortexObject, IEL922x_ChannelExtended, IShadowEL922x_ChannelExtended, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		public void FlushPlainToOnline(TcoPneumatics.PlainEL922x_ChannelExtended source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(TcoPneumatics.PlainEL922x_ChannelExtended source)
		{
		...
		public void FlushOnlineToPlain(TcoPneumatics.PlainEL922x_ChannelExtended source)
		{
			this.Read();
	...
	public partial interface IEL922x_ChannelExtended : Vortex.Connector.IVortexOnlineObject
	{
		...
		TcoPneumatics.PlainEL922x_ChannelExtended CreatePlainerType();
		void FlushOnlineToShadow();
		void FlushPlainToOnline(TcoPneumatics.PlainEL922x_ChannelExtended source);
		void FlushOnlineToPlain(TcoPneumatics.PlainEL922x_ChannelExtended source);
	}
	...
	public partial interface IShadowEL922x_ChannelExtended : Vortex.Connector.IVortexShadowObject
	{
		...
		void CopyPlainToShadow(TcoPneumatics.PlainEL922x_ChannelExtended source);
	}
	...
	public partial class PlainEL922x_ChannelExtended : System.ComponentModel.INotifyPropertyChanged, Vortex.Connector.IPlain
	{
		...
		public void CopyPlainToCyclic(TcoPneumatics.EL922x_ChannelExtended target)
		{
		...
		public void CopyPlainToCyclic(TcoPneumatics.IEL922x_ChannelExtended target)
		{
			this.CopyPlainToCyclic((TcoPneumatics.EL922x_ChannelExtended)target);
		}

		public void CopyPlainToShadow(TcoPneumatics.EL922x_ChannelExtended target)
		{
		...
		public void CopyPlainToShadow(TcoPneumatics.IShadowEL922x_ChannelExtended target)
		{
			this.CopyPlainToShadow((TcoPneumatics.EL922x_ChannelExtended)target);
		}

		public void CopyCyclicToPlain(TcoPneumatics.EL922x_ChannelExtended source)
		{
		...
		public void CopyCyclicToPlain(TcoPneumatics.IEL922x_ChannelExtended source)
		{
			this.CopyCyclicToPlain((TcoPneumatics.EL922x_ChannelExtended)source);
		}

		public void CopyShadowToPlain(TcoPneumatics.EL922x_ChannelExtended source)
		{
		...
		public void CopyShadowToPlain(TcoPneumatics.IShadowEL922x_ChannelExtended source)
		{
			this.CopyShadowToPlain((TcoPneumatics.EL922x_ChannelExtended)source);
		}
