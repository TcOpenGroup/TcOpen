...
{
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty Name \"\" }", "EL922x_ChannelBasic", "TcoPneumatics", TypeComplexityEnum.Complex)]
	public partial class EL922x_ChannelBasic : Vortex.Connector.IVortexObject, IEL922x_ChannelBasic, IShadowEL922x_ChannelBasic, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		public void FlushPlainToOnline(TcoPneumatics.PlainEL922x_ChannelBasic source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(TcoPneumatics.PlainEL922x_ChannelBasic source)
		{
		...
		public void FlushOnlineToPlain(TcoPneumatics.PlainEL922x_ChannelBasic source)
		{
			this.Read();
	...
	public partial interface IEL922x_ChannelBasic : Vortex.Connector.IVortexOnlineObject
	{
		...
		TcoPneumatics.PlainEL922x_ChannelBasic CreatePlainerType();
		void FlushOnlineToShadow();
		void FlushPlainToOnline(TcoPneumatics.PlainEL922x_ChannelBasic source);
		void FlushOnlineToPlain(TcoPneumatics.PlainEL922x_ChannelBasic source);
	}
	...
	public partial interface IShadowEL922x_ChannelBasic : Vortex.Connector.IVortexShadowObject
	{
		...
		void CopyPlainToShadow(TcoPneumatics.PlainEL922x_ChannelBasic source);
	}
	...
	public partial class PlainEL922x_ChannelBasic : System.ComponentModel.INotifyPropertyChanged, Vortex.Connector.IPlain
	{
		...
		public void CopyPlainToCyclic(TcoPneumatics.EL922x_ChannelBasic target)
		{
			Status.CopyPlainToCyclic(target.Status);
			Control.CopyPlainToCyclic(target.Control);
		}

		public void CopyPlainToCyclic(TcoPneumatics.IEL922x_ChannelBasic target)
		{
			this.CopyPlainToCyclic((TcoPneumatics.EL922x_ChannelBasic)target);
		}

		public void CopyPlainToShadow(TcoPneumatics.EL922x_ChannelBasic target)
		{
			Status.CopyPlainToShadow(target.Status);
			Control.CopyPlainToShadow(target.Control);
		}

		public void CopyPlainToShadow(TcoPneumatics.IShadowEL922x_ChannelBasic target)
		{
			this.CopyPlainToShadow((TcoPneumatics.EL922x_ChannelBasic)target);
		}

		public void CopyCyclicToPlain(TcoPneumatics.EL922x_ChannelBasic source)
		{
			Status.CopyCyclicToPlain(source.Status);
			Control.CopyCyclicToPlain(source.Control);
		}

		public void CopyCyclicToPlain(TcoPneumatics.IEL922x_ChannelBasic source)
		{
			this.CopyCyclicToPlain((TcoPneumatics.EL922x_ChannelBasic)source);
		}

		public void CopyShadowToPlain(TcoPneumatics.EL922x_ChannelBasic source)
		{
			Status.CopyShadowToPlain(source.Status);
			Control.CopyShadowToPlain(source.Control);
		}

		public void CopyShadowToPlain(TcoPneumatics.IShadowEL922x_ChannelBasic source)
		{
			this.CopyShadowToPlain((TcoPneumatics.EL922x_ChannelBasic)source);
		}
