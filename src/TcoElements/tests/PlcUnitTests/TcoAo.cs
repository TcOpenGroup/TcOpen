    ...
    public class TcoAo
    {
        ...
        public void T100_UnsignedRawTest(double required, float setVal,  int epsilon)
        {
            ...
            sut.Run(1, 100);
             ...
             //-- Assert
            var isEqual = ((sut._UnscaledResult.Synchron - epsilon) <= required) && (required <= (sut._UnscaledResult.Synchron + epsilon));
            if (!isEqual)
            {
                Assert.AreEqual("Expecting `equal` values", sut._sut._messenger._mime.Text.Synchron);
            }
        ...
        [TestCase(0, -100, 0)]
        public void T100_UnsignedRaw_RealSignedOffsetTest(double required, float setVal, int epsilon)
        {
        ...
        [TestCase(16404, 0, 1)]
        [TestCase(20, -100, 0)]
        public void T100_UnsignedRaw_RealSignedOffset_WithOffsetCorrectionTest(double required, float setVal, int epsilon)
        {
        ...
        public void T100_SignedRaw_RealSignedOffset_WithOffsetCorrectionTest(double required, float setVal, int epsilon)
        {
