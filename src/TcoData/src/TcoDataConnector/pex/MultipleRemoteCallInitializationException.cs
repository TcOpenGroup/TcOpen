...
namespace TcoData
{
    public class MultipleRemoteCallInitializationException : Exception
    {
        ...
        public MultipleRemoteCallInitializationException(string message)
            : base(message) { }
        ...
        public MultipleRemoteCallInitializationException(string message, Exception innerException)
