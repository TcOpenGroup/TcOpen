...
namespace TcoData
{
    public class BrowsableObjectCreationException : Exception
    {
        ...
        public BrowsableObjectCreationException(string message) : base(message)
        {
        ...
        public BrowsableObjectCreationException(string message, Exception innerException) : base(message, innerException)
        {
        ...
        protected BrowsableObjectCreationException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
