    ...
    public class T01_TcoDriveSimpleTests
    {
        ...
        public void T007_MoveRelativePositiveWithDisabledPositiveDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveRelativePositiveWithDisabledPositiveDirection
                );
            }
        ...
        public void T008_MoveRelativePositiveWithEnabledPositiveDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveRelativePositiveWithEnabledPositiveDirection
                );
            }
            double actpos = tc._sut._axisStatus.ActPos.Synchron;
            double setpos = 1000;
        ...
        public void T009_MoveRelativeNegativeWithDisabledNegativeDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveRelativeNegativeWithDisabledNegativeDirection
                );
            }
            double actpos = tc._sut._axisStatus.ActPos.Synchron;
            double setpos = -1000;
        ...
        public void T010_MoveRelativeNegativeWithEnabledNegativeDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveRelativeNegativeWithEnabledNegativeDirection
                );
            }
            double actpos = tc._sut._axisStatus.ActPos.Synchron;
            double setpos = -1000;
        ...
        public void T012_MoveVelocityPositiveWithDisabledPositiveDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveVelocityPositiveWithDisabledPositiveDirection
                );
            }
        ...
        public void T013_MoveVelocityPositiveWithEnabledPositiveDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveVelocityPositiveWithEnabledPositiveDirection
                );
            }
            double startpos = tc._sut._axisStatus.ActPos.Synchron;
            double velocity = 1300;
        ...
        public void T015_MoveVelocityNegativeWithDisabledNegativeDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveVelocityNegativeWithDisabledNegativeDirection
                );
            }
            double startpos = tc._sut._axisStatus.ActPos.Synchron;
            double velocity = 1300;
        ...
        public void T016_MoveVelocityNegativeWithEnabledNegativeDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveVelocityNegativeWithEnabledNegativeDirection
                );
            }
            double startpos = tc._sut._axisStatus.ActPos.Synchron;
            double velocity = 1300;
        ...
        [Test, Order((int)eTcoDriveSimpleTests.MoveAbsoluteDisabled)]
        public void T017_MoveAbsoluteDisabled()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(1, (int)eTcoDriveSimpleTests.MoveAbsoluteDisabled);
            }
            double actpos = tc._sut._axisStatus.ActPos.Synchron;
            double setpos = 1000;
            tc._position.Synchron = setpos;
            ...
            tc._jerk.Synchron = 150000;
            tc.ExecuteProbeRun(
                (int)eTcoDriveSimpleTests.MoveAbsoluteDisabled,
                () => tc._done.Synchron
            );
#if WITH_HARDWARE
        ...
        public void T018_MoveAbsoluteDisabledPositiveDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveAbsoluteDisabledPositiveDirection
                );
            }
            double actpos = tc._sut._axisStatus.ActPos.Synchron;
            double setpos = 1000;
        ...
        [Test, Order((int)eTcoDriveSimpleTests.MoveAbsoluteEnabledPositiveDirection)]
        public void T019_MoveAbsoluteEnabledPositiveDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveAbsoluteEnabledPositiveDirection
                );
            }
            double actpos = tc._sut._axisStatus.ActPos.Synchron;
            double setpos = 1000;
        ...
        [Test, Order((int)eTcoDriveSimpleTests.MoveAbsoluteDisabledNegativeDirection)]
        public void T020_MoveAbsoluteDisabledNegativeDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveAbsoluteDisabledNegativeDirection
                );
            }
            double actpos = tc._sut._axisStatus.ActPos.Synchron;
            double setpos = 1000;
        ...
        [Test, Order((int)eTcoDriveSimpleTests.MoveAbsoluteEnabledNegativeDirection)]
        public void T021_MoveAbsoluteEnabledNegativeDirection()
        {
            while (!tc._arranged.Synchron)
            {
                tc.ExecuteProbeRun(
                    1,
                    (int)eTcoDriveSimpleTests.MoveAbsoluteEnabledNegativeDirection
                );
            }
            double actpos = tc._sut._axisStatus.ActPos.Synchron;
            double setpos = 1000;
            ...
            Assert.IsFalse(tc._sut._axisStatus.Error.Synchron);
            Assert.AreEqual(0, tc._sut._axisStatus.ErrorId.Synchron); //"No enable for controller and/or feed (Master axis)"
            Assert.AreEqual(actpos - setpos, tc._sut._axisStatus.ActPos.Synchron, 1);
        }
    }
}
