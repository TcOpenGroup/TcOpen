...
namespace TcoDrivesBeckhoff
{
    public partial class TcoDriveSimple
    {
        ...
        partial void PexConstructor(IVortexObject parent, string readableTail, string symbolTail)
        {
            ...
            this._setPositionTask.LogPayloadDecoration = () =>
                this._setPositionTask.GetPlainFromOnline();
            ...
            this._moveAbsoluteTask.LogPayloadDecoration = () =>
                this._moveAbsoluteTask.GetPlainFromOnline();
            this._moveRelativeTask.LogPayloadDecoration = () =>
                this._moveRelativeTask.GetPlainFromOnline();
            this._moveModuloTask.LogPayloadDecoration = () =>
                this._moveModuloTask.GetPlainFromOnline();
            this._moveVelocityTask.LogPayloadDecoration = () =>
                this._moveVelocityTask.GetPlainFromOnline();
        ...
        public string AdvancedDiagnosticMessage
        {
            get
            {
                ...
                if (NcErrors.Errors.ContainsKey(errorCode))
                    additionalInfo = NcErrors
                        .Errors.Where(key => key.Key == errorCode)
                        .FirstOrDefault()
                        .Value;
    ...
    public static class NcErrors
    {
        public static IDictionary<uint, string> Errors = new Dictionary<uint, string>()
        {
            ...
            {
                16384,
                @"'Internal error' Internal system error in the NC on ring 0, no further details."
            },
            {
                16385,
                @"'Memory error' The ring-0 memory management is not providing the required memory. This is usually a result of another error, as a result of which the controller will halt normal operation (now if not before)."
            },
            {
                16386,
                @"'Nc retain data error (persistent data)' Error while loading the Nc retain data. The axes concerned are no longer referenced (status flag 'Homed' is set to FALSE).
            ...
            {
                16387,
                @"'Parameter for Monitoring the NC Setpoint Issuing is Invalid
            ...
            {
                16400,
                @"'Channel identifier not allowed' Either an unacceptable value (not 1...255) has been used, or a channel that does not exist in the system has been named."
            },
            {
                16401,
                @"'Group identifier not allowed' Either an unacceptable value (not 1...255) has been used, or a group that does not exist in the system has been named."
            },
            {
                16402,
                @"'Axis identifier not allowed' Either an unacceptable value (not 1...255) has been used, or an axis that does not exist in the system has been named."
            },
            {
                16403,
                @"'Encoder identifier not allowed' Either an unacceptable value (not 1...255) has been used, or a encoder that does not exist in the system has been named."
            },
            {
                16404,
                @"'Controller identifier not allowed' Either an unacceptable value (not 1...255) has been used, or a controller that does not exist in the system has been named."
            },
            {
                16405,
                @"'Drive identifier not allowed' Either an unacceptable value (not 1...255) has been used, or a drive that does not exist in the system has been named."
            },
            {
                16406,
                @"'Table identifier not allowed' Either an unacceptable value (not 1...255) has been used, or a table that does not exist in the system has been named."
            },
            ...
            {
                16433,
                @"'Axis type not allowed' Unacceptable type specification during creation of an axis."
            },
            {
                16434,
            ...
            {
                16448,
                @"'Axis is incompatible' Axis is not suitable for the intended purpose. A high speed/low speed axis, for example, cannot function as a slave in an axis coupling."
            },
            {
                16464,
                @"'Channel not ready for operation' The channel is not complete, and is therefore not ready for operation. This is usually a consequence of problems at system start-up."
            },
            {
                16465,
                @"'Group not ready for operation' The group is not complete, and is therefore not ready for operation. This is usually a consequence of problems at system start-up."
            },
            {
                16466,
                @"'Axis not ready for operation' The axis is not complete, and is therefore not ready for operation. This is usually a consequence of problems at system start-up."
            },
            ...
            {
                16483,
                @"'Table exists' The table that is to be created already exists, resp. it is tried internally to use an already existing table id ( e.g. for the universal flying saw)."
            },
            {
                16496,
                @"'Axis index not allowed' The location within the channel specified for an axis is not allowed."
            },
            {
                16497,
                @"'Axis index not allowed' The location within the group specified for an axis is not allowed."
            },
            {
                16641,
                @"'Group index not allowed' The location within the channel specified for a group is not allowed."
            },
            {
                16642,
                @"'Null pointer' The pointer to the group is invalid. This is usually a consequence of an error at system start-up."
            },
            {
                16643,
                @"'No process image' It is not possible to exchange data with the PLC. Possible causes: n the channel does not have an interface (no interpreter present) n The connection to the PLC is faulty"
            },
            {
                16644,
                @"'M-function index not allowed' Unacceptable M-function (not 0...159) detected at the execution level."
            },
            {
                16645,
                @"'No memory' No more system memory is available. This is usually the result of another error."
            },
            {
                16646,
                @"'Not ready' The function is not presently available, because a similar function is already being processed. This is usually the result of access conflicts: more than one instance wants to issue commands to the channel. This can, for example, be the consequence of an incorrect PLC //program."
            },
            {
                16647,
                @"'Function/command not supported' A requested function or command is not supported by the channel."
            },
            {
                16648,
                @"'Invalid parameter while starting' Parameters to start the channel (TwinCAT-Start) are invalid. Typically there is an invalid memory size or channel type requested."
            },
            {
                16649,
                @"'Channel function/command not executable' A channel function e.g. interpreter start is not executable because the channel is already busy, no program is loaded or in an error state."
            },
            {
                16650,
                @"'ItpGoAhead not executable' The requested command is not executable, because the interpreter is not executing a decoder stop."
            },
            {
                16656,
                @"'Error opening a file' The specified file does not exist. Sample: NC program unknown."
            },
            {
                16657,
                @"'Syntax error during loading' The NC has found a syntax error when loading an NC program."
            },
            {
                16658,
                @"'Syntax error during interpretation' The NC has found a syntax error when executing an NC program."
            },
            { 16659, @"'Missing subroutine' The NC has found a missing subroutine while loading." },
            {
                16660,
                @"'Loading buffer of interpreter is too small' The capacity of the interpreter loading buffer has been exceeded."
            },
            ...
            {
                16664,
                @"'Error while loading the NC program' The maximum number of loadable NC programs has been reached.
                    Possible cause:
            ...
            {
                16672,
                @"'Divide by zero' The NC encountered a computation error during execution: division by 0."
            },
            {
                16673,
                @"'Invalid circle parameterization' The NC encountered a computation error during execution: The specified circle cannot be calculated."
            },
            {
                16674,
                @"'Invalid FPU-Operation' The NC encountered an invalid FPU-Operation during execution. This error occurs e.g. by calculating the square root of a negative number."
            },
            {
                16688,
                @"'Stack overflow: subroutines' The NC encountered a stack overflow during execution: too many subroutine levels."
            },
            {
                16689,
                @"'Stack underflow: subroutines' The NC encountered a stack underflow during execution: too many subroutine return commands. Note: A main program must not end with a return command."
            },
            {
                16690,
                @"'Stack overflow: arithmetic unit' The NC encountered a stack overflow during execution: The calculation is too complex, or has not been correctly written."
            },
            {
                16691,
                @"'Stack underflow: arithmetic unit' The NC encountered a stack underflow during execution: The calculation is too complex, or has not been correctly written."
            },
            {
                16704,
                @"'Register index not allowed' The NC encountered an unacceptable register index during execution: Either the program contains an unacceptable value (not R0...R999) or a pointer register contains an unacceptable value."
            },
            {
                16705,
                @"'Unacceptable G-function index' The NC has encountered an unacceptable G-function (not 0...159) during execution."
            },
            {
                16706,
                @"'Unacceptable M-function index' The NC has encountered an unacceptable M-function (not 0...159) during execution."
            },
            {
                16707,
                @"'Unacceptable extended address' The NC has encountered an unacceptable extended address (not 1...9) during execution."
            },
            {
                16708,
                @"'Unacceptable index to the internal H-function' The NC has encountered an unacceptable internal H-function in the course of processing. This is usually a consequence of an error during loading."
            },
            {
                16709,
                @"'Machine data value unacceptable' While processing instructions the NC has detected an impermissible value for the machine data (MDB) (not 0…7)."
            },
            {
                16720,
                @"'Cannot change tool params here' The NC has encountered an unacceptable change of parameters for the tool compensation during execution. This error occurred for instance by changing the tool radius and programming a circle in the same block."
            },
            {
                16721,
                @"'Cannot calculate tool compensation' The NC has encountered an error by the calculation of the tool compensation."
            },
            {
                16722,
                @"'Tool compensation: The plane for the tool compensation cannot be changed here. This error occurred for instance by changing the tool plane when the compensation is turned on or active."
            },
            {
                16723,
                @"'Tool compensation: The D-Word is missing or invalid by turning on the tool compensation."
            },
            {
                16724,
                @"'Tool compensation: The specified tool radius is invalid because the value is less or equal zero."
            },
            { 16725, @"'Tool compensation: The tool radius cannot be changed here" },
            { 16726, @"'Tool compensation: Collision Detection Table is full." },
            {
                16727,
                @"'Tool compensation: Internal error while turning on the contour collision detection."
            },
            {
                16728,
                @"'Tool compensation: Internal error within the contour collision detection: update reversed geo failed."
            },
            {
                16729,
                @"'Tool compensation: Unexpected combination of geometry types by active contour collision detection."
            },
            {
                16730,
                @"'Tool compensation: Programmed inner circle is smaller than the cutter radius"
            },
            ...
            {
                16738,
                @"'The actual active interpolation rules (g-code), zero-shifts, or rotation cannot be detected"
            },
            {
                16752,
                @"'Error while loading: Invalid parameter' The NC has found an invalid parameter while loading an NC program."
            },
            {
                16753,
                @"'Invalid contour start position' The NC encountered a computation error during execution: The specified contour cannot be calculated because the initial position is not on the contour."
            },
            {
                16754,
                @"'Retrace: Invalid internal entry index' The NC encountered an invalid internal entry index during execution of the retrace function."
            },
            {
                16755,
                @"'Invalid G Code
            ...
            {
                16756,
                @"'Error while Opening the G Code File
            ...
            {
                16898,
                @"'Master axis index not allowed' The value for the master axis index in an interpolating 3D group is not allowed, because, for instance, it has gone outside the value range. Index 0: X axis (first master axis) Index 1: Y axis (second master axis) Index 2 : Z axis (third master //axis)"
            },
            {
                16899,
            ...
            {
                16901,
                @"'Invalid cycle time for statement execution task (SAF)' The value of the cycle time for the NC block execution task (SAF 1/2) is not allowed, because it has passed outside the value range."
            },
            { 16902, @"'GROUPERR_RANGE_MAXELEMENTSINAXIS '" },
            {
                16903,
                @"'Invalid cycle time for the statement preparation task (SVB)' The value of the cycle time for the NC statement preparation task (SVB 1/2) is not allowed, because it has passed outside the value range."
            },
            {
                16904,
                @"'Single step mode not allowed' The flag for the activation or deactivation of single step mode is not allowed. Value 0: Passive (buffered operation) Value 1: Active (single-block operation)"
            },
            {
                16905,
                @"'Group deactivation not allowed' (INTERNAL ERROR) The flag for the deactivation or activation of the complete group is not allowed. Value 0: Group active Value 1: Group passive"
            },
            {
                16906,
                @"'Statement execution state (SAF state) not allowed' (INTERNAL ERROR) The value for the state of the block execution state machine (SAF state) is not allowed. This error occurs on passing outside the range of values, or if the state machine enters an error state."
            },
            {
                16907,
                @"'Channel address' The group does not have a channel, or the channel address has not been initialized."
            },
            {
                16908,
                @"'Axis address (master axis)' The group does not have a master axis (or axes) or the axis address(es) has (have) not been initialized."
            },
            {
                16909,
                @"'Master axis address' A new master/slave coupling is to be inserted into the group, but there is no valid address for the leading master axis."
            },
            {
                16910,
                @"'Slave axis address' A master/slave coupling is to be inserted into the group, but there is no valid address for the slave axis."
            },
            {
                16911,
                @"'Slave set value generator address' A master/slave coupling is to be inserted into the group, but there is no valid address for the slave set value generator."
            },
            {
                16912,
                @"'Encoder address' An axis in the group does not have an encoder, or the encoder address has not been initialized."
            },
            {
                16913,
                @"'Controller address' An axis in the group does not have a controller, or the controller address has not been initialized."
            },
            {
                16914,
                @"'Drive address' An axis in the group does not have a drive, or the drive address has not been initialized."
            },
            {
                16915,
                @"'Address Master Setpoint Generator
            ...
            {
                16916,
                @"'Axis interface NC to PLC address' Group/axis does not have an axis interface from the NC to the PLC, or the axis interface address has not been initialized."
            },
            {
                16917,
                @"'Slave axis address' An existing master/slave coupling is to be removed from the group, but there is no valid address for the slave axis."
            },
            {
                16918,
                @"'Table address unknown' The table, respectively the table ID, is unknown. This table is used for the master/slave coupling or for the characteristic curve."
            },
            { 16919, @"'NcControl address' The NcControl address has not been initialized." },
            {
                16920,
                @"'Axis is blocked for commands while persistent NC data are queued' Axis is blocked for commands while waiting for valid IO data to accept the queued persistent NC data."
            },
            {
                16921,
                @"'The scaling mode MASTER-AUTOOFFSET is invalid because no reference table was found'. The used scaling mode MASTER-AUTOOFFSET is invalid in this context because an existing reference table is missing.
                    This error can occur for example when adding cam tables without a unique reference to an existing cam table.    "
            },
            {
                16922,
                @"'The master axis start position does not permit synchronization' When a slave axis is being coupled on, the position of the master axis does not permit synchronization at the given synchronization positions."
            },
            {
                16923,
                @"'Slave coupling factor (gearing factor) of 0.0 is not allowed' A master/slave coupling with a gearing factor of 0.0 is being created. This value is not allowed, since it does not correspond to any possible coupling, and division will generate an FPU exception."
            },
            {
                16924,
                @"'Insertion of master axis into group not allowed' A master axis is to be inserted into a group at a location that is already occupied by another master axis. Maybe the reconfiguration cannot be done, because this axis has got an existing slave coupling. This master/slave coupling must be revoked before."
            },
            {
                16925,
                @"'Deletion of master axis from group not allowed' (INTERNAL ERROR) A master axis is to be removed from a location in a group that is not in fact occupied by master axis."
            },
            {
                16926,
                @"'Function/feature is not supported from the setpoint generator A function or feature is not supported from the setpoint generator (e.g. PTP master setpoint generator). This can be in general or only in a special situation."
            },
            {
                16927,
                @"'Group initialization' Group has not been initialized. Although the group has been created, the rest of the initialization has not been performed (1. Initialization of group I/O, 2. Initialization of group, 3. Reset group)."
            },
            {
                16928,
                @"'Group not ready / group not ready for new task' The group is being given a new task while it is still in the process of executing an existing task. This request is not allowed because it would interrupt the execution of the previous task. The new task could, for instance, be a positioning command, or the 'set actual position' function. Precisely the converse relationships apply for the 'set new end position' function. In that case, the group/axis must still be actively moving in order to be able to cause a change in the end position."
            },
            {
                16929,
                @"'Requested set velocity is not allowed' The value requested for the set velocity of a positioning task is less than or equal to zero, larger than the 'maximum velocity' (see axis parameters), or, in the case of servo-drives, is larger than the 'reference velocity' of the axis (see drive parameters)."
            },
            {
                16930,
                @"'Requested target position is not allowed (master axis)' The requested value for the target position of a positioning task is not within the software end locations. In other words, it is either less than the minimum software end location or larger than the maximum software end location. This check is only carried out if the relevant end position monitoring is active."
            },
            {
                16931,
                @"'No enable for controller and/or feed (Master axis)' The axis enables for the master axis needed for positioning are not present. This can involve the controller enable and/or the relevant, direction-dependent feed enable (see axis interface PlcToNc)."
            },
            {
                16932,
                @"'Movement smaller than one encoder increment' (INTERNAL ERROR) The distance that a group/axis is supposed to move is smaller than the physical significance of one encoder increment. In other words the movement is smaller than the scaling factor of the axis. The reaction to this is that the axis is reported as having logically finished without having actively moved. This means that an external error is not generated for the user. This error is also issued for high/low speed axes if a loop movement with nonzero parameters is smaller than the sum of the creeping and //braking distances. In such a case it is not meaningful to either exceed or to fail to reach the target position."
            },
            {
                16933,
                @"'Drive not ready during axis start' During an axis start it is ascertained that the drive is not ready. The following are possible causes: - the drive is in the error state (hardware error) - the drive is in the start-up phase (e.g. after an axis reset that was preceded by a hardware error) - the drive is missing the controller enable (ENABLE) Note: The time required for 'booting' a drive after a hardware fault can amount to several seconds."
            },
            {
                16934,
                @"'Invalid parameters of the emergency stop.' Either, both, the deceleration and the jerk are less than zero or one of the parameters is weaker than the corresponding parameter of the start data."
            },
            {
                16935,
            ...
            {
                16936,
                @"'Requested traverse distance is not allowed' The requested traverse distance or looping distance is smaller than the braking distance of the two/speed axis."
            },
            {
                16937,
                @"'Requested target position is not allowed (slave axis)' The value for the target position of a positioning task when calculated for the slave axis is not within the software end locations. In other words, it is either less than the minimum software end location or larger than the maximum software end location. This check is only carried out if the relevant end position monitoring is active."
            },
            {
                16938,
                @"'No enable for controller and/or feed (slave axis)' The axis enables for one or more coupled slave axes needed for positioning are not present. This can involve the controller enable and/or the relevant, direction-dependent feed enable (see axis interface PlcToNc)."
            },
            {
                16939,
                @"'The activation position (position threshold) is out of range of the actual positioning' The activation position (position threshold) of a new axis command (e.g. 'new velocity activated at a position') is out of range. E.g. the activation position is before the actual position or behind the target position."
            },
            {
                16940,
                @"'The start or activation data of the external setpoint generation are not valid' This may be caused through: 1. The external setpoint generation is active and a new activation with a start type (1: absolute, 2: relative) unequal to the current one is send.
            ...
            {
                16941,
                @"'Velocity is not constant' For changing the dynamic parameter 'acceleration' und 'deceleration' the axis has to be in dynamic state without acceleration and deceleration (that means constant velocity)."
            },
            {
                16942,
                @"'Jerk less than or equal to 0.0 is not allowed' A value less than or equal to 0.0 for the jerk (PTP and CNC) is not allowed, since the jerk is by definition positive, and with a jerk of 0.0, division will generate an FPU exception."
            },
            {
                16943,
                @"'Acceleration less than or equal to 0.0 is not allowed' A value less than or equal to 0.0 for the acceleration (PTP and CNC) is not allowed, since the acceleration is positive by definition, and an acceleration of 0.0 will not allow a motion to be generated."
            },
            {
                16944,
                @"'Absolute deceleration value less than or equal to 0.0 is not allowed' A value less than or equal to 0.0 for the absolute value of the deceleration (PTP and CNC) is not allowed, since the absolute value of the deceleration is positive by definition, and an absolute value of the deceleration of 0.0 will not allow a motion to be generated."
            },
            {
                16945,
                @"'Set velocity less than or equal to 0.0 is not allowed' A value less than or equal to 0.0 or outside the range from 10-3 up to 10+10 for the set velocity (PTP and CNC) is not allowed, since the set velocity is by definition strictly positive, and with a set velocity of 0.0, division will generate an FPU exception."
            },
            {
                16946,
                @"'Loss of precision when trying a positioning' The positioning is so long in space or time that decimal parts loose there relevance LOSS_OF_PRECISION)."
            },
            {
                16947,
                @"'Cycle time less than or equal to 0.0 is not allowed' A value less than or equal to 0.0 for the cycle time (PTP and CNC) is not allowed, since the cycle time is by definition strictly positive, and with a cycle time of 0.0, division will generate an FPU exception."
            },
            {
                16948,
                @"'PTP data type <intasdouble> range exceeded' Such extreme parameters have been supplied for the start task, the override or the new target position that the internal data type loses its precision."
            },
            {
                16949,
                @"'PTP LHL velocity profile cannot be generated' (INTERNAL ERROR) Such extreme parameters have been supplied for the start task, the override or the new target position that it is not possible to generate a velocity profile of the type LHL (Low-High-Low)."
            },
            {
                16950,
                @"'PTP HML velocity profile cannot be generated' (INTERNAL ERROR) Such extreme parameters have been supplied for the override or the new target position that it is not possible to generate a velocity profile of the type HML (High-Middle-Low)."
            },
            { 16951, @"'Start data address is invalid' The address of the start data is invalid." },
            {
                16952,
                @"'Velocity override (start override) is not allowed' The value for the velocity override is not allowed, because it is less than 0.0% or more than 100.0% (see axis interface PlcToNc). Here, 100.0 % corresponds to the integral value 1000000 in the axis interface. Value range: [0 ... 1000000]"
            },
            { 16953, @"'Start type not allowed' The start type supplied does not exist." },
            {
                16954,
                @"'Velocity overflow (overshoot in the velocity)' The new dynamic with the parameterized jerk is so weak that a velocity overflow will occur (overshoot in the velocity). The command is therefore not supported."
            },
            {
                16955,
                @"'Start parameter for the axis structure is invalid' External or internal parameters for the start structure for a positioning task are invalid. Thus, for instance, the scaling factor, the SAF cycle time or the requested velocity may be less than or equal to zero, which is not allowed."
            },
            {
                16956,
                @"'Override generator initialization parameter invalid' One of the override generator (re)initialization parameters is invalid."
            },
            {
                16957,
                @"'Slave axis has not set value generator' (INTERNAL ERROR) It is found that a slave axis within a group does not have a valid slave generator (set value generator). A slave axis and a slave set value generator must always be present as a pair. This is an internal error."
            },
            {
                16958,
                @"'Table is empty' Either the SVB table or the SAF table does not contain any entries."
            },
            { 16959, @"'Table is full' The SVB table or the SAF table has no more free lines." },
            {
                16960,
                @"'No memory available' SVB memory allocation for dynamic entry in SAF table failed."
            },
            {
                16961,
                @"'Table already contains an entry' (INTERNAL ERROR) SAF table entry abandoned, because, incorrectly, an entry already exists."
            },
            {
                16962,
                @"'Stop is already active' The stop instruction is not forwarded, because it has already been activated."
            },
            {
                16963,
                @"'Compensation has not been carried out over the full compensation section' The compensations start parameters do not permit compensation over the full section to be compensated. For this reason the compensation will be carried out over a smaller section."
            },
            {
                16964,
                @"'Internal parameters for the compensation are invalid' (INTERNAL ERROR) Invalid internal parameters or start parameters of the lower-level generator."
            },
            {
                16965,
                @"'Compensation active' Start of compensation refused, because compensation is already active. It's also possible that the M/S axes are not active moved. Therefore an execution of the compensation is impossible."
            },
            {
                16966,
                @"'Compensation not active' Stop of compensation refused, because compensation is not active."
            },
            {
                16967,
                @"'Compensation type invalid' The type supplied for the section compensation is invalid. At the present time only compensation type 1 (trapezoidal velocity profile) is allowed."
            },
            {
                16968,
                @"'Axis address for compensation invalid' (INTERNAL ERROR) The address of the master of slave axis on which the section compensation is to act is invalid. This is an internal error."
            },
            {
                16969,
                @"'Invalid slave address' (INTERNAL ERROR) The slave address given for on-line coupling/decoupling is invalid."
            },
            {
                16970,
                @"'Coupling velocity invalid' The velocity of what is to become the master axis is 0, which means that on-line coupling is not possible."
            },
            {
                16971,
                @"'Coupling velocities not constant' The velocity of what is to become the master axis and the velocity of what is to become the slave axis are not constant, so that on-line coupling is not possible."
            },
            {
                16972,
                @"'Cycle time less than or equal to 0.0 is not allowed' A value less than or equal to 0.0 for the cycle time (Slave) is not allowed, since the cycle time is by definition strictly positive, and with a cycle time of 0.0, division will generate an FPU exception."
            },
            {
                16973,
                @"'Decoupling task not allowed' The slave axis is of such a type (e.g. a table slave) or is in such a state (master velocity 0) that on-line decoupling is not possible."
            },
            {
                16974,
                @"'Function not allowed' The function cannot logically be executed, e.g. some commands are not possible and not allowed for slave axes."
            },
            {
                16975,
                @"'No valid table weighting has been set' The weighting factor of each table is 0, so that no table can be read."
            },
            {
                16976,
                @"'Axis type, actual position type or end position type is not allowed' The start type for a positioning task in invalid. Valid start types are ABSOLUTE (1), RELATIVE (2), CONTINUOUS POSITIVE (3), CONTINUOUS NEGATIVE (4), MODULO (5), etc. It is also possible that the types for setting a new actual position or for travel to a new end position are invalid."
            },
            {
                16977,
                @"'Function not presently supported' An NC function has been activated that is currently not released for use, or which is not even implemented. This can be a command which is not possible or not allowed for master axes."
            },
            {
                16978,
                @"'State of state machine invalid' (INTERNAL ERROR) The state of an internal state machine is invalid. This is an internal error."
            },
            {
                16979,
                @"'Reference cam became free too soon' During the referencing process for an axis it is moved in the direction of the referencing cam, and is only stopped again when the cam signal is reached. After the axis has then also physically stopped, the referencing cam must remain occupied until the axis subsequently starts back down from the cam in the normal way."
            },
            {
                16980,
                @"'Clearance monitoring between activation of the hardware latch and appearance of the sync pulse' When the clearance monitoring is active, a check is kept on whether the number of increments between activation of the hardware latch and occurrence of the sync pulse (zero pulse) has become smaller than a pre-set value. This error is generated when that happens. (See parameters for the incremental encoder)"
            },
            {
                16981,
                @"'No memory available' The dynamic memory allocation for the set value generator, the SVB table or the SAF table has failed."
            },
            {
                16982,
                @"'The table slave axis has no active table' Although the table slave axis has tables, none of the tables is designated as active. If this occurs during the run time the whole master/slave group is stopped by a run time error."
            },
            {
                16983,
                @"'Function not allowed' The requested function or the requested task is not logically allowed. An example for such an error message would be 'set an actual position' for an absolute encoder (M3000, KL5001, etc.)."
            },
            {
                16984,
                @"'Stopping compensation not allowed' It is not possible to stop the compensation, since compensation is already in the stopping phase."
            },
            {
                16985,
                @"'Slave table is being used' The slave table cannot be activated, because it is currently being used."
            },
            {
                16986,
                @"'Master or slave axis is processing a job (e.g. positioning command) while coupling is requested' A master/slave coupling of a certain slave type (e.g. linear coupling) cannot be executed. he master or intended slave axis is not in stand still state and is executing a job (e.g. positioning) at the same time as the coupling request received. For this couple type this is not allowed."
            },
            {
                16987,
                @"'Slave (start) parameter is incorrect' One of the slave start/coupling parameters is not allowed (Coupling factor is zero, the master position scaling of an cam is zero, etc.)."
            },
            {
                16988,
                @"'Slave type is incorrect' The slave type does not match up to the (SVB) start type."
            },
            {
                16989,
                @"'Axis stop is already active' The axis stop/Estop is not initiated, because the stop/estop is already active."
            },
            {
                16990,
                @"'Maximum number of tables per slavegenerator reached' The maximum number of tables per slave generator is reached (e.g. 'MC_MultiCamIn' is limited to 4 tables)."
            },
            {
                16991,
                @"'The scaling mode is invalid'. The used scaling is invalid in this context. Either the mode is not defined or yet not implemented or however it cannot in this constellation be put into action.
            ...
            {
                16993,
                @"'Table not found' No table exists with the ID prescribed or the table ID is not unique."
            },
            {
                16994,
                @"'Incorrect table type' The table referred to in the function is of the incorrect type."
            },
            {
                16995,
                @"'Single step mode' This error occurs if single step mode is selected for a group or axis and a new task is requested while one of the individual tasks is still being processed."
            },
            {
                16996,
                @"'Group task unknown (asynchronous table entry)' The group has received a task whose type or sub-type is unknown. Valid tasks can be single or multi-dimensional positioning tasks (Geo 1D, Geo 3D), referencing tasks, etc."
            },
            {
                16997,
                @"'Group function unknown (synchronous function)' The group has received a function whose type is unknown. Valid functions are 'Reset', 'Stop', 'New end position', 'Start/stop section compensation', 'Set actual position', 'Set/reset referencing status' etc."
            },
            {
                16998,
                @"'Group task for slave not allowed' Group tasks are usually only possible for master axes, not for slave axes. A slave axis only moves as an indirect result of a positioning task given to its associated master axis. A slave can thus never directly be given a task.
                    Exception: see axis parameter 'Allow motion commands to slave axis'.    "
            },
            {
                16999,
                @"'Group function for slave not allowed' Group functions are in principle only possible for master axes, not for slave axes. The only exception is represented by the 'Start/stop section compensation' function, which is possible both for masters and for slaves. A slave cannot directly execute any other functions beyond this."
            },
            {
                17000,
            ...
            {
                17002,
                @"'Parameters of the delay-generator are invalid' Invalid external/internal parameters of the delay generator (delay time, cycle time, tics)."
            },
            {
                17003,
                @"'External parameters of the superimposed instruction are invalid' Invalid external parameters of the superimposed functionality (acceleration, deceleration, velocity, process velocity, length)."
            },
            { 17004, @"'Invalid override type.'" },
            {
                17005,
                @"'Activation position under/overrun' The requested activation position is located in the past of the master (e.g. when exchanging a cam table)."
            },
            {
                17006,
                @"'Activation impossible: Master is standing' The required activation of the correction is impossible since the master axis is not moving. A synchronization is not possible, because the master axis standing and the slave axis is still not synchronous."
            },
            {
                17007,
                @"'Activation mode not possible' The requested activation mode is not possible when the slave axis is moving. Otherwise the slave velocity would jump to zero."
            },
            {
                17008,
                @"'Start parameter for the compensation is invalid' One of the dynamic parameters for the compensation is invalid (necessary condition): Acceleration (>0) Deceleration (>0) Process velocity (>0)"
            },
            {
                17009,
                @"'Start parameter for the compensation is invalid' Velocity camber is negative."
            },
            {
                17010,
                @"'Start parameter for the compensation is invalid' The section on which the compensation is to occur is not positive."
            },
            {
                17011,
                @"'Target position under/overrun' (INTERNAL ERROR) The position (calculated from the modulo-target-position) where the axis should stand at end of oriented stop has been run over."
            },
            {
                17012,
                @"'Target position will be under/overrun' (INTERNAL ERROR) The position (calculated from the modulo-target-position) where the axis should stand at end of oriented stop is too near and will be run over."
            },
            {
                17013,
            ...
            {
                17014,
                @"'Joint Error at Start of Setpoint Generation
            ...
            {
                17015,
                @"'Dynamic parameters not permitted' (INTERNAL ERROR) The dynamic parameters resulting from internal calculation like acceleration, deceleration and jerk are not permitted."
            },
            {
                17017,
                @"'The New Target Position is Invalid or Cannot be Reached
            ...
            {
                17018,
                @"'New Velocity for Moving or the Final Target Velocity is Invalid
            ...
            {
                17019,
                @"'The Final Velocity or the New Target Position is Invalid
            ...
            {
                17020,
                @"'The New Moving Velocity is Invalid
            ...
            {
                17021,
                @"'Internal Starting Mode is Invalid
            ...
            {
                17022,
                @"'A requested motion command could not be realized (BISECTION)' A requested motion command could not be realized using the requested parameters.The command has been executed best possible and this message is therefore to be understood just as a warning. Samples:
            ...
            {
                17030,
                @"'The parameterized velocity is not permitted'. The parameterized target velocity is lower than the minimum velocity (but the value zero is permitted). The value for minimum velocity is calculated from the minimum jerk rate and the NC cycle time (minimum jerk rate multiplied with the square of the NC cycle time). The unit for example is mm/s."
            },
            {
                17031,
                @"'A activation cannot be executed due to a pending activation' A activation e.g. 'CamIn', 'CamScaling' or 'WriteMotionFunction' cannot be executed due to a pending activation (e.g. 'CamIn', 'CamScaling', 'WriteMotionFunction'). Only activation can be enabled."
            },
            {
                17032,
                @"'Illegal combination of different cycle times within an axis group' A logical axis group includes elements (axes) with different cycle times for a common setpoint generator and I/O-execution, resp. This situation can occur with Master/Slave-coupling or configuring 3D- and FIFO-groups (including path, auxiliary, and slave axes)."
            },
            {
                17033,
                @"'Illegal motion reversal' Due to the actual dynamical state a motion reversal will happen. To avoid this motion reversal the axis command is not performed and the previous system state restored."
            },
            {
                17034,
                @"'Illegal moment for an axis command because there is an old axis command with activation position still active' The moment for the command is illegal because there is still an old command with activation position active (e.g. 'go to new velocity at threshold position' or 'reach new velocity at threshold position')."
            },
            {
                17035,
                @"'Error in the stop-calculation routine' (INTERNAL ERROR) Due to an internal error in the stop-calculation routine the current commando cannot be performed. The previous system state is restored."
            },
            {
                17036,
                @"'A command with activation position cannot fully be performed because the remaining path is too short'A command with activation position (threshold) like 'reach a new velocity at a position' can be just partially executed because the path from the actual position to the activation position is too short."
            },
            {
                17037,
                @"'Illegal decouple type when decoupling a slave axis' The decouple and restart command contains an invalid decouple type."
            },
            {
                17038,
                @"'Illegal target velocity when decoupling a slave axis' The decouple and restart command contains an illegal target velocity [1 < V <Vmax]."
            },
            {
                17039,
                @"'The command new dynamic parameter cannot be performed since this would require a new target velocity'Das Kommando zum Aktivieren neuer Dynamikparameter wie Beschleunigung, Verzögerung und Ruck kann nicht durchgeführt werden, da dies eine neue beauftragte Fahrgeschwindigkeit erfordern würde.
            ...
            {
                17041,
                @"'Decouple routine of slave axis doesn't return a valid solution' Internal jerk scaling of decouple routine cannot evaluate a valid solution (decoupling slave axis and transform to master axis). The command is rejected because velocity can become too high, a reversal of movement can occur, or the target position can be passed."
            },
            {
                17042,
                @"'Command not be executed because the command buffer is full filled' The command is rejected because the command buffer is full filled."
            },
            {
                17043,
                @"'Command is rejected due to an internal error in the Look Ahead' (INTERNAL ERROR) The command is rejected due to an internal error in the 'look ahead'."
            },
            {
                17044,
                @"'Command is rejected because the segment target velocity is not realized' The command is rejected, because the new target segment velocity Vrequ is not realizable and an internal optimizing is impossible."
            },
            {
                17045,
                @"'Successive commands have the same final position' Successive commands have the same final position. So the moving distance is zero."
            },
            {
                17046,
                @"'Logical positioning direction is inconsistent with the direction of the buffer command' In the extended buffer mode, where the actual end position is replaced by the new buffer start position, the logical positioning direction is inconsistent with the direction of the buffer command (=> contradiction). A buffered command (BufferMode, BlendingLow, BlendingPrevious, BlendingNext, BlendingHigh) is rejected with error 0x4296 if the command is using the Beckhoff specific optional BlendingPosition but the blending position is located beyond the target position of the previous motion command."
            },
            {
                17047,
                @"'Command is rejected because the remaining positioning length is to small' The command is rejected because the remaining path length is too small.
            ...
            {
                17051,
                @"'collect error for invalid start parameters'
            ...
            {
                17052,
                @"'Reference cam is not found' During the referencing process for an axis it is moved in the direction of the referencing cam. This reference cam, however, was not found as expected (=> leads to the abortion of the referencing procedure)."
            },
            {
                17053,
            ...
            {
                17065,
                @"'Curve velocity reduction method not allowed' (INTERNAL ERROR) The curve velocity reduction method does not exist."
            },
            {
                17066,
                @"'Minimum velocity not allowed' The minimum velocity that has been entered is less than 0.0."
            },
            {
                17067,
                @"'Power function input not allowed' (INTERNAL ERROR) The input parameters in the power_() function lead to an FPU exception."
            },
            {
                17068,
                @"'Dynamic change parameter not allowed' A parameter that controls alterations to the dynamics is invalid. Parameter: 1. Absolute motion dynamics change: All parameters must be strictly positive. 2. Relative reduction c_f: 0.0 < c_f <= 1.0"
            },
            { 17069, @"'Memory allocation error' (INTERNAL ERROR)" },
            {
                17070,
                @"'The calculated end position differs from the end position in the nc instruction (internal error).'"
            },
            {
                17071,
                @"'Calculate remaining chord length'
                    invalid value   "
            },
            {
                17072,
                @"'Set value generator SVB active' Starting the set value generator (SVB, SAF) has been refused, since the SVB task is already active."
            },
            {
                17073,
                @"'SVB parameter not allowed' (INTERNAL ERROR) A parameter related to the internal structure of the set value generator (SVB) results in logical errors and/or to an FPU exception. Affects these parameters: Minimum velocity (>0.0), TimeMode, ModeDyn, ModeGeo, StartType, DistanceToEnd, TBallRadius."
            },
            {
                17074,
            ...
            {
                17075,
                @"'Helix is a circle' The helix has degenerated to a circle, and should be entered as such."
            },
            {
                17076,
                @"'Helix is a straight line' The helix has degenerated to a straight line, and should be entered as such."
            },
            {
                17077,
                @"'Guider parameter not allowed' One of the guider's parameters leads to logical errors and/or to an FPU exception."
            },
            {
                17078,
                @"'Invalid segment address' (INTERNAL ERROR) The geometry segment does not have a valid geometry structure address or does not have a valid dynamic structure address."
            },
            {
                17079,
                @"'Unparameterized generator' (INTERNAL ERROR) The SVB generator is not yet parameterized and is therefore unable to operate."
            },
            {
                17080,
                @"'Unparameterized table' (INTERNAL ERROR) The table has no information concerning the address of the corresponding dynamic generator."
            },
            {
                17082,
                @"'The calculation of the arc length of the smoothed path failed (internal error).'"
            },
            ...
            {
                17085,
                @"'NC-Block violates software limit switches of the group' At least one path axis with active software limit monitoring has violated the limit switches. Therefore the geometric entry is denied with an error."
            },
            {
                17086,
                @"'Internal error in the evaluation of a possible software limit switch violation for the segment with the block-number xx.' At least one path axis with active position limit monitoring has violated the limit switches."
            },
            { 17087, @"'Invalid reference speed type." },
            {
                17088,
                @"'Interpolating group contains axes of an incorrect axis type' An interpolating 3D group may only contain continuously guided axes of axis type 1 (SERVO)."
            },
            {
                17089,
                @"'Scalar product cannot be calculated' The length of one of the given vectors is 0.0."
            },
            {
                17090,
                @"'Inverse cosine cannot be calculated' The length of one of the given vectors is 0.0."
            },
            { 17091, @"'Invalid table entry type' The given table entry type is unknown." },
            {
                17092,
                @"'Invalid DIN66025 information type' (INTERNAL ERROR) The given DIN66025 information type is unknown. Known types: G0, G1, G2, G3, G17, G18, G19."
            },
            {
                17093,
                @"'Invalid dimension' (INTERNAL ERROR) The CNC dimension is unknown. Known dimensions: 1, 2, 3. Or: The CNC dimension is invalid for the given geometrical object. For a circle the dimension must be 2 or 3, while for a helix it must be 3."
            },
            {
                17094,
                @"'Geometrical object is not a straight line' The given object, interpreted as a straight line, has a length of 0.0."
            },
            {
                17095,
                @"'Geometrical object is not a circle' Interpreted as a circular arc, the given object has a length of 0.0, or an angle of 0.0 or a radius of 0.0."
            },
            {
                17096,
                @"'Geometrical object is not a helix' Interpreted as a circular arc, the given object has a length of 0.0, or an angle of 0.0, or a radius of 0.0. or a height of 0.0."
            },
            {
                17097,
                @"'Set velocity less than or equal to 0.0 is invalid' A value less than or equal to 0.0 for the set velocity (CNC) is not allowed, since the set velocity is positive by definition, and a set velocity of 0.0 cannot generate any motion."
            },
            {
                17098,
                @"'Address for look-ahead invalid' (INTERNAL ERROR) The address supplied for the look-ahead is invalid."
            },
            {
                17099,
                @"'Set value generator SAF active' Starting the set value generator (SAF) has been refused, since the SAF task is already active."
            },
            {
                17100,
                @"'CNC set value generation not active' Stop or change of override refused, because the set value generation is not active."
            },
            {
                17101,
                @"'CNC set value generation in the stop phase' Stop or change of override refused, because the set value generation is in the stop phase."
            },
            {
                17102,
                @"'Override not allowed' An override of less than 0.0 % or more than 100.0 % is invalid."
            },
            {
                17103,
                @"'Invalid table address' (INTERNAL ERROR) The table address given for the initialization of the set value generator is invalid, or no valid logger connection (report file) is present."
            },
            ...
            {
                17108,
                @"'Delete Distance To Go failed' Delete Distance to go (only interpolation) failed. This error occurred, if e.g. the command 'DelDTG' was not programmed in the actual movement of the nc program."
            },
            {
                17109,
            ...
            {
                17114,
                @"'Parameter of Motion Function (MF) table incorrect' The parameter of the Motion Function (MF) are invalid. This may refer to the first time created data set or to online changed data."
            },
            {
                17115,
                @"'Parameter of Motion Function (MF) table incorrect' The parameter of the Motion Function (MF) are invalid. This may refer to the first time created data set or to online changed data.
            ...
            {
                17121,
                @"'Invalid parameter' The external (Fifo) generator parameter is not allowed."
            },
            {
                17122,
                @"'External generator is active' The external generator cannot be started, as it is already active."
            },
            {
                17123,
                @"'External generator is not active' The external generator cannot be stopped, as it is not active."
            },
            {
                17124,
                @"'NC-Block with auxiliary axis violates software limit switches of the group' At least one auxiliary axis with active software limit monitoring has violated the limit switches. Therefore the geometric entry is denied with an error."
            },
            {
                17125,
                @"'NC-Block type Bezier spline curve contains a cusp (singularity)' The Bezier spline curve contain a cusp, i.e.at a certain interior point both the curvature and the modulus of the velocity tend to 0 such that the radius of curvature is infinite.
            ...
            {
                17127,
                @"'Value for dead time compensation not allowed' The value for the dead time compensation in seconds for a slave coupling to an encoder axis (virtual axis) is not allowed."
            },
            ...
            {
                17135,
                @"'Axis is locked for motion commands because a stop command is still active' The axis/group is locked for motion commands because a stop command is still active. The axis can be released by calling MC_Stop with Execute=FALSE or by using MC_Reset (TcMC2.Lib)."
            },
            {
                17136,
                @"'Invalid number of auxiliary axes' The local number of auxiliary axes does not tally with the global number of auxiliary axes."
            },
            {
                17137,
                @"'Invalid reduction parameter for auxiliary axes' The velocity reduction parameters for the auxiliary axes are inconsistent."
            },
            {
                17138,
                @"'Invalid dynamic parameter for auxiliary axes' The dynamic parameters for the auxiliary axes are inconsistent."
            },
            {
                17139,
                @"'Invalid coupling parameter for auxiliary axes' The coupling parameters for the auxiliary axes are inconsistent."
            },
            {
                17140,
                @"'Invalid auxiliary axis entry' The auxiliary axis entry is empty (no axis motion)."
            },
            {
                17142,
                @"'Invalid parameter' The limit for velocity reduction of the auxiliary axes is invalid. It has to be in the interval 0..1.0"
            },
            {
                17144,
                @"'Block search - segment not found' The segment specified as a parameter could not be found by the end of the NC program.
                    Possible cause:
            ...
            {
                17145,
                @"'Blocksearch – invalid remaining segment length' The remaining travel in the parameter fLength is incorrectly parameterized"
            },
            {
                17147,
                @"'Internal Error in the Context of Coupled Axes (Slave Axes)
                    Fatal internal error using coupled axes(slave axes). Inconsistent internal state.Please, contact the support team.    "
            },
            {
                17148,
                @"'Parameter for the Maximum Number of Jobs (Entries) to be Transferred is Invalid
            ...
            {
                17152,
                @"'Axis ID not allowed' The value for the axis ID is not allowed, e.g. because it has already been assigned, is less than or equal to zero, is greater than 255, or does not exist in the current configuration."
            },
            {
                17153,
                @"'Axis type not allowed' The value for the axis type is unacceptable because it is not defined. Type 1: Servo Type 2: Fast/creep Type 3: Stepper motor"
            },
            {
                17158,
                @"'Slow manual velocity not allowed' The value for the slow manual velocity is not allowed."
            },
            {
                17159,
                @"'Fast manual velocity not allowed' The value for the fast manual velocity is not allowed."
            },
            { 17160, @"'High speed not allowed' The value for the high speed is not allowed." },
            {
                17161,
                @"'Acceleration not allowed' The value for the axis acceleration is not allowed."
            },
            {
                17162,
                @"'Deceleration not allowed' The value for the axis deceleration is not allowed."
            },
            { 17163, @"'Jerk not allowed' The value for the axis jerk is not allowed." },
            {
                17164,
                @"'Delay time between position and velocity is not allowed' The value for the delay time between position and velocity ('idle time compensation') is not allowed."
            },
            {
                17165,
                @"'Override-Type not allowed' The value for the velocity override type is not allowed. Type 1: With respect to the internal reduced velocity (default value) Type 2: With respect to the original external start velocity"
            },
            {
                17166,
                @"'NCI: Velo-Jump-Factor not allowed'
                    The value for the velo-jump-factor ('VeloJumpFactor') is not allowed.This parameter only works for TwinCAT NCI.	"
            },
            {
                17167,
                @"'NCI: Radius of tolerance sphere for the auxiliary axes is invalid'
                    It was tried to enter an invalid value for the size of the tolerance sphere. This sphere affects only auxiliary axes!	"
            },
            {
                17168,
                @"'NCI: Value for maximum deviation for the auxiliary axes is invalid'
                    It was tried to enter an invalid value for the maximum allowed deviation. This parameter affects only auxiliary axes!	"
            },
            {
                17170,
                @"'Referencing velocity in direction of cam not allowed' The value for the referencing velocity in the direction of the referencing cam is not allowed."
            },
            {
                17171,
                @"'Referencing velocity in sync direction not allowed' The value for the referencing velocity in the direction of the sync pulse (zero track) is not allowed."
            },
            {
                17172,
                @"'Pulse width in positive direction not allowed' The value for the pulse width in the positive direction is not allowed (pulsed operation). The use of the pulse width for positioning is chosen implicitly through the axis start type. Pulsed operation corresponds to positioning with a relative displacement that corresponds precisely to the pulse width."
            },
            {
                17173,
                @"'Pulse width in negative direction not allowed' The value for the pulse width in the negative direction is not allowed (pulsed operation). The use of the pulse width for positioning is chosen implicitly through the axis start type. Pulsed operation corresponds to positioning with a relative displacement that corresponds precisely to the pulse width."
            },
            {
                17174,
                @"'Pulse time in positive direction not allowed' The value for the pulse width in the positive direction is not allowed (pulsed operation)."
            },
            {
                17175,
                @"'Pulse time in negative direction not allowed' The value for the pulse width in the negative direction is not allowed (pulsed operation)."
            },
            {
                17176,
                @"'Creep distance in positive direction not allowed' The value for the creep distance in the positive direction is not allowed."
            },
            {
                17177,
                @"'Creep distance in negative direction not allowed' The value for the creep distance in the negative direction is not allowed."
            },
            {
                17178,
                @"'Braking distance in positive direction not allowed' The value for the braking distance in the positive direction is not allowed."
            },
            {
                17179,
                @"'Braking distance in negative direction not allowed' The value for the braking distance in the negative direction is not allowed."
            },
            {
                17180,
                @"'Braking time in positive direction not allowed' The value for the braking time in the positive direction is not allowed."
            },
            {
                17181,
                @"'Braking time in negative direction not allowed' The value for the braking time in the negative direction is not allowed."
            },
            {
                17182,
                @"'Switching time from high to low speed not allowed' The value for the time to switch from high to low speed is not allowed."
            },
            {
                17183,
                @"'Creep distance for stop not allowed' The value for the creep distance for an explicit stop is not allowed."
            },
            {
                17184,
                @"'Motion monitoring not allowed' The value for the activation of the motion monitoring is not allowed."
            },
            {
                17185,
                @"'Position window monitoring not allowed' The value for the activation of the position window monitoring is not allowed."
            },
            {
                17186,
                @"'Target window monitoring not allowed' The value for the activation of target window monitoring is not allowed."
            },
            {
                17187,
                @"'Loop not allowed' The value for the activation of loop movement is not allowed."
            },
            {
                17188,
                @"'Motion monitoring time not allowed' The value for the motion monitoring time is not allowed."
            },
            {
                17189,
                @"'Target window range not allowed' The value for the target window is not allowed."
            },
            {
                17190,
                @"'Position window range not allowed' The value for the position window is not allowed."
            },
            {
                17191,
                @"'Position window monitoring time not allowed' The value for the position window monitoring time is not allowed."
            },
            {
                17192,
                @"'Loop movement not allowed' The value for the loop movement is not allowed."
            },
            {
                17193,
                @"'Axis cycle time not allowed' The value for the axis cycle time is not allowed."
            },
            {
                17194,
                @"'Stepper motor operating mode not allowed' The value for the stepper motor operating mode is not allowed."
            },
            {
                17195,
                @"'Displacement per stepper motor step not allowed' The value for the displacement associated with one step of the stepper motor is not allowed (step scaling)."
            },
            {
                17196,
                @"'Minimum speed for stepper motor set value profile not allowed' The value for the minimum speed of the stepper motor speed profile is not allowed."
            },
            {
                17197,
                @"'Stepper motor stages for one speed stage not allowed' The value for the number of steps for each speed stage in the set value generation is not allowed."
            },
            {
                17198,
                @"'DWORD for the interpretation of the axis units not allowed' The value that contains the flags for the interpretation of the position and velocity units is not allowed."
            },
            {
                17199,
                @"'Maximum velocity not allowed' The value for the maximum permitted velocity is not allowed."
            },
            {
                17200,
                @"'Motion monitoring window not allowed' The value for the motion monitoring window is not allowed."
            },
            {
                17201,
                @"'PEH time monitoring not allowed' The value for the activation of the PEH time monitoring is not allowed (PEH: positioning end and halt)."
            },
            {
                17202,
                @"'PEH monitoring time not allowed' The value for the PEH monitoring time (timeout) is not allowed (PEH: positioning end and halt). default value: 5s"
            },
            ...
            {
                17206,
                @"'Parameter for the Error Reaction Delay is Invalid
                    The parameter for the error reaction delay of the axis is invalid.  "
            },
            {
                17207,
                @"'Parameter 'Couple Slave to Actual Values if not Enabled' is Invalid
                    The parameter 'Couple Slave to Actual Values if not Enabled' is invalid.    "
            },
            {
                17208,
                @"'Parameter 'Allow Motion Commands to Slave Axis' is Invalid
            ...
            {
                17209,
                @"'Parameter 'Allow Motion Commands to External Setpoint Axis' is Invalid
            ...
            {
                17210,
                @"'Parameter 'Fading Acceleration' is Invalid
            ...
            {
                17211,
                @"'Fast Axis Stop Signal Type not allowed' The value for the Signal Type of the 'Fast Axis Stop' is not allowed [0...5]."
            },
            {
                17216,
                @"'Axis initialization' Axis has not been initialized. Although the axis has been created, the rest of the initialization has not been performed (1. Initialization of axis I/O, 2. Initialization of axis, 3. Reset axis)."
            },
            {
                17217,
                @"'Group address' Axis does not have a group, or the group address has not been initialized (group contains the set value generation)."
            },
            {
                17218,
                @"'Encoder address' The axis does not have an encoder, or the encoder address has not been initialized."
            },
            {
                17219,
                @"'Controller address' The axis does not have a controller, or the controller address has not been initialized."
            },
            {
                17220,
                @"'Drive address' The axis does not have a drive, or the drive address has not been initialized."
            },
            {
                17221,
                @"'Axis interface PLC to NC address' Axis does not have an axis interface from the PLC to the NC, or the axis interface address has not been initialized."
            },
            {
                17222,
                @"'Axis interface NC to PLC address' Axis does not have an axis interface from the NC to the PLC, or the axis interface address has not been initialized."
            },
            {
                17223,
                @"'Size of axis interface NC to PLC is not allowed' (INTERNAL ERROR) The size of the axis interface from NC to PLC is not allowed."
            },
            {
                17224,
                @"'Size of axis interface PLC to NC is not allowed' (INTERNAL ERROR) The size of the axis interface from PLC to NC is not allowed."
            },
            {
                17238,
                @"'Controller enable' Controller enable for the axis is not present (see axis interface SPS®NC). This enable is required, for instance, for an axis positioning task."
            },
            {
                17239,
                @"'Feed enable negative: There is no feed enable for negative motion direction (see axis interface PLC->NC). This enable is checked e.g. for a positioning task of an axis into negative motion direction."
            },
            {
                17240,
                @"'Feed enable plus' Feed enable for movement in the positive direction is not present (see axis interface SPS®NC). This enable is required, for instance, for an axis positioning task in the positive direction."
            },
            {
                17241,
                @"'Set velocity not allowed' The set velocity requested for a positioning task is not allowed. This can happen if the velocity is less than or equal to zero, larger than the maximum permitted axis velocity, or, in the case of servo-drives, is larger than the reference velocity of the axis (see axis and drive parameters)."
            },
            {
                17242,
            ...
            {
                17249,
                @"'Time range exceeded (future)' The calculated position lies too far in the future (e.g. when converting a position value in a DC time stamp)."
            },
            {
                17250,
                @"'Time range exceeded (past)' The calculated position lies too far in the past (e.g. when converting a position value in a DC time stamp)."
            },
            {
                17251,
                @"'Position cannot be determined' The requested position cannot be determined. Case 1: It was not passed through in the past. Case 2: It cannot be reached in future. A reason can be a zero velocity value or an acceleration that causes a turn back."
            },
            {
                17252,
                @"'Position indeterminable (conflicting direction of travel)' The direction of travel expected by the caller of the function deviates from the actual direction of travel (conflict between PLC and NC view, for example when converting a position to a DC time)."
            },
            {
                17264,
                @"'No Slave Coupling Possible (Velocity Violation)
            ...
            {
                17265,
                @"'No Slave Coupling Possible (Acceleration Violation)
            ...
            {
                17266,
                @"'The synchronization profile would violate the lower end position of the slave.
                    Check when GearInSync_CheckMask_MinPos is active."
            },
            {
                17267,
                @"'The synchronization profile would violate the upper end position of the slave.
                    Check when GearInSync_CheckMask_MaxPos is active."
            },
            {
                17268,
                @"'The synchronization profile would violate the user limit position Options.PositionLimitMin.
                    Check when GearInSync_CheckMask_OptionalMinPos is active."
            },
            {
                17269,
                @"'The synchronization profile would violate the user limit position Options.PositionLimitMax.
                    Check when GearInSync_CheckMask_OptionalMaxPos is active."
            },
            {
                17270,
                @"'The synchronization point lies under the starting point. As a result, the profile swings under both the start position and the synchronous position.
                    Check when GearInSync_CheckMask_UndershootPos is active."
            },
            {
                17271,
                @"'The synchronization profile would swing back under the slave start position of the flying saw.
                    Check when GearInSync_CheckMask_UndershootPos is active."
            },
            {
                17272,
                @"'The synchronization point lies under the starting point. The synchronization profile would swing beyond the slave start position of the flying saw.
                    Check when GearInSync_CheckMask_OvershootPos is active."
            },
            {
                17273,
                @"'The synchronization profile would swing beyond the slave synchronous position of the flying saw.
                    Check when GearInSync_CheckMask_OvershootPos is active."
            },
            {
                17274,
                @"'The maximum velocity of the synchronization profile is higher than the maximum velocity of the slave axis.
            ...
            {
                17276,
                @"'The maximum velocity of the synchronization profile would be higher than the synchronous velocity.
            ...
            {
                17277,
                @"'The maximum velocity of the synchronization profile would be higher than the starting velocity and synchronous velocity.
            ...
            {
                17280,
                @"'The minimum velocity of the synchronization profile lies below the synchronous velocity.
                    (Positive direction of travel and starting velocity higher than synchronous velocity)
                    Check when GearInSync_CheckMask_UndershootVelo is active."
            },
            {
                17281,
                @"'The minimum velocity of the synchronization profile lies below the starting velocity.
                    (Positive direction of travel and starting velocity lower than synchronous velocity)
                    Check when GearInSync_CheckMask_UndershootVelo is active."
            },
            {
            ...
            {
                17286,
                @"'The velocity of the flying saw swings below zero; the motion is reversed.
            ...
            {
                17288,
                @"'The maximum acceleration of the synchronization profile would be higher than the maximum acceleration of the slave axis.
                    Check when GearInSync_CheckMask_MaxAcc is active."
            },
            {
                17289,
                @"'The maximum deceleration of the synchronization profile would be higher than the maximum deceleration of the slave axis.
                    Check when GearInSync_CheckMask_MaxDec is active."
            },
            {
                17290,
                @"'The maximum jerk of the synchronization profile would be higher than the maximum jerk of the slave axis.
            ...
            {
                17312,
                @"'Axis consequential error' Consequential error resulting from another causative error related to another axis. Axis consequential errors can occur in relation to master/slave couplings or with multiple axis interpolating DXD groups."
            },
            {
                17408,
            ...
            {
                19200,
                @"'Axis was stopped' The axis was stopped during travel to the target position. The axis may have been stopped with a PLC command via ADS, a call via AXFNC, or by the System Manager."
            },
            {
                19201,
                @"'Axis cannot be started' The axis cannot be started because:
            ...
            {
                19202,
                @"'Control mode not permitted' No target position control, and no position range control."
            },
            {
                19203,
                @"'Axis is not moving' The position and velocity can only be restarted while the axis is physically in motion."
            },
            {
                19204,
                @"'Invalid mode'
            ...
            {
                19208,
                @"'Axis is in protected mode' The axis is in protected mode (e.g., coupled) and cannot be moved."
            },
            { 19209, @"'Axis is not ready' The axis is not ready and cannot be moved." },
            {
                19210,
                @"'Error during referencing' Referencing (homing) of the axis could not be started or was not successful."
            },
            {
                19211,
                @"'Incorrect definition of the trigger input' The definition of the trigger signal for function block MC_TouchProbe is incorrect. The defined encoder-ID, the trigger signal or the trigger edge are invalid."
            },
            {
                19212,
                @"'Position latch was disabled' The function block MC_TouchProbe has detected that a measuring probe cycle it had started was disabled. The reason may be an axis reset, for example."
            },
            {
                19213,
                @"'NC status feedback timeout' A function was successfully sent from the PLC to the NC. An expected feedback in the axis status word has not arrived."
            },
            {
                19214,
                @"'Additional product not installed' The function is available as an additional product but is not installed on the system."
            },
            {
                19215,
                @"'No NC Cycle Counter Update' – The NcToPlc Interface or the NC Cycle Counter in the NcToPlc Interface was not updated."
            },
            {
                19216,
                @"'M-function query missing' This error occurs if the M-function was confirmed, but the request bit was not set."
            },
            {
                19217,
                @"'Zero shift index is outside the range' The index of the zero shift is invalid."
            },
            {
                19218,
                @"'R-parameter index or size is invalid' This error occurs if the R-parameters are written or read but the index or size are outside the range."
            },
            { 19219, @"'Index for tool description is invalid'" },
            {
                19220,
                @"'Version of the cyclic channel interface does not match the requested function or the function block' This error occurs if an older TwinCAT version is used to call new functions of a later TcNci.lib version."
            },
            {
                19221,
                @"'Channel is not ready for the requested function' The requested function cannot be executed, because the channel is in the wrong state. This error occurs during reverse travel, for example, if the axis was not stopped with ItpEStop first."
            },
            {
                19222,
                @"'Requested function is not activated' The requested function requires explicit activation."
            },
            {
                19223,
                @"'Axis is already in another group' The axis has already been added to another group."
            },
            {
                19224,
                @"'Block search could not be executed successfully' The block search has failed.
                    Possible causes:
                    Invalid block number"
            },
            {
                19225,
                @"'Invalid block search parameter' This error occurs if the FB ItpBlocksearch is called with invalid parameters (e.g., E_ItpDryRunMode, E_ItpBlockSearchMode)"
            },
            {
                19232,
                @"'Cannot add all axes' This error occurs if an auxiliary axis is to be added to an interpolation group, but the function fails. It is likely that a preceding instruction of an auxiliary axis was skipped."
            },
            {
                19248,
                @"'Pointer is invalid' A pointer to a data structure is invalid, e.g., Null
                    Data structure MC_CAM_REF was not initialized"
            },
            {
                19249,
                @"'Memory size invalid' The specification of the memory size (SIZE) for a data structure is invalid.
            ...
            {
                19251,
                @"'Point ID is invalid' The ID of a point (sampling point) of a motion function is less than 1."
            },
            {
                19252,
                @"'Number of points is invalid' The number of points (sampling points) of a cam plate to be read or written is less than 1."
            },
            {
                19253,
                @"'MC table type is invalid' The type of a cam plate does not match the definition MC_TableType."
            },
            {
                19254,
                @"'Number of rows invalid' The number of rows (sampling points) of a cam table is less than 1."
            },
            {
                19255,
                @"'Number of columns invalid' The number of columns of a cam table is invalid.
            ...
            {
                19256,
                @"'Step size invalid'. The increment for the interpolation is invalid, e.g., less than or equal to zero."
            },
            {
                19264,
                @"'Terminal type not supported' The terminal used is not supported by this function block."
            },
            { 19265, @"'Register read/write error' This error implies a validity error." },
            {
                19266,
                @"'Axis is enabled' The axis is enabled but should not be enabled for this process."
            },
            {
                19267,
                @"'Incorrect size of the compensation table' The specified table size (in bytes) does not match the actual size"
            },
            {
                19268,
                @"'The minimum/maximum position in the compensation table does not match the position in the table description (ST_CompensationDesc)"
            },
            {
                19269,
                @"'Not implemented' The requested function is not implemented in this combination"
            },
            {
                19270,
                @"'Window not in the specified modulo range' The parameterized min or max position is not in the specified modulo range"
            },
            {
                19271,
                @"'Buffer overflow' The number of events has led to an overflow of the buffer and not all events could be acquired."
            },
            {
                19296,
                @"'Motion command did not become active' A motion command has been started and has been buffered and confirmed by the NC. Nevertheless, the motion command did not become active (possibly due to a terminating condition or an internal NC error)."
            },
            {
                19297,
                @"'Motion command could not be monitored by the PLC' A motion command has been started and has been buffered and confirmed by the NC. The PLC has not been able to monitor the execution of this command and the execution status is unclear since the NC is already executing a more recent command. The execution state is unclear. This error may come up with very short buffered motion commands which are executed during one PLC cycle."
            },
            {
                19298,
                @"'Buffered command was terminated with an error' A buffered command was terminated with an error. The error number is not available, because a new command is already being executed."
            },
            {
                19299,
                @"'Buffered command was completed without feedback' A buffered command was completed but there was no feedback to indicate success or failure."
            },
            {
                19300,
                @"' 'BufferMode' is not supported by the command' The 'BufferMode' is not supported by this command."
            },
            {
                19301,
                @"'Command number is zero' The command number for queued commands managed by the system unexpectedly has the value 0."
            },
            {
                19302,
                @"'Function block was not called cyclically' The function block was not called cyclically. The command execution could not be monitored by the PLC, because the NC was already executing a subsequent command. The execution state is unclear."
            },
            {
                19313,
                @"'Invalid NCI entry type'. The FB FB_NciFeedTablePreparation was called with an unknown nEntryType."
            },
            {
                19314,
                @"'NCI feed table full' The table is full, and the entry is therefore not accepted.
                    Remedy:
            ...
            {
                19316,
                @"'ST_NciTangentialFollowingDesc: Tangential axis is not an auxiliary axis' In the entry for the tangential following, a tangential axis was named that is not an auxiliary axis."
            },
            {
                19317,
                @"'ST_NciTangentialFollowingDesc: nPathAxis1 or nPathAxis2 is not a path axis. It is therefore not possible to determine the plane."
            },
            {
                19318,
                @"'ST_NciTangentialFollwoingDesc: nPathAxis1 and nPathAxis2 are the same. It is therefore not possible to determine the plane."
            },
            ...
            {
                19321,
                @"'Tangential following: Monitoring of the deviation angle was activated during activation of tangential following (E_TfErrorOnCritical1), and an excessively large deviation angle was detected in the current segment."
            },
            ...
            {
                19325,
                @"'FB_NciFeedTablePreparation: the specified nEntryType does not match the structure type"
            },
            {
                19326,
                @"'ST_NciMFuncFast and ST_NciMFuncHsk: the requested M-function is not between 0 and 159"
            },
            {
                19327,
                @"'ST_NciDynOvr: the requested value for the dynamic override is not between 0.01 and 1"
            },
            {
                19328,
                @"'ST_NciVertexSmoothing: invalid parameter. This error is generated if a negative smoothing radius or an unknown smoothing type is encountered."
            },
            {
                19329,
                @"'FB_NciFeedTablePrepartion: The requested velocity is not in the valid range"
            },
            ...
            {
                19351,
                @"'An attempt was made to back up parameters again, although they have already been backed up."
            },
            {
                19352,
                @"'An attempt was made to restore parameters, although none have been backed up."
            },
            { 19359, @"'The abortion of a homing has failed." },
            {
                19360,
                @"'KinGroup error: the kinematic group is in an error state.
            ...
            {
                19376,
                @"'The current axis position or the axis position resulting from the new position offset exceeds the valid range of values."
            },
            {
                19377,
                @"'The new position offset exceeds the valid range of values [AX5000: 2^31]."
            },
            {
                19378,
                @"'The current axis position or the axis position resulting from the new position offset falls below the valid range of values."
            },
            {
                19379,
                @"'The new position offset falls below the valid range of values [AX5000: -2^31]."
            },
            {
                19380,
                @"'The activated feedback and/or storage location (AX5000: P-0-0275) differ from the parameterization on the function block."
            },
            {
                19381,
                @"'Reinitialization of the actual NC position has failed, e.g., reference system = 'ABSOLUTE (with single overflow)' & software end position monitoring is disabled."
            },
            {
                19382,
                @"'The command to set or delete a position offset was rejected without feedback data, e.g., if the drive controller's firmware does not support the corresponding command."
            },
            {
                19383,
                @"'The command to set or delete a position offset was rejected with feedback data. The information in the feedback data may contain further information about the cause.
            ...
            {
                19458,
                @"'Invalid axis position: The transformation can not be calculated with the current position data.
                    Possible causes:
                    The position is outside the working area of the kinematics"
            },
            {
                19459,
                @"'Invalid dimension: The dimension of the paramerterized input parameter does not match the dimension expected by the kinematic object.
                    Possible causes:
            ...
            {
                19475,
                @"'NCERR_RBTFRAME_INVALIDWCSTOMCS
            ...
            {
                33057,
                @"'Invalid environment for Object (e.g. TcCom-Object's Hierarchy or missing/faulty Objects)."
            },
            { 33058, @"'Incompatible Driver or Object." },
            {
                33060,
                @"'Command execution does not terminate (e. g. MC_Reset does not signal DONE)."
            },
            ...
            {
                33087,
                @"'Slave cannot synchronize. The slave cannot reach the SlaveSyncPosition with the given dynamics."
            },
            {
                33088,
                @"'Invalid value for one or more of the dynamic parameters (Acceleration, Deceleration, Jerk)."
            },
            { 33089, @"'IdentInGroup is invalid." },
            {
                33090,
                @"'The number of axes in the group is incompatible with the axes convention."
            },
            { 33091, @"'Function Block or respective Command is not supported by Target." },
            {
                33092,
                @"'Command queue full. Command queue is completely filled up and cannot accept additional commands until some commands are fully processed."
            },
            {
                33093,
                @"'Mapping of Cyclic Interface between NC and PLC is missing (e.g. AXIS_REF, AXES_GROUP_REF, ...)."
            },
            {
                33094,
                @"'Invalid Velocity Value. The velocity was not set or the entered value is invalid"
            },
            {
                33095,
                @"'Invalid Coordinate Dimension. The dimension of the set coordinate interpretation does not meet the requirements."
            },
            ...
            {
                33099,
                @"'Path buffer is invalid. E.g. because provided buffer has invalid address or is not big enough."
            },
            ...
            {
                33108,
                @"'Invalid Number of ACS Axes. The number of ACS input axes does not match the number of ACS input axes expected by the kinematic transformation."
            },
            {
                33109,
                @"'Invalid Number of MCS Data. The number of MCS input data does not match the number expected by the kinematic transformation."
            },
            {
                33110,
                @"'Invalid Value Set for Kinematic Parameters. The numeric value set for the parameter does not reside within the respective definition range."
            },
            {
                33112,
                @"'The Given ACS Values Cannot be Reached. The given ACS values result in an invalid machine configuration."
            },
            {
                33113,
                @"'The Set Target Positions Cannot be Reached. The set target positions reside outside the admissible working space."
            },
            { 33117, @"'Discontinuity in ACS axes detected. Discontinuity in ACS axes detected." },
            {
                33120,
                @"'Circle Specification in Path is invalid. The specification of a circle segment in the programmed interpolated path (e.g. via MC_MovePath) has an invalid or ambiguous description. Probably its center cannot be determined reliably."
            },
            {
                33121,
                @"'Maximum stream lines reached. The maximum number of stream lines is limited. Please refer to function block documentation for details."
            },
            {
                33123,
                @"'Invalid First Segment. The corresponding element can only be analyzed with a well-defined start point."
            },
            { 33124, @"'Invalid auxiliary point. The auxiliary point is not well-defined." },
            {
                33126,
                @"'Invalid parameter for GapControlMode. Invalid parameter for GapControlMode, most likely in combination with the group parameter GapControlDirection."
            },
            {
                33127,
                @"'Group got unsupported Axis Event (e.g. State Change). Group got unsupported Axis Event (e.g. State Change e.g. triggered by a Single Axis Reset)."
            },
            {
                33128,
                @"'Unsupported Compensation Type. The compensation type was either not set or is not supported by the addressed object."
            },
            { 33129, @"'Master axis does not exist or cannot be used." },
            {
                33130,
                @"'Invalid or Missing Tracking Transformation. This error occurs at MC_TrackConveyorBelt if at the CoordTransform input an invalid object ID is used or the object ID points to an object that is not supported as coordinate transformation."
            },
            {
                33131,
                @"'Position is not on Track. Either Track cannot be activated because Actual Position is not on Track, or Target Position is not on Active Track or TrackPart"
            },
            { 33132, @"'Axis does not have an activated track." },
            {
                33133,
                @"'Invalid Compensation ObjectId. An Object with this ObjectId does not exist or it is not of the right type (has to be a compensation)."
            },
            {
                33134,
                @"'Axis is in error because axis was not in Target when InTargetAlarm Timer expired."
            },
            {
                33135,
                @"'Coupling would cause a cyclic dependency of axis (e.g. via MC_GearInPos)."
            },
            { 33136, @"'Axis was not added to an axes group, the command is not valid." },
            { 33151, @"'Drive has invalid State." },
            {
                33153,
                @"'Parameter for gap control are invalid with the current configuration. Function block with gap control was issued to an axis that is not in a CA group"
            },
            {
                33154,
                @"'Software position limit violation. Software position limits of at least one axis have been or would have been violated by a command."
            },
            {
                33155,
                @"'Target position is not reachable. There is no path available to the target position or target position is unreachable in general."
            },
            {
                33157,
                @"'The mover or one of its relevant coordinates is busy. Either the whole mover or at least of its coordinates relevant to the command are busy."
            },
            {
                33158,
                @"'A collision has occured or would occur. Either a collision has occurred or would occur if the command was executed."
            },
            { 33159, @"'Invalid Track Specification." },
            { 33160, @"'Command not allowed in track state." },
            {
                33161,
                @"'Invalid Reference passed to Function Block. An invalid reference (or pointer) was used in a function block call. This can happen if a reference type is used before it was initialized."
            },
            {
                33162,
                @"'Path is locked against modifications. The path was locked to further changes. However, it might be resettable."
            },
