...
{
    public class T07_TcoSequenceNonAutoRestorableTests
    {
        TcoSequenceNonAutoRestorableTest tc = ConnectorFixture
            .Connector
            .MAIN
        ...
        public void T700_ExternalSequenceNumberOfStepsCount()
        {
            ...
            Assert.AreEqual(initStepId, tc._sequencer._currentStepId.Synchron); //Check if the initial StepId was written to the current step of the sequencer
            Assert.AreEqual("---test---init---", tc._sequencer._currentStepDescription.Synchron); //Check if the initial StepDescription was written to the current step of the sequencer
            ...
            Assert.AreEqual(
                ...
                tc._sequencer._currentStepStatus.Synchron
        ...
        public void T702_ExternalSequenceOnStepCompleted()
        {
            ...
            Assert.AreEqual(
                psc + tc.GetNumberOfStepsInSequence(), //The actual value of the call of the method PostStepComplete() should increment exactly by number of the steps in the sequence, as each step is completed.
        ...
        public void T703_ExternalSequenceOnSequenceCompleted()
        {
            ...
            Assert.AreEqual(
                psc + 1, //The actual value of the call of the method PostStepComplete() should increment exactly by number of the steps in the sequence, as each step is completed.
        ...
        public void T705_ExternalSequenceOnStateChangeWithRestoreCallInside()
        {
            ...
            Assert.AreEqual("Step 1", tc._sequencer._currentStepDescription.Synchron); //Check if StepDescription changes to Step 1.
            Assert.AreEqual(
                30, //Check if current step status is Running.
                tc._sequencer._currentStepStatus.Synchron
            ); //None := 0 , Disabled:= 10 , ReadyToRun:= 20 , Running:= 30, Done:= 40, Error := 50
            Assert.IsFalse(tc._sequencer._sequencerHasError.Synchron); //Check if seuencer has no error
            Assert.AreEqual(0, tc._sequencer._sequencerErrorId.Synchron);
        ...
        public void T706_ExternalSequenceTooLowStepId()
        {
            ...
            Assert.AreEqual(70, tc._sequencer._sequencerErrorId.Synchron);
        }

        [Test, Order(706)]
        public void T706_ExternalSequenceMinStepId()
        {
            numberOfSteps = 10;
            tc.SingleCycleRun(() => tc.Restore()); //Restore sequencer to its initial state, reset all step counters, timers and all additional values
            tc.SingleCycleRun(() => tc.SetCyclicMode()); //Set sequencer into the cyclic mode
            ...
            Assert.AreEqual("Step 1", tc._sequencer._currentStepDescription.Synchron); //Check if StepDescription changes to the expected step message.
            Assert.AreEqual(
                30, //Check if current step status is Running.
                tc._sequencer._currentStepStatus.Synchron
            ); //None := 0 , Disabled:= 10 , ReadyToRun:= 20 , Running:= 30, Done:= 40, Error := 50
        ...
        [Test, Order(707)]
        public void T707_ExternalSequenceMaxStepId()
        {
            numberOfSteps = 10;
            tc.SingleCycleRun(() => tc.Restore()); //Restore sequencer to its initial state, reset all step counters, timers and all additional values
            tc.SingleCycleRun(() => tc.SetCyclicMode()); //Set sequencer into the cyclic mode
            ...
            Assert.IsTrue(tc._sequencer._sequencerHasError.Synchron); //Check if seuencer has error
            Assert.AreEqual(80, tc._sequencer._sequencerErrorId.Synchron);
            ...
            Assert.AreEqual("Step 0", tc._sequencer._currentStepDescription.Synchron); //Check if StepDescription changes to the expected step message.
            Assert.AreEqual(
        ...
        public void T710_PLCSequenceCheckUniquenessFirstCycle()
        {
            ...
            Assert.AreEqual(
                tc.GetNumberOfStepsInSequence(), //Check if number of the stored steps is same as the number of the counted steps
            ...
            Assert.AreEqual(initStepDescription, tc._sequencer._currentStepDescription.Synchron); //Check if StepDescription does not change. As the StepId uniqueness control has not yet been performed,
        ...
        public void T712_PLCSequenceRestoreAlreadyCheckedSequence()
        {
            ...
            Assert.AreEqual(
                resetCycleCount + 1, //Check if only one restore of the sequencer was was performed, as it was expected
        ...
        public void T713_PLCSequenceNotUniqueStepIdFirstCycle()
        {
            ...
            //2Bremoved =>
            Assert.AreNotEqual(initStepDescription, tc._sequencer._currentStepDescription.Synchron); //Check if StepDescription change from initStepDescription due to StepId uniqueness control error.
            Assert.AreEqual(
        ...
        public void T714_PLCSequenceNotUniqueStepIdSecondCycle()
        {
            ...
            Assert.GreaterOrEqual(
                onSequencerErrorCount + 10, //Check if OnSequencerErrorCount has been incremented by 10-NotUniqueStepId
                tc._sequencer._onSequencerErrorCount.Synchron
            );
        }
        ...
        public void T718_PLCSequenceAfterErrorRestoreThirdCycle()
        {
            ...
            Assert.AreEqual(
                "Step number 1", //Check if StepId changes from "Step number 0" to "Step number 1".
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
                40, //Check if current step status is Done.
        ...
        public void T730_OpenCloseSequenceFirstCycle()
        {
            ...
            Assert.AreEqual(
                numberOfSteps + 1, //Check if OrderOfTheCurrentlyEvaluatedStep that represent total number of calls of the method Step() in this sequence is equal to
                tc.GetOrderOfTheCurrentlyEvaluatedStep()
            ); //expected value
        }
        ...
        public void T731_OpenCloseSequenceSecondCycle()
        {
            ...
            tc.SequencerSingleCycleRun(() => //"Step " + numberOfSteps, with step status Done
            {
                ...
                tc.UpdateCurrentStepDetails();
                Assert.AreEqual(
                    numberOfSteps + 1, //OrderOfTheCurrentlyExecutedStep should have value of numberOfSteps + 1 as all steps was completed
                    tc.GetOrderOfTheCurrentlyExecutedStep()
                );
                Assert.AreEqual(
                    numberOfSteps + 1, //OrderOfTheCurrentlyEvaluatedStep should have value of numberOfSteps + 1 as it is number of calls of the method Step()
                    tc.GetOrderOfTheCurrentlyEvaluatedStep()
                ); //after call of the method Open()
                tc.SequenceComplete();
            });
            ...
            Assert.AreEqual(
                numberOfSteps, //Check if StepId stays at the last step StepId.
                tc._sequencer._currentStepId.Synchron
            );
            Assert.AreEqual(
                "Step " + numberOfSteps.ToString(), //Check if StepDescription stays at the last step StepDescription.
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
                40, //Check if current step status is Done.
        ...
        public void T732_OpenCloseSequenceThirdCycle()
        {
            ...
            tc.SequencerSingleCycleRun(() => //"Step " + numberOfSteps, with step status Done
            {
                tc.UpdateCurrentStepDetails();
                Assert.AreEqual(
                    0, //OrderOfTheCurrentlyExecutedStep should have value of zero as it has been reseted by call of the method SequenceComplete() in
                    tc.GetOrderOfTheCurrentlyExecutedStep()
                ); //the previous test
                Assert.AreEqual(0, tc.GetOrderOfTheCurrentlyEvaluatedStep()); //OrderOfTheCurrentlyEvaluatedStep should have value of zero as new call of the method Open() has been performed
            });
            tc.UpdateCurrentStepDetails();
            ...
            Assert.AreEqual(
                numberOfSteps, //Check if StepId stays at the last step StepId as before, as no new call of the method Step() has been performed
                tc._sequencer._currentStepId.Synchron
            );
            Assert.AreEqual(
                "Step " + numberOfSteps.ToString(), //Check if StepDescription stays at the last step StepDescription as before, as no new call of the method Step() has been performed
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
                40, //Check if current step status is Done  as before, as no new call of the method Step() has been performed
                tc._sequencer._currentStepStatus.Synchron
            ); //None := 0 , Disabled:= 10 , ReadyToRun:= 20 , Running:= 30, Done:= 40, Error := 50
        }
        ...
        public void T733_OpenCloseSequenceFourthCycle()
        {
            ...
            Assert.AreEqual(1, tc.GetOrderOfTheCurrentlyEvaluatedStep()); //OrderOfTheCurrentlyEvaluatedStep should have value of one as it was reseted by call of the method Open(), but method call Step() increments this value
            Assert.AreEqual(
        ...
        public void T744_RequestStepToNotExistingStepFirstCycle()
        {
            ...
            tc.UpdateCurrentStepDetails();
            Assert.AreEqual(
                reqStep, //Check if StepId stays reqStep as before
                tc._sequencer._currentStepId.Synchron
            );
            Assert.AreEqual(
                "Step " + reqStep.ToString(), //Check if StedDescription stays in "Step " + reqStep as before
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
                40, //Check if current step status stays in Running as before
                tc._sequencer._currentStepStatus.Synchron
            ); //None := 0 , Disabled:= 10 , ReadyToRun:= 20 , Running:= 30, Done:= 40, Error := 50
        }
        ...
        public void T745_RequestStepToNotExistingStepSecondCycle()
        {
            ...
            Assert.AreEqual(
                "Step " + reqStep.ToString(), //Check if StepId stays in "Step " + reqStep as before
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
                40, //Check if current step status stays in Running as before
        ...
        public void T746_RequestStepToNotExistingStepThirdCycle()
        {
            ...
            Assert.AreEqual(
                "REQUESTED STEP_ID: "
                    + //Check if StepDescription changes from value "Step " + reqstep to the expected error message
        ...
        public void T761_RequestStepCallingCyclicallySecondCycle()
        {
            ...
            Assert.AreEqual(
                10, //Check if StepId changes to two
                tc._sequencer._currentStepId.Synchron
            );
            Assert.AreEqual(
                "Step 10", //Check if StepDescription changes to "Step 2"
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
                30, //Check if current step status changes to Running
        ...
        public void T762_RequestStepCallingCyclicallyNext20Cycle()
        {
            ...
            Assert.AreEqual(initCycle, cycle); //Check it the RequestStepCycle value was succesfully written
            cycle = 0;
            tc.SequencerRunUntilEndConditionIsMet(
                action: () => //Step 10 is active from the previous PLC cycle, so at first call of this method Step 10 is executed
        ...
        public void T770_SetStepMode()
        {
            ...
            tc.UpdateCurrentStepDetails();
            Assert.AreEqual(initStepId, tc._sequencer._currentStepId.Synchron); //Check if the initial StepId was written to the current step of the sequencer
            Assert.AreEqual(initStepDescription, tc._sequencer._currentStepDescription.Synchron); //Check if the initial StepDescription was written to the current step of the sequencer
            Assert.AreEqual(0, tc.GetNumberOfStepsInSequence()); //Check if the number of the steps was succesfully cleared
        ...
        public void T781_ExternalSequenceStepModeNextNcyclesWithStepInMethodCall()
        {
            cycle = 0;
            tc.SequencerRunUntilEndConditionIsMet(
                action: () => //After execution of this method, actual StepId should have value of numberOfSteps, as stepmode is on and StepIn()
            ...
            tc.UpdateCurrentStepDetails();
            Assert.AreEqual(
                numberOfSteps, //Check if StepId changes to numberOfSteps.
                tc._sequencer._currentStepId.Synchron
            ); //
            Assert.AreEqual(
                "Step " + numberOfSteps.ToString(), //Check if StepDescription changes to "Step " + numberOfSteps.
                tc._sequencer._currentStepDescription.Synchron
            ); //
            Assert.AreEqual(
        ...
        public void T790_PLCSequenceCheckUniquenessStepModeFirstCycle()
        {
            ...
            Assert.AreEqual(initStepDescription, tc._sequencer._currentStepDescription.Synchron); //Check if StepDescription does not change. As the StepId uniqueness control control has not yet been performed,
            //the step logic is not executed, even if entering or transition conditions are met
        }
        ...
        public void T792_PLCSequenceCheckUniquenessStepModeThirdCycle()
        {
            ...
            tc.UpdateCurrentStepDetails();
            Assert.AreEqual(
                cycleCount + 1, //Check if only one PLC cycle was performed
        ...
        public void T794_PLCSequenceNotUniqueStepIdInStepModeFirstCycle()
        {
            ...
            Assert.AreNotEqual(initStepDescription, tc._sequencer._currentStepDescription.Synchron); //Check if StepDescription change from initStepDescription due to StepId uniqueness control control error.
            Assert.AreEqual(
                "ERROR NOT UNIQUE STEP_ID "
                    + //Check if StepDescription change, due to StepId uniqueness control error to the expected error message
                    lastStepId.ToString(),
        ...
        public void T811_StepModeStepIn()
        {
            cycle = 0;
            tc.SequencerRunUntilEndConditionIsMet(
                action: () => //After running this method, sequencer should stay in StepId 3, with StepDescription "Step 3"
        ...
        public void T812_StepModeChangeStepIdDuringExecution()
        {
            cycle = 0;
            tc.SequencerRunUntilEndConditionIsMet(
                action: () => //After running this method, sequencer should stay in error,
        ...
        public void T818_StepModeCommentOutTest()
        {
            ...
            Assert.AreEqual(
                "ERROR, STEP ORDER CHANGED DURING STEP EXECUTION FROM: 3=>1",
                tc.GetTextOfTheMostImportantMessage()
            ); //Check if messenger return the expected error message
            Assert.AreEqual(
                true, //Check if sequence returns error
                tc.SequencerHasError()
            );
        ...
        public void T830_StepModePrepareForRequestStepFromLowerToHigher()
        {
            ...
            Assert.AreEqual(
                "(>Step 1<)", //Check if StepDescription changes from "Initial step" to "(>Initial step<)". As the StepId uniqueness control control has
                tc._sequencer._currentStepDescription.Synchron
            ); //already been performed, the step logic is executed.
            Assert.AreEqual(
                20, //Check if current step status is ReadyToRun.
        ...
        public void T831_StepModeRequestStepFromLowerToHigher()
        {
            ...
            Assert.AreEqual(
                "(>Step " + reqStep.ToString() + "<)", //Check if StepDescription changes to "(>Step reqStep<)". As the StepId uniqueness control control has
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
                20, //Check if current step status is ReadyToRun.
        ...
        public void T832_StepModePrepareForRequestStepFromHigherToLower()
        {
            ...
            Assert.AreEqual(
                0, //Check if StepId stays at 0.
                tc._sequencer._currentStepId.Synchron
            ); //As no StepIn() method was called, sequence should stay in step 0
            Assert.AreEqual(
        ...
        public void T833_StepModeRequestStepFromHigherToLowerTriggered()
        {
            cycle = 0;
            tc.SequencerRunUntilEndConditionIsMet(
                action: () => //After running this method, sequencer should stay in StepId reqStep + 5,
        ...
        public void T835_StepModeRequestStepToNotExistingStepFirstCycle()
        {
            ...
            Assert.AreEqual(
                "(>Step " + reqStep.ToString() + "<)", //Check if StepDescription stays in "Step " + reqStep as before
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
                40, //Check if current step status stays in ReadyToRun as before
                tc._sequencer._currentStepStatus.Synchron
            ); //None := 0 , Disabled:= 10 , ReadyToRun:= 20 , Running:= 30 , Done:= 40, Error := 50
        }
        ...
        public void T837_StepModeRequestStepToNotExistingStepThirdCycle()
        {
            ...
            Assert.AreEqual(
                50, //Check if the sequencer error is of the type RequestedUidDoesNotExist
                tc.GetSequencerErrorId()
            ); //noerror := 0, NotUniqueStepId:= 10, StepIdHasBeenChanged:= 20, OrderOfTheStepHasBeenChanged:= 40, StepWithRequestedIdDoesNotExists:= 50,SeveralRequestStep:= 60
            Assert.AreEqual(
                50, //Check if step status is Error
        ...
        public void T842_StepModePrepareForDisableStepTestNext2Cycles()
        {
            ...
            cycle = 0;
            tc.SequencerRunUntilEndConditionIsMet(
                action: () => //After running this method, sequencer should stay in StepId 1, with StepDescription "(>Step 1<)"
                { //Step status should be ReadyToRun
                    if (tc.Step(0, true, "Initial step"))
                    {
                        tc.StepCompleteWhen(true);
        ...
        public void T843_StepModePrepareForDisabledStepTest()
        {
            ...
            Assert.AreEqual(0, tc._sequencer._onStateChangeCount.Synchron);
            Assert.AreEqual(-1, tc._sequencer._stateChangeFrom.Synchron);
            Assert.AreEqual(-1, tc._sequencer._stateChangeTo.Synchron);
        }
        ...
        public void T845_StepModeStepInAfterStepInCallOnDisabledStep()
        {
            ...
            Assert.AreEqual(1, tc._sequencer._onStateChangeCount.Synchron);
            Assert.AreEqual(0, tc._sequencer._stateChangeFrom.Synchron);
            Assert.AreEqual(2, tc._sequencer._stateChangeTo.Synchron);
        }
        ...
        public void T873_StepModeRequestStepToTheLastStepOfTheSequence()
        {
            ...
            tc.UpdateCurrentStepDetails();
            Assert.AreEqual(
                numberOfSteps, //Check if StepId changes from 2 to numberOfSteps
                tc._sequencer._currentStepId.Synchron
            );
            Assert.AreEqual(
                "(>Step "
                    + numberOfSteps.ToString() //Check if StepDescription changes from "(>Step 2<)" to "(>Step + numberOfSteps<)"
                    + "<)",
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
        ...
        public void T874_StepModeStepForward()
        {
            ...
            tc.UpdateCurrentStepDetails();
            Assert.AreEqual(
                numberOfSteps, //Check if StepId stays at numberOfSteps
                tc._sequencer._currentStepId.Synchron
            );
            Assert.AreEqual(
                "(>Step "
                    + numberOfSteps.ToString() //Check if StepDescription stays "(>Step + numberOfSteps<)"
                    + "<)",
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
        ...
        public void T875_StepModeStepBackward()
        {
            ...
            tc.UpdateCurrentStepDetails();
            Assert.AreEqual(
                numberOfSteps - 1, //Check if StepId changes from numberOfSteps to  numberOfSteps - 1
                tc._sequencer._currentStepId.Synchron
            );
            Assert.AreEqual(
                "(>Step "
                    + //Check if StepDescription changes from "(>Step + numberOfSteps<)" to  "(>Step + numberOfSteps - 1<)"
        ...
        public void T876_StepModeRequestBeforeFirstStepOfTheSequence()
        {
            ...
            Assert.AreEqual(
                "(>Step 1<)", //Check if StepDescription changes from "(>Step + numberOfSteps - 1<)" to  "(>Step 1<)"
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
                20, //Check if current step status stays at ReadyToRun
        ...
        public void T882_StepModeStepInIntoTheStepInsideWhichRequestStepToTheLastStepOfTheSequence()
        {
            ...
            tc.UpdateCurrentStepDetails();
            Assert.AreEqual(
                numberOfSteps, //Check if StepId changes from 1 to numberOfSteps
                tc._sequencer._currentStepId.Synchron
            );
            Assert.AreEqual(
                "(>Step "
                    + numberOfSteps.ToString() //Check if StepDescription changes from "(>Step 1<)" to "(>Step + numberOfSteps<)"
                    + "<)",
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
        ...
        public void T883_StepModeStepInAfterRequestStepToTheLastStepOfTheSequenceWasCalled()
        {
            ...
            Assert.AreEqual(
                "Step " + numberOfSteps.ToString(), //Check if StepDescription changes from "(>Step 1<)" to "(>Step + numberOfSteps<)"
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
        ...
        public void T884_StepModeStepInFromLastStepOfTheSequence()
        {
            ...
            tc.UpdateCurrentStepDetails();
            Assert.AreEqual(
                0, //Check if StepId changes from 1 to numberOfSteps
                tc._sequencer._currentStepId.Synchron
            );
            Assert.AreEqual(
                "(>Step 0<)", //Check if StepDescription changes from "(>Step 1<)" to "(>Step + numberOfSteps<)"
                tc._sequencer._currentStepDescription.Synchron
            );
            Assert.AreEqual(
        ...
        public void T891_SwitchStepModeOnDuringStepExecution()
        {
            cycle = 0;
            tc.SequencerRunUntilEndConditionIsMet(
                action: () => //After execution of this method, actual StepId should have value of 2
        ...
        public void T893_SwitchStepModeStepForwardFromRunningStep()
        {
            ...
            plcCycle = 0;
            tc.SequencerRunUntilEndConditionIsMet(
                action: () => //After execution of this method, actual StepId should have value of 3
        ...
        public void T899_OnStateChangeWhenChangingModes()
        {
            ...
            //Cyclic mode
            tc.SetCyclicMode(); //This set sequence to cyclic mode
            tc.SequencerMultipleCyclesRun(
                () => //Performs cyclicCycles of the complete sequence. OnStateChange should be called cyclicCycles * numberOfSteps + numberOfSteps - 1 times.
                {
            ...
            Assert.AreEqual(
                onStateChangeCount + stepInEvents,
            ...
            ulong PostSequenceCompleteCount =
                2 * (ulong)cyclicCycles
                + (ulong)Math.Ceiling((decimal)(stepInEvents / (numberOfSteps + 1)));
            Assert.AreEqual(
                PostSequenceCompleteCount,
                tc._sequencer._onSequenceCompleteCount.Synchron
            );
        }
    }
