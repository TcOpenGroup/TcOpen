...
{
    public class T05_TcoSequenceAutoRestorableTests
    {
        TcoSequenceAutoRestorableTest tc = ConnectorFixture
            .Connector
            .MAIN
        ...
        public void T512_PLCSequenceRestoreAlreadyCheckedSequence()
        {
            ...
            Assert.AreEqual(
                restoreCycleCount + 1, //Check if only one restore of the sequencer was was performed, as it was expected
