...
namespace TcoCoreUnitTests.PlcExecutedTests
{
    public class T05_TcoSequencerTests
    {
        ...
        public void T513_NotUniqueStepId()
        {
            ...
            tc._done.Synchron = false;
            tc.ExecuteProbeRun(
                (int)eTcoSequencerTests.RestoreAlreadyCheckedSequence,
                () => tc._done.Synchron
            );
        ...
        public void T530_OpenCloseSequence()
        {
            ...
            Assert.AreEqual(0, tc._sut_A.GetOrderOfTheCurrentlyEvaluatedStep()); //OrderOfTheCurrentlyEvaluatedStep should have value of zero as new call of the method Open() has been performed

            Assert.AreEqual(
                0, //OrderOfTheCurrentlyExecutedStep should have value of zero as it has been reseted by call of the method SequenceComplete() in
                tc._sut_N.GetOrderOfTheCurrentlyExecutedStep()
            ); //the previous test
            Assert.AreEqual(0, tc._sut_N.GetOrderOfTheCurrentlyEvaluatedStep()); //OrderOfTheCurrentlyEvaluatedStep should have value of zero as new call of the method Open() has been performed
            ...
            Assert.AreEqual(
                0, //OrderOfTheCurrentlyEvaluatedStep should have value of zero as it was reseted by call of the method Open()
                tc._sut_A.GetOrderOfTheCurrentlyEvaluatedStep()
            );
            Assert.AreEqual(
            ...
            Assert.AreEqual(1, tc._sut_A.GetOrderOfTheCurrentlyEvaluatedStep()); //OrderOfTheCurrentlyEvaluatedStep should have value of one as it was reseted by call of the method Open(), but method call Step() increments this value
            Assert.AreEqual(
            ...
            Assert.AreEqual(1, tc._sut_N.GetOrderOfTheCurrentlyEvaluatedStep()); //OrderOfTheCurrentlyEvaluatedStep should have value of one as it was reseted by call of the method Open(), but method call Step() increments this value
            Assert.AreEqual(
                0, //Check if StepId changes to zero
                tc._sut_N._currentStep.ID.Synchron
            );
        ...
        [
            Test,
            Order((int)eTcoSequencerTests.RequestStepWhilePreviousRequestStepHasNotBeenYetProcessed)
        ]
        public void T547_RequestStepWhilePreviousRequestStepHasNotBeenYetProcessed()
        {
            ...
            tc.ExecuteProbeRun(
                1,
                (int)eTcoSequencerTests.RequestStepWhilePreviousRequestStepHasNotBeenYetProcessed
            );
            Assert.IsTrue(tc._arranged.Synchron);
            Assert.IsFalse(tc._done.Synchron);
        ...
        public void T551_DisableStepEnabledAndActiveInPreviousPLCcycle()
        {
            ...
            tc.ExecuteProbeRun(
                1,
                (int)eTcoSequencerTests.DisableStepEnabledAndActiveInPreviousPLCcycle
            );
            Assert.IsTrue(tc._arranged.Synchron);
            Assert.IsFalse(tc._done.Synchron);
        ...
        public void T560_RequestStepCallingCyclically()
        {
            ...
            tc.ExecuteProbeRun(
                (ulong)cycle - 1,
                (int)eTcoSequencerTests.RequestStepCallingCyclically
            );
        ...
        [Test, Order((int)eTcoSequencerTests.CheckStepIdUniquenessStepMode)]
        ...
        public void T601_InvalidModeDetailed()
        {
            ...
            tc.ExecuteProbeRun(1, (int)eTcoSequencerTests.InvalidModeDetailed);
            Assert.IsTrue(tc._arranged.Synchron);
            Assert.IsFalse(tc._done.Synchron);
        ...
        [Test, Order((int)eTcoSequencerTests.StepInErrorDetailed)]
        ...
        [Test, Order((int)eTcoSequencerTests.StepModeStepIn)]
        ...
        [Test, Order((int)eTcoSequencerTests.StepModeChangeStepIdDuringExecution)]
        public void T612_StepModeChangeStepIdDuringExecution()
        {
            tc.ExecuteProbeRun(2, (int)eTcoSequencerTests.StepModeChangeStepIdDuringExecution);
            Assert.AreEqual(2, tc._plcCycleCounter.Synchron);
            Assert.IsFalse(tc._done.Synchron);
        ...
        [Test, Order((int)eTcoSequencerTests.StepModeChangeStepOrder)]
        ...
        [Test, Order((int)eTcoSequencerTests.StepModeCommentOutPartOfRunningSequencer)]
        ...
        [Test, Order((int)eTcoSequencerTests.StepModeUncommentPartOfRunningSequencer)]
        ...
        public void T633_StepModeRequestStepFromHigherToLower()
        {
            ...
            tc.ExecuteProbeRun(
                (ulong)reqStep + 5,
                (int)eTcoSequencerTests.StepModeRequestStepFromHigherToLower
            );
        ...
        [Test, Order((int)eTcoSequencerTests.StepModeRequestStepToNotExistingStep)]
        ...
        [Test, Order((int)eTcoSequencerTests.StepModeDisabledStep)]
        public void T641_StepModeDisabledStep()
        {
            ...
            tc.ExecuteProbeRun(1, (int)eTcoSequencerTests.StepModeDisabledStep);
            Assert.IsTrue(tc._arranged.Synchron);
            Assert.IsFalse(tc._done.Synchron);
        ...
        public void T699_OnStateChangeWhenChangingModes()
        {
            ...
            tc.ExecuteProbeRun(
                cyclicCycles,
                (int)eTcoSequencerTests.OnStateChangeWhenChangingModes
            );
