...
namespace TcoCoreUnitTests.PlcExecutedTests
{
    public class T03_TcoTaskTests
    {
        ...
        public void T300_TaskInvokeAndWaitForDone()
        {
            ...
            //Act
            tc.ExecuteProbeRun(
                (int)eTcoTaskTests.TaskInvokeAndWaitForDone,
                () => tc._done.Synchron
            );
        ...
        public void T301_TaskInvokeAfterDoneWithNoEmptyCycles()
        {
            ...
            //Act
            tc.ExecuteProbeRun(
                (int)eTcoTaskTests.TaskInvokeAfterDoneWithNoEmptyCycles,
                () => tc._done.Synchron
            );
            //Assert
            GetCounterValues(); //Readout all counter values from test instance into the _1 variables
        ...
        public void T302_TaskInvokeAfterDoneWithOneEmptyCycle()
        {
            ...
            //Act
            tc.ExecuteProbeRun(
                (int)eTcoTaskTests.TaskInvokeAfterDoneWithOneEmptyCycle,
                () => tc._done.Synchron
            );
            //Assert
            GetCounterValues(); //Readout all counter values from test instance into the _1 variables
        ...
        public void T303_TaskInvokeAfterDoneWithAbortCall()
        {
            ...
            //Act
            tc.ExecuteProbeRun(
                (int)eTcoTaskTests.TaskInvokeAfterDoneWithAbortCall,
                () => tc._done.Synchron
            );
            //Assert
            GetCounterValues(); //Readout all counter values from test instance into the _1 variables
        ...
        public void T304_TaskInvokeAfterDoneWithRestoreCall()
        {
            ...
            //Act
            tc.ExecuteProbeRun(
                (int)eTcoTaskTests.TaskInvokeAfterDoneWithRestoreCall,
                () => tc._done.Synchron
            );
            //Assert
            GetCounterValues(); //Readout all counter values from test instance into the _1 variables
        ...
        public void T305_TaskAbortDuringExecutionAndInvoke()
        {
            ...
            //Act
            tc.ExecuteProbeRun(
                (int)eTcoTaskTests.TaskAbortDuringExecutionAndInvoke,
                () => tc._done.Synchron
            );
            //Assert
            GetCounterValues(); //Readout all counter values from test instance into the _1 variables
        ...
        public void T310_TaskError()
        {
            ...
            Assert.AreEqual(A_onErrorCounter_0 + 1, A_onErrorCounter_1);
            Assert.IsTrue(
                (A_whileErrorCounter_1 - A_whileErrorCounter_0)
                    > (A_onErrorCounter_1 - A_onErrorCounter_0)
            );
        ...
        public void T311_TaskInvokeAfterErrorNoRestoreNoEmptyCycles()
        {
            ...
            tc.ExecuteProbeRun(
                (ulong)(1 + cycles_A),
                (int)eTcoTaskTests.TaskInvokeAfterErrorNoRestoreNoEmptyCycles
            );
        ...
        public void T312_TaskInvokeAfterErrorNoRestoreOneEmptyCycle()
        {
            ...
            tc.ExecuteProbeRun(
                (ulong)(2 + cycles_A),
                (int)eTcoTaskTests.TaskInvokeAfterErrorNoRestoreOneEmptyCycle
            );
            //Assert
            Assert.IsTrue(tc._to_A._sut_A._isError.Synchron); //Task should stay in Error, not Done, not Busy, as before.
            Assert.IsFalse(tc._to_A._sut_A._isBusy.Synchron);
        ...
        public void T330_ElapsedTypeMeasurement()
        {
            ...
            tc.ExecuteProbeRun(
                (int)eTcoTaskTests.ElapsedTypeMeasurement,
                () => tc._to_A._sut_A._taskState.Synchron == (short)eTaskState.Done
            );
        ...
        public void T360_TaskExecuteMethodNotCalled()
        {
            ...
            Assert.AreEqual(
                "Cyclic execution of the task not called. Make sure you are calling Execute() method cyclically in the call tree of the context.",
                message.Text
            );
