...
namespace TcoCoreUnitTests.PlcExecutedTests
{
    ...
    public class T05_TcoSequenceTests
    {
        ...
        public void T513_NotUniqueStepId()
        {
            ...
            tc._done.Synchron = false;
            tc.ExecuteProbeRun((int)eTcoSequenceTests.RestoreAlreadyCheckedSequence,()=>tc._done.Synchron);
        ...
        [Test, Order((int)eTcoSequenceTests.RequestStepWhilePreviousRequestStepHasNotBeenYetProcessed)]
        public void T547_RequestStepWhilePreviousRequestStepHasNotBeenYetProcessed()
        {
            ...
            tc.ExecuteProbeRun(1, (int)eTcoSequenceTests.RequestStepWhilePreviousRequestStepHasNotBeenYetProcessed);
            Assert.IsTrue(tc._arranged.Synchron);
            Assert.IsFalse(tc._done.Synchron);
        ...
        public void T551_DisableStepEnabledAndActiveInPreviousPLCcycle()
        {
            ...
            tc.ExecuteProbeRun(1, (int)eTcoSequenceTests.DisableStepEnabledAndActiveInPreviousPLCcycle);
            Assert.IsTrue(tc._arranged.Synchron);
            Assert.IsFalse(tc._done.Synchron);
        ...
        public void T560_RequestStepCallingCyclically()
        {
            ...
            tc.ExecuteProbeRun((ulong)cycle-1, (int)eTcoSequenceTests.RequestStepCallingCyclically);
        ...
        public void T633_StepModeRequestStepFromHigherToLower()
        {
            ...
            tc.ExecuteProbeRun((ulong)reqStep + 5, (int)eTcoSequenceTests.StepModeRequestStepFromHigherToLower);
        ...
        [Test, Order((int)eTcoSequenceTests.StepModeRequestStepWhilePreviousRequestStepHasnotBeenYetProcessed)]
        ...
        public void T699_OnStateChangeWhenChangingModes()
        {
            ...
            //Step mode
            tc.ExecuteProbeRun((ulong)stepInEvents + 1, (int)eTcoSequenceTests.OnStateChangeWhenChangingModes);
        ...
        public void T6100_MissedSequenceOpening()
        {
            ...
            Assert.AreEqual("Sequencer is not opened. You must call `Open` method before any step.", tc._sut_A._openingClosingErrorMessenger._mime.PlainMessage.Text);
