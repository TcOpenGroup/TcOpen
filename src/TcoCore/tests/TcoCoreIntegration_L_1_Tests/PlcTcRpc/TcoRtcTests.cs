...
namespace TcoCoreUnitTests.PlcTcRpc
{
    ...
    {
        TcoCoreTests.TcoRtcTest tc_A = TcoCoreUnitTests
            .ConnectorFixture
            .Connector
            .MAIN
            ._tcoRtcTest_A;
        TcoCoreTests.TcoRtcTest tc_B = TcoCoreUnitTests
            .ConnectorFixture
            .Connector
            .MAIN
            ._tcoRtcTest_B;
        ...
        public void T000_SetSynchronizationParametersFromTcA()
        {
            ...
            isFirstTestRunAfterPlcDownload =
                tc_A._rtcSynchParamsGet.synchContextIdentity.Synchron == 0;
            ...
            Assert.AreEqual(
                tc_A._myIdentity.Synchron,
                tc_A._rtcSynchParamsGet.synchContextIdentity.Synchron
            );
        ...
        public void T001_SetSynchronizationParametersFromTcB()
        {
            ...
            Assert.AreNotEqual(
                tc_B._myIdentity.Synchron,
                tc_B._rtcSynchParamsGet.synchContextIdentity.Synchron
            );
            Assert.AreEqual(
        ...
        public void T003_RtcNowLocalChanging()
        {
            ...
            Assert.LessOrEqual(
                Math.Abs(_PlcDuration.TotalMilliseconds - _DotNetDuration.TotalMilliseconds),
                1000
            );
        }
        ...
        public void T004_RtcNowUtcChanging()
        {
            ...
            Assert.LessOrEqual(Delay, _PlcDuration.TotalMilliseconds); //Check if time difference is equal.
