...
namespace TcoCoreUnitTests.PlcTcRpc
{
    ...
    {
        TcoCoreTests.TcoContextTest tc_A = TcoCoreUnitTests
            .ConnectorFixture
            .Connector
            .MAIN
            ._tcoContextTest_A;
        TcoCoreTests.TcoContextTest tc_B = TcoCoreUnitTests
            .ConnectorFixture
            .Connector
            .MAIN
            ._tcoContextTest_B;
        ...
        public void T105_MultipleContextDotMainCallUsingTestRunner()
        {
            ...
            tc_A.RunUntilEndConditionIsMet(
                () => //Calling of the Open() method before the code inside the parentheses is ensured be the TestRunner RunUntilEndConditionIsMet
                {
                    tc_A.CallMainFromUnitTest(); //Calling only the Main() method
                    i++;
                },
                () => i >= cycles
            ); //Calling of the Close() method after the code inside the parentheses is ensured be the TestRunner RunUntilEndConditionIsMet
