...
namespace TcoCoreUnitTests.PlcTcRpc
{
    public class T03_TcoTaskTests
    {
        ...
        public void Setup()
        {
            ...
            A_TaskInvokeRECount_0 = tc._tcoObjectTest_A
                ._tcoTaskTest_A
                ._invokeRisingEdgeCounter
                .Synchron;
            B_TaskInvokeRECount_0 = tc._tcoObjectTest_A
                ._tcoTaskTest_B
                ._invokeRisingEdgeCounter
                .Synchron;
            ...
            A_TaskExecuteRECount_0 = tc._tcoObjectTest_A
                ._tcoTaskTest_A
                ._executeRisingEdgeCounter
                .Synchron;
            B_TaskExecuteRECount_0 = tc._tcoObjectTest_A
                ._tcoTaskTest_B
                ._executeRisingEdgeCounter
                .Synchron;
            ...
            A_TaskDoneRECount_0 = tc._tcoObjectTest_A
                ._tcoTaskTest_A
                ._doneRisingEdgeCounter
                .Synchron;
            B_TaskDoneRECount_0 = tc._tcoObjectTest_A
                ._tcoTaskTest_B
                ._doneRisingEdgeCounter
                .Synchron;
        ...
        public void GetCounterValues()
        {
            ...
            A_TaskInvokeRECount_1 = tc._tcoObjectTest_A
                ._tcoTaskTest_A
                ._invokeRisingEdgeCounter
                .Synchron;
            B_TaskInvokeRECount_1 = tc._tcoObjectTest_A
                ._tcoTaskTest_B
                ._invokeRisingEdgeCounter
                .Synchron;
            ...
            A_TaskExecuteRECount_1 = tc._tcoObjectTest_A
                ._tcoTaskTest_A
                ._executeRisingEdgeCounter
                .Synchron;
            B_TaskExecuteRECount_1 = tc._tcoObjectTest_A
                ._tcoTaskTest_B
                ._executeRisingEdgeCounter
                .Synchron;
            ...
            A_TaskDoneRECount_1 = tc._tcoObjectTest_A
                ._tcoTaskTest_A
                ._doneRisingEdgeCounter
                .Synchron;
            B_TaskDoneRECount_1 = tc._tcoObjectTest_A
                ._tcoTaskTest_B
                ._doneRisingEdgeCounter
                .Synchron;
        ...
        public void T300_TaskInvokeAndWaitForDone()
        {
            ...
            tc.RunUntilEndConditionIsMet(
                () =>
                {
                    ...
                    finished =
                        tc._tcoObjectTest_A._tcoTaskTest_A._isDone.Synchron
                        && //End condition, execution finished, when the both tasks are in Done state.
            ...
            Assert.Greater(
                A_TaskDoneCount_1 - A_TaskDoneCount_0,
                B_TaskDoneCount_1 - B_TaskDoneCount_0
        ...
        public void T305_TaskAbortDuringExecutionAndInvoke()
        {
            ...
            Assert.AreEqual(
                A_TaskDoneCount_1 - A_TaskDoneCount_0, //As the taskB is aborted and invoked again after taskA is done, difference between end (_1) and start (_0) counters of the both tasks should be exactle the cycles_B cycles
        ...
        public void T310_TaskError()
        {
            ...
            Assert.AreEqual(onErrorCounter_0 + 1, onErrorCounter_1);
            Assert.IsTrue(
                (whileErrorCounter_1 - whileErrorCounter_0) > (onErrorCounter_1 - onErrorCounter_0)
            );
        ...
        public void T314_TaskAbortDuringExecution()
        {
            ...
            {
                tt.TriggerRestore();
            }); //Restore() method should set the task into the Idle state from any state.
        ...
        public void T317_CheckAutoRestoreProperties()
        {
            ...
            Assert.AreEqual(
                ts._autoRestoreToMyChildsEnabled.Synchron, //The child's inherited auto restore property should be the same as the parent's dedicated auto restore property.
