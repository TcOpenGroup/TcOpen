...
namespace TcoCoreUnitTests.PlcTcRpc
{
    public class T02_TcoObjectTests
    {
        ...
        public void T200_IdentitiesTest()
        {
            ...
            Assert.AreEqual(
                tc_A_to_A._myContextIdentity.Synchron,
                tc_A_to_B._myContextIdentity.Synchron
            ); //Identity of the child's context (tc_A_to_A) is the same as the identity of the child's context (tc_A_to_B), as they have the same parent(tc_A)
            Assert.AreEqual(
                tc_A_to_A._myParentIdentity.Synchron,
                tc_A_to_B._myParentIdentity.Synchron
            ); //Identity of the child's parent (tc_A_to_A) is the same as the identity of the child object's (tc_A_to_B), as they have the same parent(tc_A)
            Assert.AreEqual(
                tc_A_to_A._myContextStartCount.Synchron,
                tc_A_to_B._myContextStartCount.Synchron
            ); //_startCycleCount of the child (tc_A_to_A) is the same as the _startCycleCount of the child (tc_A_to_B), as they have the same parent(tc_A)
            Assert.AreEqual(
                tc_A_to_A._myContextEndCount.Synchron,
                tc_A_to_B._myContextEndCount.Synchron
            ); //_endCycleCount of the child (tc_A_to_A) is the same as the _endCycleCount of the child (tc_A_to_B), as they have the same parent(tc_A)
            ...
            Assert.AreEqual(
                tc_B_to_A._myContextIdentity.Synchron,
                tc_B_to_B._myContextIdentity.Synchron
            ); //Identity of the child's context (tc_B_to_A) is the same as the identity of the child's context (tc_B_to_B), as they have the same parent(tc_B)
            Assert.AreEqual(
                tc_B_to_A._myParentIdentity.Synchron,
                tc_B_to_B._myParentIdentity.Synchron
            ); //Identity of the child's parent (tc_B_to_A) is the same as the identity of the child object's (tc_B_to_B), as they have the same parent(tc_B)
            Assert.AreEqual(
                tc_B_to_A._myContextStartCount.Synchron,
                tc_B_to_B._myContextStartCount.Synchron
            ); //_startCycleCount of the child (tc_B_to_A) is the same as the _startCycleCount of the child (tc_B_to_B), as they have the same parent(tc_B)
            Assert.AreEqual(
                tc_B_to_A._myContextEndCount.Synchron,
                tc_B_to_B._myContextEndCount.Synchron
            ); //_endCycleCount of the child (tc_B_to_A) is the same as the _endCycleCount of the child (tc_B_to_B), as they have the same parent(tc_B)
