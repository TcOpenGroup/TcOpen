...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty Name \"\" }", "TcoSequencerAutoRestorableTest", "TcoCoreTests", TypeComplexityEnum.Complex)]
	public partial class TcoSequencerAutoRestorableTest : Vortex.Connector.IVortexObject, ITcoSequencerAutoRestorableTest, IShadowTcoSequencerAutoRestorableTest, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		I_TcoSequencer ITcoSequencerAutoRestorableTest._Sequencer
		{
			get
			{
				return _Sequencer;
		...
		IShadow_TcoSequencer IShadowTcoSequencerAutoRestorableTest._Sequencer
		{
			get
			{
				return _Sequencer;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool ITcoSequencerAutoRestorableTest._RunPLCinstanceOnce
		{
			get
			{
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowTcoSequencerAutoRestorableTest._RunPLCinstanceOnce
		{
			get
			{
				return _RunPLCinstanceOnce;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool ITcoSequencerAutoRestorableTest._RunPLCinstanceCyclicaly
		{
			get
			{
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowTcoSequencerAutoRestorableTest._RunPLCinstanceCyclicaly
		{
			get
			{
				return _RunPLCinstanceCyclicaly;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt ITcoSequencerAutoRestorableTest._StepID
		{
			get
			{
				return _StepID;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowTcoSequencerAutoRestorableTest._StepID
		{
			get
			{
				return _StepID;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool ITcoSequencerAutoRestorableTest._Enabled
		{
			get
			{
				return _Enabled;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowTcoSequencerAutoRestorableTest._Enabled
		{
			get
			{
				return _Enabled;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineString ITcoSequencerAutoRestorableTest._StepDescription
		{
			get
			{
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowString IShadowTcoSequencerAutoRestorableTest._StepDescription
		{
			get
			{
				return _StepDescription;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool ITcoSequencerAutoRestorableTest._RunOneStep
		{
			get
			{
				return _RunOneStep;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowTcoSequencerAutoRestorableTest._RunOneStep
		{
			get
			{
				return _RunOneStep;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool ITcoSequencerAutoRestorableTest._RunAllSteps
		{
			get
			{
				return _RunAllSteps;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowTcoSequencerAutoRestorableTest._RunAllSteps
		{
			get
			{
				return _RunAllSteps;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool ITcoSequencerAutoRestorableTest._FinishStep
		{
			get
			{
				return _FinishStep;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowTcoSequencerAutoRestorableTest._FinishStep
		{
			get
			{
				return _FinishStep;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool ITcoSequencerAutoRestorableTest._Reset
		{
			get
			{
				return _Reset;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowTcoSequencerAutoRestorableTest._Reset
		{
			get
			{
				return _Reset;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt ITcoSequencerAutoRestorableTest._CycleCount
		{
			get
			{
				return _CycleCount;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowTcoSequencerAutoRestorableTest._CycleCount
		{
			get
			{
				return _CycleCount;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt ITcoSequencerAutoRestorableTest._ResetCycleCount
		{
			get
			{
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowTcoSequencerAutoRestorableTest._ResetCycleCount
		{
			get
			{
				return _ResetCycleCount;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool ITcoSequencerAutoRestorableTest._Init
		{
			get
			{
				return _Init;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowTcoSequencerAutoRestorableTest._Init
		{
			get
			{
				return _Init;
		...
		public PlainTcoSequencerAutoRestorableTest CreatePlainerType()
		{
			var cloned = new PlainTcoSequencerAutoRestorableTest();
			cloned._Sequencer = _Sequencer.CreatePlainerType();
			return cloned;
		}

		protected PlainTcoSequencerAutoRestorableTest CreatePlainerType(PlainTcoSequencerAutoRestorableTest cloned)
		{
			cloned._Sequencer = _Sequencer.CreatePlainerType();
			return cloned;
		}
		...
		public void FlushPlainToOnline(TcoCoreTests.PlainTcoSequencerAutoRestorableTest source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(TcoCoreTests.PlainTcoSequencerAutoRestorableTest source)
		{
		...
		public void FlushOnlineToPlain(TcoCoreTests.PlainTcoSequencerAutoRestorableTest source)
		{
			this.Read();
		...
		public TcoSequencerAutoRestorableTest(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail)
		{
		...
		public TcoSequencerAutoRestorableTest()
		{
		...
		protected abstract class PlcTcoSequencerAutoRestorableTest
		{
            ...
            /// </summary>
            /// <exclude />
	public partial interface ITcoSequencerAutoRestorableTest : Vortex.Connector.IVortexOnlineObject
	{
		...
		TcoCoreTests.PlainTcoSequencerAutoRestorableTest CreatePlainerType();
		void FlushOnlineToShadow();
		void FlushPlainToOnline(TcoCoreTests.PlainTcoSequencerAutoRestorableTest source);
		void FlushOnlineToPlain(TcoCoreTests.PlainTcoSequencerAutoRestorableTest source);
	}
            ...
            /// </summary>
            /// <exclude />
	public partial interface IShadowTcoSequencerAutoRestorableTest : Vortex.Connector.IVortexShadowObject
	{
		...
		void CopyPlainToShadow(TcoCoreTests.PlainTcoSequencerAutoRestorableTest source);
	}
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainTcoSequencerAutoRestorableTest : Vortex.Connector.IPlain
	{
		...
		public void CopyPlainToCyclic(TcoCoreTests.TcoSequencerAutoRestorableTest target)
		{
		...
		public void CopyPlainToCyclic(TcoCoreTests.ITcoSequencerAutoRestorableTest target)
		{
			this.CopyPlainToCyclic((TcoCoreTests.TcoSequencerAutoRestorableTest)target);
		}

		public void CopyPlainToShadow(TcoCoreTests.TcoSequencerAutoRestorableTest target)
		{
		...
		public void CopyPlainToShadow(TcoCoreTests.IShadowTcoSequencerAutoRestorableTest target)
		{
			this.CopyPlainToShadow((TcoCoreTests.TcoSequencerAutoRestorableTest)target);
		}

		public void CopyCyclicToPlain(TcoCoreTests.TcoSequencerAutoRestorableTest source)
		{
		...
		public void CopyCyclicToPlain(TcoCoreTests.ITcoSequencerAutoRestorableTest source)
		{
			this.CopyCyclicToPlain((TcoCoreTests.TcoSequencerAutoRestorableTest)source);
		}

		public void CopyShadowToPlain(TcoCoreTests.TcoSequencerAutoRestorableTest source)
		{
		...
		public void CopyShadowToPlain(TcoCoreTests.IShadowTcoSequencerAutoRestorableTest source)
		{
			this.CopyShadowToPlain((TcoCoreTests.TcoSequencerAutoRestorableTest)source);
		}

		public event System.ComponentModel.PropertyChangedEventHandler PropertyChanged;
		public PlainTcoSequencerAutoRestorableTest()
		{
