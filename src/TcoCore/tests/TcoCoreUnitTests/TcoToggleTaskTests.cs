...
namespace TcoCoreUnitTests
{
    ...
    public class T10_TcoToggleTaskTests
    {
        ...
        ulong ToggleTask_counterValue_0;
        ulong ToggleTask_counterValue_1;
        ulong ToggleTask_counterValuePV_0;
        ulong ToggleTask_counterValuePV_1;
        ulong ToggleTask_toggleCounter_0;
        ulong ToggleTask_toggleCounter_1;
        ulong ToggleTask_runCounter_0;
        ulong ToggleTask_runCounter_1;
        ulong ToggleTask_onFtrigCounter_0;
        ulong ToggleTask_onFtrigCounter_1;
        ulong ToggleTask_onRtrigCounter_0;
        ulong ToggleTask_onRtrigCounter_1;
        ulong ToggleTask_onCounter_0;
        ulong ToggleTask_onCounter_1;
        ulong ToggleTask_offCounter_0;
        ulong ToggleTask_offCounter_1;
        ulong ToggleTask_onStateChangeCounter_0;
        ulong ToggleTask_onStateChangeCounter_1;
        ulong ToggleTask_taskOnCounter_0;
        ulong ToggleTask_taskOnCounter_1;
        ulong ToggleTask_taskOffCounter_0;
        ulong ToggleTask_taskOffCounter_1;
        ulong ToggleTask_stateChangedCounter_0;
        ulong ToggleTask_stateChangedCounter_1;


        TcoContextTest tc = ConnectorFixture.Connector.MAIN._tcoContextTest_A;
        TcoToggleTaskTest tt = ConnectorFixture.Connector.MAIN._tcoContextTest_A._tcoToggleTaskTest_A;
        TcoToggleTaskTest ttb = ConnectorFixture.Connector.MAIN._tcoContextTest_A._tcoToggleTaskTest_B;
        ...
        public void Setup()
        {
            ...
            ToggleTask_counterValue_0 = tt._counterValue.Synchron;
            ToggleTask_counterValuePV_0 = tt._counterValuePV.Synchron;
            ToggleTask_toggleCounter_0 = tt._toggleCounter.Synchron;
            ToggleTask_runCounter_0 = tt._runCounter.Synchron;
            ToggleTask_onFtrigCounter_0 = tt._onFtrigCounter.Synchron;
            ToggleTask_onRtrigCounter_0 = tt._onRtrigCounter.Synchron;
            ToggleTask_onCounter_0 = tt._onCounter.Synchron;
            ToggleTask_offCounter_0 = tt._offCounter.Synchron;
            ToggleTask_onStateChangeCounter_0 = tt._onStateChangeCounter.Synchron;
            ToggleTask_taskOnCounter_0 = tt._taskOnCounter.Synchron;
            ToggleTask_taskOffCounter_0 = tt._taskOffCounter.Synchron;
            ToggleTask_stateChangedCounter_0 = tt._stateChangedCounter.Synchron;
        ...
        {
            ToggleTask_counterValue_1 = tt._counterValue.Synchron;
            ToggleTask_counterValuePV_1 = tt._counterValuePV.Synchron;
            ToggleTask_toggleCounter_1 = tt._toggleCounter.Synchron;
            ToggleTask_runCounter_1 = tt._runCounter.Synchron;
            ToggleTask_onFtrigCounter_1 = tt._onFtrigCounter.Synchron;
            ToggleTask_onRtrigCounter_1 = tt._onRtrigCounter.Synchron;
            ToggleTask_onCounter_1 = tt._onCounter.Synchron;
            ToggleTask_offCounter_1 = tt._offCounter.Synchron;
            ToggleTask_onStateChangeCounter_1 = tt._onStateChangeCounter.Synchron;
            ToggleTask_taskOnCounter_1 = tt._taskOnCounter.Synchron;
            ToggleTask_taskOffCounter_1 = tt._taskOffCounter.Synchron;
            ToggleTask_stateChangedCounter_1 = tt._stateChangedCounter.Synchron;
        }
        ...
        [Test, Order(1000)]
        public void T1000_CheckInitStates()
        {
            tc._callMyPlcInstance.Synchron = false;                                     //Switch off the cyclical execution of the tc instance 
            tt.ReadOutState();
            ttb.ReadOutState();

            Assert.IsTrue(tt._isOn.Synchron);
            Assert.IsFalse(tt._isOff.Synchron);

            Assert.IsTrue(ttb._isOff.Synchron);
            Assert.IsFalse(ttb._isOn.Synchron);
        }

        [Test, Order(1001)]
        public void T1001_Message()
        {
        ...
        [Test, Order(1002)]
        public void T1002_ToggleCallWhileRunNotCalled()
        {
            tc._callMyPlcInstance.Synchron = false;                                     //Switch off the cyclical execution of the tc instance 
            state = tt._isOn.Synchron;
            tc.AddEmptyCycle();
            tc.AddEmptyCycle();
            tt.TriggerToggle();
            Assert.AreEqual("Run() method is not called cyclically.", tt.GetMessage()); //Check if message apears in the mime.
            Assert.AreEqual(state , tt._isOn.Synchron);
        }

        [Test, Order(1003)]
        public void T1003_ToggleInvokeWhileRunNotCalled()
        {
            tc._callMyPlcInstance.Synchron = false;                                     //Switch off the cyclical execution of the tc instance 
            tc.AddEmptyCycle();
            tc.AddEmptyCycle();
