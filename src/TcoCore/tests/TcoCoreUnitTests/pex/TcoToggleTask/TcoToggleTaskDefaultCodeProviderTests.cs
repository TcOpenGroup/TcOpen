...
namespace TcoCore.Swift.Tests
{
    ...
    public class TcoToggleTaskDefaultCodeProviderTests
    {
        ...
        {
            var actual = new TcoToggleTaskDefaultCodeProvider(new TcoToggleTask(new MockRootObject(), "ToggleTask", "_toggleTask"));
        ...
        {
            var taskCodeProvider = new TcoToggleTaskDefaultCodeProvider(new TcoToggleTask(new MockRootObject(), "ToggleTask", "_toggleTask"));
