...
namespace TcoCoreUnitTests.PlcExecutedTests
{
    ...
    {
        TcoTaskTestContext xtc = ConnectorFixture.Connector.MAIN._tcoTaskTestContext;
        ...
        {
            xtc.ExecuteProbeRun(2, (int)eTcoTaskTests.CallTasksBodiesOnly);
        }
        ...
        public void Setup()
        {
            ...
            A_TaskInvokeCount_0 = xtc._sut_A._invokeCounter.Synchron;
            B_TaskInvokeCount_0 = xtc._sut_B._invokeCounter.Synchron;
            A_TaskInvokeRECount_0 = xtc._sut_A._invokeRisingEdgeCounter.Synchron;
            B_TaskInvokeRECount_0 = xtc._sut_B._invokeRisingEdgeCounter.Synchron;
            A_TaskExecuteCount_0 = xtc._sut_A._executeCounter.Synchron;
            B_TaskExecuteCount_0 = xtc._sut_B._executeCounter.Synchron;
            A_TaskExecuteRECount_0 = xtc._sut_A._executeRisingEdgeCounter.Synchron;
            B_TaskExecuteRECount_0 = xtc._sut_B._executeRisingEdgeCounter.Synchron;
            A_TaskDoneCount_0 = xtc._sut_A._doneCounter.Synchron;
            B_TaskDoneCount_0 = xtc._sut_B._doneCounter.Synchron;
            A_TaskDoneRECount_0 = xtc._sut_A._doneRisingEdgeCounter.Synchron;
            B_TaskDoneRECount_0 = xtc._sut_B._doneRisingEdgeCounter.Synchron;
            A_onStartCounter_0 = xtc._sut_A._onStartCounter.Synchron;
            B_onStartCounter_0 = xtc._sut_B._onStartCounter.Synchron;
            A_onErrorCounter_0 = xtc._sut_A._onErrorCounter.Synchron;
            A_whileErrorCounter_0 = xtc._sut_A._whileErrorCounter.Synchron;
            ...
            xtc._done.Synchron = false;
            xtc._arranged.Synchron = false;
            xtc._plcCycleCounter.Synchron =0 ;
        ...
        {
            xtc.ExecuteProbeRun(2, (int)eTcoTaskTests.RestoreTasks);
        }
        ...
        public void GetCounterValues()
        {
            ...
            A_TaskInvokeCount_1 = xtc._sut_A._invokeCounter.Synchron;
            B_TaskInvokeCount_1 = xtc._sut_B._invokeCounter.Synchron;
            A_TaskInvokeRECount_1 = xtc._sut_A._invokeRisingEdgeCounter.Synchron;
            B_TaskInvokeRECount_1 = xtc._sut_B._invokeRisingEdgeCounter.Synchron;
            A_TaskExecuteCount_1 = xtc._sut_A._executeCounter.Synchron;
            B_TaskExecuteCount_1 = xtc._sut_B._executeCounter.Synchron;
            A_TaskExecuteRECount_1 = xtc._sut_A._executeRisingEdgeCounter.Synchron;
            B_TaskExecuteRECount_1 = xtc._sut_B._executeRisingEdgeCounter.Synchron;
            A_TaskDoneCount_1 = xtc._sut_A._doneCounter.Synchron;
            B_TaskDoneCount_1 = xtc._sut_B._doneCounter.Synchron;
            A_TaskDoneRECount_1 = xtc._sut_A._doneRisingEdgeCounter.Synchron;
            B_TaskDoneRECount_1 = xtc._sut_B._doneRisingEdgeCounter.Synchron;
            A_onStartCounter_1 = xtc._sut_A._onStartCounter.Synchron;
            B_onStartCounter_1 = xtc._sut_B._onStartCounter.Synchron;
            A_onErrorCounter_1 = xtc._sut_A._onErrorCounter.Synchron;
            A_whileErrorCounter_1 = xtc._sut_A._whileErrorCounter.Synchron;

            plccycles = xtc._plcCycleCounter.Synchron;
        }
        ...
        public void T300_TaskInvokeAndWaitForDone()
        {
            ...
            //Arrange
            xtc._sut_A._counterSetValue.Synchron = cycles_A;    //Assign _CounterSetValue to Task A 
            xtc._sut_B._counterSetValue.Synchron = cycles_B;    //Assign _CounterSetValue to Task B
            //Act
            xtc.ExecuteProbeRun((int)eTcoTaskTests.TaskInvokeAndWaitForDone, () => xtc._done.Synchron);
        ...
        public void T301_TaskInvokeAfterDoneWithNoEmptyCycles()
        {
            ...
            //Act
            xtc.ExecuteProbeRun((int)eTcoTaskTests.TaskInvokeAfterDoneWithNoEmptyCycles, () => xtc._done.Synchron);
            //Assert
            GetCounterValues();                                                         //Readout all counter values from test instance into the _1 variables
        ...
        public void T302_TaskInvokeAfterDoneWithOneEmptyCycle()
        {
            ...
            //Act
            xtc.ExecuteProbeRun((int)eTcoTaskTests.TaskInvokeAfterDoneWithOneEmptyCycle, () => xtc._done.Synchron);
            //Assert
            GetCounterValues();                                                         //Readout all counter values from test instance into the _1 variables
            CheckBothTaskInvokeCount(1);                                                //Both tasks should be triggered just once
            Assert.AreEqual(A_TaskExecuteCount_0 + cycles_A, A_TaskExecuteCount_1);     //Execution body of the Task A should run exactly cycles_A cycles
        ...
        public void T303_TaskInvokeAfterDoneWithAbortCall()
        {
            ...
            //Act
            xtc.ExecuteProbeRun((int)eTcoTaskTests.TaskInvokeAfterDoneWithAbortCall, () => xtc._done.Synchron);
            //Assert
            GetCounterValues();                                                         //Readout all counter values from test instance into the _1 variables
        ...
        public void T304_TaskInvokeAfterDoneWithRestoreCall()
        {
            ...
            //Act
            xtc.ExecuteProbeRun((int)eTcoTaskTests.TaskInvokeAfterDoneWithRestoreCall, () => xtc._done.Synchron);
            //Assert
            GetCounterValues();                                                         //Readout all counter values from test instance into the _1 variables
            CheckBothTaskInvokeCount(1);                                                //Both tasks should be triggered just once
            Assert.AreEqual(A_TaskExecuteCount_0 + cycles_A, A_TaskExecuteCount_1);     //Execution body of the Task A should run exactly cycles_A cycles
        ...
        public void T305_TaskAbortDuringExecutionAndInvoke()
        {
            ...
            //Act
            xtc.ExecuteProbeRun((int)eTcoTaskTests.TaskAbortDuringExecutionAndInvoke, () => xtc._done.Synchron);
            //Assert
            GetCounterValues();                                                         //Readout all counter values from test instance into the _1 variables
        ...
        public void T310_TaskError()
        {
            ...
            //Arange
            while (!xtc._arranged.Synchron)
            {
                xtc.ExecuteProbeRun(1, (int)eTcoTaskTests.TaskError);
            }
            Assert.IsFalse(xtc._sut_A._isError.Synchron);                                       //Task should be Busy, not Done, not in Error.
            Assert.IsTrue(xtc._sut_A._isBusy.Synchron);
            Assert.IsFalse(xtc._sut_A._isDone.Synchron);
            Assert.AreEqual(6, xtc._plcCycleCounter.Synchron);

            //Act
            xtc.ExecuteProbeRun(1, (int)eTcoTaskTests.TaskError);
            //Assert
            Assert.IsTrue(xtc._sut_A._isError.Synchron);                                        //Task should be in Error, not Done, not Busy.
            Assert.IsFalse(xtc._sut_A._isBusy.Synchron);
            Assert.IsFalse(xtc._sut_A._isDone.Synchron);
            Assert.AreEqual(7, xtc._plcCycleCounter.Synchron);
            GetCounterValues();
            Assert.AreEqual(A_onErrorCounter_0 + 1, A_onErrorCounter_1);

            //Arange
            cycles_A = 10;
            xtc._inUint.Synchron = cycles_A;
            //Act
            xtc.ExecuteProbeRun(cycles_A, (int)eTcoTaskTests.TaskError);
            //Assert
            GetCounterValues();
            Assert.AreEqual(A_onErrorCounter_0 + 1, A_onErrorCounter_1);
            ...
            Assert.AreEqual(7+cycles_A, xtc._plcCycleCounter.Synchron);
        ...
        //{
        //    xtc._elapsedTimeETA.Synchron = new TimeSpan(0, 0, 0, 0, 50);
        //    xtc._runElapsedTimer.Synchron = false;
        //    var expected = xtc._elapsedTimeETA.Synchron.Add(new TimeSpan(0, 0, 0, 0, 10)); // need to add one PLC cycle duration to the expected.

        //    xtc.ExecuteProbeRun(3, 0);

        //    xtc.ExecuteProbeRun((int)eTcoTaskTests.ElapsedTypeMeasurement, () => xtc._sut_A._taskState.Synchron == (short)eTaskState.Done);           
        //    Assert.AreEqual(expected, xtc._elapsedTime.Synchron);
        //}     
    }
}
