    ...
    public partial class App : Application
    {
        public App()
        {
            ...
            Entry.IntegrationProjectsPlc.MAIN_TECHNOLOGY._technology._ST001._settings.InitializeRepository(
                TcoData.Repository.Json.Repository.Factory(
                    new TcOpen.Inxton.Data.Json.JsonRepositorySettings<PlainST001_ProcessData>(
                        @"C:\TcOpen\Data\Settings"
                    )
                )
            );
