...
{
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty Name \"\" }", "IO", "TcoPneumaticsTests", TypeComplexityEnum.Complex)]
	public partial class IO : Vortex.Connector.IVortexObject, IIO, IShadowIO, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		public void FlushPlainToOnline(TcoPneumaticsTests.PlainIO source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(TcoPneumaticsTests.PlainIO source)
		{
		...
		public void FlushOnlineToPlain(TcoPneumaticsTests.PlainIO source)
		{
			this.Read();
	...
	public partial interface IIO : Vortex.Connector.IVortexOnlineObject
	{
		...
		TcoPneumaticsTests.PlainIO CreatePlainerType();
		void FlushOnlineToShadow();
		void FlushPlainToOnline(TcoPneumaticsTests.PlainIO source);
		void FlushOnlineToPlain(TcoPneumaticsTests.PlainIO source);
	}
	...
	public partial interface IShadowIO : Vortex.Connector.IVortexShadowObject
	{
		...
		void CopyPlainToShadow(TcoPneumaticsTests.PlainIO source);
	}
	...
	public partial class PlainIO : System.ComponentModel.INotifyPropertyChanged, Vortex.Connector.IPlain
	{
		...
		public void CopyPlainToCyclic(TcoPneumaticsTests.IO target)
		{
		...
		public void CopyPlainToCyclic(TcoPneumaticsTests.IIO target)
		{
			this.CopyPlainToCyclic((TcoPneumaticsTests.IO)target);
		}

		public void CopyPlainToShadow(TcoPneumaticsTests.IO target)
		{
		...
		public void CopyPlainToShadow(TcoPneumaticsTests.IShadowIO target)
		{
			this.CopyPlainToShadow((TcoPneumaticsTests.IO)target);
		}

		public void CopyCyclicToPlain(TcoPneumaticsTests.IO source)
		{
		...
		public void CopyCyclicToPlain(TcoPneumaticsTests.IIO source)
		{
			this.CopyCyclicToPlain((TcoPneumaticsTests.IO)source);
		}

		public void CopyShadowToPlain(TcoPneumaticsTests.IO source)
		{
		...
		public void CopyShadowToPlain(TcoPneumaticsTests.IShadowIO source)
		{
			this.CopyShadowToPlain((TcoPneumaticsTests.IO)source);
		}
