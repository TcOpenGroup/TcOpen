    ...
    public class MQTTTests
    {
        ...
        public void emit_test()
       {
        ...
        public void integrate_with_serilog_test_remote_mqtt_broker()
        {
            ...
            while (appMessage == null) { System.Threading.Thread.Sleep(10); }
        ...
        public void integrate_with_serilog_test_remote_mqtt_broker_performance_test()
        {
            ...
            subscriberClient.UseApplicationMessageReceivedHandler((m) => appMessages.Add(m.ApplicationMessage));
            ...
            while (appMessages.Count < 1000) { System.Threading.Thread.Sleep(10); }           
