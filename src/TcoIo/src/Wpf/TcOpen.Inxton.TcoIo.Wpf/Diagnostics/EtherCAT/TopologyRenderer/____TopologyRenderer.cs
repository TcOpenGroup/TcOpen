...
namespace TcoIo
{
    public class ____TopologyRenderer : UserControl
    {
        static int row;
        static int maxrow;
        static int column;
        ...
        public ____TopologyRenderer() : base()
        {
            row=0;
            maxrow = 0;
            column = 0;
        ...
        public object Render(Grid wiringGrid = null)
        {
            ...
            stackPanel.PreviewMouseWheel += new MouseWheelEventHandler(StackPanel_PreviewMouseWheel);
            scrollViewer.Content = stackPanel;
            //stackPanel.PreviewMouseWheel += StackPanel_PreviewMouseWheel;
            //Binding binding = new Binding { Source = zoom, Mode = BindingMode.OneWay };
            stackPanel.SetBinding(StackPanel.LayoutTransformProperty, new Binding() { Source = zoom, Path = new PropertyPath("ZoomValue"), Mode = BindingMode.OneWay });
            ...
            stackPanel.Children.Add(hardwareGrid);
            ////viewbox.Child = scrollViewer;
            //return viewbox;
            return scrollViewer;
        }
