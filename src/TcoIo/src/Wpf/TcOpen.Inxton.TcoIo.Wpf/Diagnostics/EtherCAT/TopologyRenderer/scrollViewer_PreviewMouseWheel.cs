            ...
            else
            {
                if(this.grid != null && this.grid.Children != null && this.grid.Children.Count > 0)
                {
                    ...
                    if(child_0 != null && child_0.Children != null && child_0.Children.Count > 0)
                    {
                        ...
                        if (child_0_1 != null && child_0_1.Children != null && child_0_1.Children.Count > 0)
                        {
                        ...
                        else if (child_0_0 != null && child_0_0.Children != null && child_0_0.Children.Count > 0)
                        {
                            EtcGroupedView child_0_0_0 = child_0_0.Children[0] as EtcGroupedView;
                            if (child_0_0_0 != null)
                            {
                                ScrollViewer groupScrollViewer = child_0_0_0.groupViewScrollViewer as ScrollViewer;
                                if (groupScrollViewer != null)
                                {
                                    if (e.Delta > 0)
                                    {
