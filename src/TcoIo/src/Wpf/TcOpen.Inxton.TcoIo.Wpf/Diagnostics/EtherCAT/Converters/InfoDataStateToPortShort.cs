...
namespace TcoIo.Converters
{
    public class InfoDataStateToPortShort : MarkupExtension, IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            string ret = "";
            if ((((int)(ushort)value) & 0x1000) != 0) ret = ret + "port A";
            if ((((int)(ushort)value) & 0x2000) != 0) ret = ret + "port B";
            if ((((int)(ushort)value) & 0x4000) != 0) ret = ret + "port C";
            if ((((int)(ushort)value) & 0x8000) != 0) ret = ret + "port D";
            return ret;
        }
