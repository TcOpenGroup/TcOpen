...
namespace TcoIo.Converters
{
    public class InfoDataSyncUnitStateToOverallState : MarkupExtension, IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            string ret = "";
            if ((((int)(ushort)value) & 0x0003) != 0)
                ret = ret + "At least one slave in 'BOOT' state" + Environment.NewLine;
            else if ((((int)(ushort)value) & 0x0001) != 0)
                ret = ret + "At least one slave in 'INIT' state" + Environment.NewLine;
            else if ((((int)(ushort)value) & 0x0002) != 0)
                ret = ret + "At least one slave in 'PREOP' state" + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0004) != 0)
                ret = ret + "At least one slave in 'SAFEOP' state" + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0008) != 0)
                ret = ret + "At least one slave in 'OP' state" + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0010) != 0)
                ret = ret + "At least one slave signals error," + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0020) != 0)
                ret = ret + "Invalid vendorId, productCode," + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0040) != 0)
                ret = ret + "Initialization error occurred," + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0080) != 0)
                ret = ret + "At least one slave disabled, " + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0100) != 0)
                ret = ret + "At least one slave not present; " + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0200) != 0)
                ret = ret + "At least one slave signals link error; " + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0400) != 0)
                ret = ret + "At least one slave signals missing link " + Environment.NewLine;
            if ((((int)(ushort)value) & 0x0800) != 0)
                ret = ret + "At least one slave signals unexpected link " + Environment.NewLine;
