...
namespace TcoIo
{
    ...
    public class InfoDataStateToErrorState : MarkupExtension, IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            string ret = "";
            if ((((int)(ushort)value) & 0x0010) != 0) ret = ret + "Slave signals error; ";
            if ((((int)(ushort)value) & 0x0020) != 0) ret = ret + "Invalid vendorId, productCode; ";
            if ((((int)(ushort)value) & 0x0040) != 0) ret = ret + "Initialization error occurred; ";
    ...
    public class InfoDataStateToPort : MarkupExtension, IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            string ret = "";
            if ((((int)(ushort)value) & 0x1000) != 0) ret = ret + "at port A";
            if ((((int)(ushort)value) & 0x2000) != 0) ret = ret + "at port B";
            if ((((int)(ushort)value) & 0x4000) != 0) ret = ret + "at port C";
            if ((((int)(ushort)value) & 0x8000) != 0) ret = ret + "at port D";
            return ret;
        }
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
