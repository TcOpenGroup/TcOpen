...
using TcoLoggersTests;
using Tc.Prober.Runners;

namespace TcoLoggersUnitTests
{
    public class fbUnitTestExampleTests
    {
        ...
        public void Setup()
        {
            Entry.TcoLoggersTests.Connector.BuildAndStart().ReadWriteCycleDelay = 100;
            sut = Entry.TcoLoggersTests.MAIN._sampleComponentTests;
        }
