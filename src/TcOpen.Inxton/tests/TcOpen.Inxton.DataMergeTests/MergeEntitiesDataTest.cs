...
namespace TcoDataMergeTests
{
    public class MergeEntitiesDataTest
    {
        ...
        public void SetUp()
        {
            repositoryTarget = new RavenDbRepository<TestData>(
                new RavenDbRepositorySettings<TestData>(
            ...
            repositoryTarget.OnCreate = (id, data) =>
            {
                data._Created = DateTime.Now;
                data._Modified = DateTime.Now;
            };
            repositoryTarget.OnUpdate = (id, data) =>
            {
                data._Modified = DateTime.Now;
            };
            ...
            repositorySource = new RavenDbRepository<TestData>(
                new RavenDbRepositorySettings<TestData>(
                    new string[] { @"http://localhost:8080" },
                    "SourceData",
                    "",
            ...
            repositorySource.OnCreate = (id, data) =>
            {
                data._Created = DateTime.Now;
                data._Modified = DateTime.Now;
            };
            repositorySource.OnUpdate = (id, data) =>
            {
                data._Modified = DateTime.Now;
            };
            ...
            var recordsSource = repositorySource
                .Queryable.Where(p => true)
                .Select(p => p._EntityId)
                .ToList();
            recordsSource.ForEach(p => repositorySource.Delete(p));

            var recordsTarget = repositoryTarget
                .Queryable.Where(p => true)
                .Select(p => p._EntityId)
                .ToList();
        ...
        {
            testDataSource = new TestData()
            {
                _recordId = default(dynamic),
                _Created = new DateTime(1904522374),
                _EntityId = "TestValue1447482512",
                _Modified = new DateTime(1997083921)
            };
            repositorySource.Create(testDataSource._EntityId, testDataSource);

            testDataTarget = new TestData()
            {
                _recordId = default(dynamic),
                _Created = new DateTime(1904522374),
                _EntityId = "TestValue1447482513",
                _Modified = new DateTime(1997083921)
            };
        ...
        public void compare_req_prop_not_in_list()
        {
            ...
            reqProperties = PropertyHelper.GetPropertiesNames(
                new PlainTcoAnalogueInspectorData(),
                p => p.IsByPassed,
                p => p.IsExcluded,
                p => p.RequiredMin,
                p => p.RequiredMax,
                p => p.NumberOfAllowedRetries
            );
            ...
            // Assert
            Assert.AreNotEqual(
                testDataSource.customChecker1.DetectedStatus.ToString(),
                mergedTarget.customChecker1.DetectedStatus.ToString()
            );
            Assert.AreNotEqual(
                testDataSource.customChecker2.DetectedStatus.ToString(),
                mergedTarget.customChecker2.DetectedStatus.ToString()
            );
            Assert.AreNotEqual(
                testDataSource.customChecker3.DetectedStatus.ToString(),
                mergedTarget.customChecker3.DetectedStatus.ToString()
            );
            Assert.AreNotEqual(
                testDataSource.customChecker4.DetectedStatus.ToString(),
                mergedTarget.customChecker4.DetectedStatus.ToString()
            );
        }
        ...
        public void compare_if_req_prop_is_in_list()
        {
            ...
            // Assert
            Assert.AreEqual(
                testDataSource.customChecker1.IsByPassed,
                mergedTarget.customChecker1.IsByPassed
            );
            Assert.AreEqual(
                testDataSource.customChecker2.IsByPassed,
                mergedTarget.customChecker2.IsByPassed
            );
            Assert.AreNotEqual(
                testDataSource.customChecker3.IsByPassed,
                mergedTarget.customChecker3.IsByPassed
            );
            Assert.AreNotEqual(
                testDataSource.customChecker4.IsByPassed,
                mergedTarget.customChecker4.IsByPassed
            );
        }
        ...
        public void compare_req_prop_is_in_list_with_exclusion_result_zero()
        {
            ...
            Assert.AreEqual(
                testDataSource.customChecker1.NumberOfAllowedRetries,
                mergedTarget.customChecker1.NumberOfAllowedRetries
            );
            ...
            Assert.AreEqual(
                testDataSource.customChecker2.NumberOfAllowedRetries,
                mergedTarget.customChecker2.NumberOfAllowedRetries
            );
            ...
            Assert.AreNotEqual(
                testDataSource.customChecker3.NumberOfAllowedRetries,
                mergedTarget.customChecker3.NumberOfAllowedRetries
            );
            ...
            Assert.AreNotEqual(
                testDataSource.customChecker4.NumberOfAllowedRetries,
                mergedTarget.customChecker4.NumberOfAllowedRetries
            );
        }
        ...
        public void compare_no_req_type_no_prop_no_inclusion_no_exclusion()
        {
            ...
            var merge = new MergeEntitiesData<TestData>(repositorySource, repositoryTarget);
        ...
        public void compare_inclusion_exclusion_from_outside()
        {
            ...
            merge.Merge(
                testDataSource._EntityId,
                testDataTarget._EntityId,
                ExcludeFromOutside,
                IncludeFromOutside,
                ReqPropertyFromOutisde
            );
        ...
        private IEnumerable<string> ReqPropertyFromOutisde(object obj)
        {
            ...
            switch (obj)
            {
                case PlainTcoAnalogueInspectorData c:
                    return PropertyHelper.GetPropertiesNames(
                        c,
                        p => p.IsByPassed,
                        p => p.IsExcluded,
                        p => p.RequiredMin,
    ...
    public class TestData : TcoData.PlainTcoEntity
    {
        ...
        public PlainTcoAnalogueInspectorData customChecker1 { get; set; } =
            new PlainTcoAnalogueInspectorData();
        public PlainTcoAnalogueInspectorData customChecker2 { get; set; } =
            new PlainTcoAnalogueInspectorData();

        public PlainTcoDigitalInspectorData customChecker3 { get; set; } =
            new PlainTcoDigitalInspectorData();
        public PlainTcoDigitalInspectorData customChecker4 { get; set; } =
            new PlainTcoDigitalInspectorData();
    }
}
