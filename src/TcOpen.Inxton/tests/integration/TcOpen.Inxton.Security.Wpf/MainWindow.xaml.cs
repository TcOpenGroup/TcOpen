...
namespace integration.Security.Wpf.netcore
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void LoginOnDifferentThread_Click(object sender, RoutedEventArgs e) =>
            Task.Run(() => LoginAdmin(sender, e));

        private void LogoutOnDifferentThread_Click(object sender, RoutedEventArgs e) =>
            Task.Run(() => Logout(sender, e));
