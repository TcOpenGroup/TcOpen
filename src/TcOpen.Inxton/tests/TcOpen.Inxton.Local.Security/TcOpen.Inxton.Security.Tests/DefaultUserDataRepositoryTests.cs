...
namespace TcOpen.Inxton.Security.Tests
{
    ...
    public class DefaultUserDataRepositoryTests
    {
        ...
        public void CreateTest()
        {
            ...
            Assert.AreEqual(
                1,
                _userData.Queryable.Where(p => p.Username == expected.Username).Count()
            );
        }
        ...
        public void UpdateTest()
        {
            ...
            Assert.AreEqual(
                expected.Roles[1],
                _userData
                    .Queryable.Where(p => p._EntityId == expected._EntityId)
                    .FirstOrDefault()
                    .Roles[1]
            );
        }
        ...
        public void DeleteTest()
        {
            ...
            Assert.IsFalse(
                _userData
                    .Queryable.Where(p => p._EntityId == expected._EntityId)
                    .Any(p => p.Username == expected.Username)
            );
        }
    }
}
