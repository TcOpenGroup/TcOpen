...
namespace TcOpen.Inxton.Security.Wpf
{
    public class PwdsChange : Freezable
    {
        ...
        public static readonly DependencyProperty Pb1Property =
            DependencyProperty.Register("Pb1", typeof(PasswordBox), typeof(PwdsChange));
        ...
        public static readonly DependencyProperty OldPwdProperty =
            DependencyProperty.Register("OldPwd", typeof(PasswordBox), typeof(PwdsChange));
        ...
        public static readonly DependencyProperty Pb2Property =
            DependencyProperty.Register("Pb2", typeof(PasswordBox), typeof(PwdsChange));
