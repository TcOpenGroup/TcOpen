...
namespace TcOpen.Inxton.Data
{
    ...
    public class IdentifierValueMismatchedException : Exception
    {
        ...
        public IdentifierValueMismatchedException(string message)
            : base(message) { }
        ...
        public IdentifierValueMismatchedException(string message, Exception innerException)
        ...
        protected IdentifierValueMismatchedException(
