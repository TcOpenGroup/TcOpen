...
namespace TcoIoBeckhoffUnitTests
{
    public class fbUnitTestExampleTests
    {
        ...
        //public void Setup()
        //{
        //    Entry.TcoIoBeckhoffTests.Connector.BuildAndStart().ReadWriteCycleDelay = 100;
        //    sut = Entry.TcoIoBeckhoffTests.MAIN._sampleComponentTests;
        //}
