...
namespace TcoAbbRobotics
{
    public static class TcoOmnicoreControlerEvents_v_1_x_x
    {
        public static IDictionary<uint, string> Ids = new Dictionary<uint, string>()
        {
            ...
            {
                10091,
                @"Restart not possible A restart after collision detection is not possible before acknowledge the error dialogue"
            },
            {
                10092,
                @"(Re)start not possible (Re)start is not possible due to lost contact with IO module arg configured with trustlevel."
            },
            { 10095, @"At least one task is unchecked in the task selection panel " },
            { 10096, @"arg not active " },
            {
                10097,
                @"Restart not possible The task arg is set in blocked state and the program is for that reason not possible to restart from the current program position."
            },
            {
                10098,
                @"Restart not possible The task arg has been in system failure state and the program is for that reason not possible to restart from the current program position."
            },
            { 10099, @"Program start rejected " },
            {
                10100,
                @"SFTP server up The control system communicates correctly with the SFTP server arg."
            },
            {
                10101,
                @"SFTP server down The control system is not able to communicate correctly with the SFTP server arg."
            },
            {
                10106,
                @"Time for service It's time for service for robot arg because it is arg days since the last service."
            },
            {
                10107,
                @"Close to service It remains arg days for robot arg until it's time for service."
            },
            {
                10108,
                @"Time for service It's time for service for robot arg cause it's arg hours of production since last service."
            },
            {
                10109,
                @"Close to service It remains arg hours of production for robot arg to next service."
            },
            { 10110, @"Gearbox needs service The gearbox at arg of robot arg needs service." },
            {
                10111,
                @"Gearbox reached service interval The gearbox at arg of robot arg has reached arg of its service interval."
            },
            {
                10112,
                @"SIS calendar notification The system date and time has changed. This could cause problems with the SIS calendar notification."
            },
            {
                10115,
                @"A backup is made of the robot memory Data is moved from robot memory to backup of robot memory by arg."
            },
            {
                10116,
                @"Robot memory is restored from the backup Data is moved from backup of robot memory to robot memory by arg."
            },
            { 10117, @"The robot memory is cleared Data in robot memory is cleared by arg." },
            {
                10118,
                @"The backup of the robot memory is cleared Data in the backup of robot memory is cleared by arg."
            },
            {
                10120,
                @"Program stopped The reason is that an external or internal stop after current instruction has occurred."
            },
            {
                10121,
                @"Program stopped The reason is that the task has reached an exit instruction."
            },
            ...
            {
                10124,
                @"Program stopped The reason is that the task has reached a break instruction."
            },
            {
                10125,
                @"Program stopped The reason is that an external or internal stop has occurred."
            },
            { 10126, @"Program stopped The reason is that an error has occurred." },
            {
                10127,
                @"Backward execution not possible The reason is that it is not possible to execute backward past beginning of instruction list."
            },
            {
                10128,
                @"Backward execution not possible The reason is that it is not possible to execute backward past the instruction."
            },
            {
                10129,
                @"Program stopped The reason is that the event routine for RESET or POWER_ON is ready."
            },
            { 10130, @"Program stopped The reason is that the task is ready with this move step." },
            {
                10131,
                @"Program stopped The reason is that the routine called from system IO interrupt or a service routine is ready."
            },
            { 10132, @"Program stopped The reason could not be determined." },
            {
                10133,
                @"Program stopped The reason is that the task is ready with the execution of the UNDO handlers."
            },
            {
                10134,
                @"POWER_ON event routine stopped The system was stopped while execution a POWER_ON event routine."
            },
            {
                10135,
                @"Program stopped The reason is that a stop after current cycle has occurred."
            },
            {
                10136,
                @"Program stopped The reason is that the task has reached a stop instruction."
            },
            {
                10137,
                @"Program stopped The reason is that the task has reached a stop\AllMoveTask instruction."
            },
            {
                10138,
                @"Program stopped The reason is that an stop from system input has occurred."
            },
            ...
            {
                10141,
                @"Program pointer moved to cursor The program pointer of task arg in module arg has been moved to position arg by arg."
            },
            {
                10142,
                @"Call routine The program pointer in task arg has been moved to routine arg by arg."
            },
            {
                10143,
                @"Cancel call routine The execution of the called routine has been canceled in task arg by arg."
            },
            {
                10144,
                @"Simulate of Wait instruction A wait instruction (WaitTime, WaitUntil, WaitDO, etc.) has been simulated in task arg by arg."
            },
            {
                10145,
                @"Task selection panel is set Task arg has been added in Task Selection Panel by arg."
            },
            {
                10146,
                @"Task selection panel is cleared Task arg has been removed in Task Selection Panel by arg."
            },
            ...
            {
                10149,
                @"Program Pointer moved to routine The program pointer in task arg has been moved to routine arg by arg."
            },
            {
                10150,
                @"Program started Execution of task arg has been started from the first instruction of the task's entry routine. The originator could not be determined."
            },
            {
                10151,
                @"Program started Execution of task arg has been started from the first instruction of the task's entry routine. The originator is an external client."
            },
            {
                10152,
                @"Program started Execution of task arg has been started from the first instruction of the task's entry routine. The start order was initiated by an
            ...
            {
                10155,
                @"Program restarted Execution of task arg has been restarted from where it was
            previously stopped.The originator could not be determined"
            },
            {
                10156,
                @"Program restarted Execution of task arg has been restarted from where it was previously stopped. The originator is an external client."
            },
            {
                10157,
                @"Program restarted Execution of task arg has been restarted from where it was previously stopped. The restart order was initiated by an action causing the UNDO handler to execute."
            },
            ...
            {
                10177,
                @"Task refuses to start Task arg:
            ...
            {
                10185,
                @"Task could not be prepared for start Task arg:
            ...
            {
                10190,
                @"Protected area not done A power fail did occur in the middle of a protected area for the task arg. The system is trying to selfheal."
            },
            {
                10191,
                @" Protected area not done A power fail did occur in the middle of a protected area for the task arg. A pending error is removed from the queue."
            },
            {
                10192,
                @" Protected area not done A power fail did occur in the middle of a protected area for the task arg. A pending exit is removed from the queue."
            },
            {
                10193,
                @" Protected area not done A power fail did occur in the middle of a protected area for the task arg. This may result in an extra program cycle."
            },
            {
                10194,
                @" Protected area not done A power fail did occur in the middle of a protected area for the task arg. The task will be restarted from the main routine."
            },
            {
                10195,
                @" Protected area not done A power fail did occur in the middle of a protected area for the task arg. All tasks are reset and all user programs are lost."
            },
            {
                10196,
            ...
            {
                10201,
                @"Event logs for one domain is cleared User arg has cleared domain argX XXX."
            },
            { 10202, @"Date and/or time is changed Date and/or time is changed to arg by arg." },
            {
                10205,
                @"Configuration parameter changed A configuration parameter has been changed in domain: arg by arg."
            },
            {
                10206,
                @"Configuration file has been loaded A configuration file arg has been loaded by arg."
            },
            {
                10210,
                @"Execution cancelled The restart will clear the execution in task arg of a POWER ON system event routine."
            },
            {
                10211,
                @"Execution cancelled The restart will clear the execution in task arg of a STOP system event routine."
            },
            {
                10212,
                @"Execution cancelled The restart will clear the execution in task arg of an EMERGENCY STOP system event routine."
            },
            {
                10213,
                @"Execution cancelled The restart will clear the execution in task arg of a START system event routine."
            },
            {
                10214,
                @"Execution cancelled The restart will clear the execution in task arg of a RESTART system event routine."
            },
            {
                10215,
                @"Execution cancelled The restart will clear the execution in task arg of a RESET system event routine."
            },
            {
                10217,
                @"Execution cancelled The restart will clear the execution in task arg of a USER routine."
            },
            { 10218, @"Execution cancelled The restart will clear the execution in task arg." },
            {
                10219,
                @"Execution cancelled The restart will clear the execution in task arg of a STEP system event routine."
            },
            ...
            {
                10260,
                @"System diagnostics info generated System diagnostics information was successfully generated to file arg."
            },
            {
                10261,
                @"System diagnostics info unavailable User requested to save diagnostics system information to file arg. System was unable to fulfill this request."
            },
            {
                10262,
                @"System log has been created A system log has been created. A System Diagnostics has to be created using FlexPendant or RobotStudio."
            },
            {
                10270,
                @"Cyclic Brake Check Done The Cyclic Brake Check has been done for all brakes supervised by Safety Controllers."
            },
            ...
            {
                10280,
                @"The coordinate system has been changed to World frame The coordinate system has been changed to World frame in mechanical unit arg by arg."
            },
            {
                10281,
                @"The coordinate system has been changed to Base frame The coordinate system has been changed to Base frame in mechanical unit arg by arg."
            },
            {
                10282,
                @"The coordinate system has been changed to Tool frame The coordinate system has been changed to Tool frame in mechanical unit arg by arg."
            },
            {
                10283,
                @"The coordinate system has been changed to Object frame The coordinate system has been changed to Object frame in mechanical unit arg by arg."
            },
            {
                10284,
                @"Non motion execution mode is set The non motion execution mode has been set by arg."
            },
            {
                10285,
                @"Non motion execution mode has been reset The non motion execution mode has been reset by arg."
            },
            {
                10286,
                @"Payload has been changed The payload has been changed to arg in task arg by arg."
            },
            {
                10287,
                @"Total load has been changed The total load has been changed to arg in task arg by arg."
            },
            {
                10288,
                @"The Work Object has been changed The Work object has been changed to arg in task arg by arg."
            },
            {
                10289,
                @"The tool has been changed The tool has been changed to arg in task arg by arg."
            },
            {
                10290,
                @"The robot has been calibrated The mechanical unit arg, axis arg has been calibrated by arg."
            },
            { 10291, @"Goto position The functionality Goto position has been used by arg." },
            {
                10292,
                @"Revolution Counter updated The revolution counter for robot arg, axis arg has been updated by arg."
            },
            {
                10293,
                @"Path Supervision is set to On The Path supervision for task arg is set to On by user: arg."
            },
            {
                10294,
                @"Path Supervision is set to Off The Path supervision for task arg is set to Off by user: arg."
            },
            {
                10295,
                @"The Sensitivity for Path Supervision is updated The Sensitivity for task arg for Path Supervision is set to arg% by user: arg."
            },
            {
                10296,
                @"Jog Supervision is set to On The Jog supervision for task arg is set to On by user: arg."
            },
            {
                10297,
                @"Jog Supervision is set to Off The Jog supervision for task arg is set to Off by user: arg."
            },
            {
                10298,
                @"The Sensitivity for Jog Supervision is updated The Sensitivity for task arg for Jog Supervision is set to arg% by user: arg."
            },
            ...
            {
                10350,
                @"Update of task failed The system could not update task arg to the new configuration."
            },
            {
                10351,
                @"A task is removed The task arg was removed because of configuration changes."
            },
            {
                10352,
                @"A task is added The task arg was installed because of configuration changes."
            },
            {
                10353,
                @"A task is reinstalled The task arg was reinstalled because of configuration changes."
            },
            {
                10354,
                @"Restore aborted due to lost system data The system is using a backup of the system data, since the system data was not properly saved at last shutdown. Due to this, a previously ordered Restore from directory arg was attempted again, but was aborted."
            },
            {
                10355,
                @"Restore error Error during the restore of Task. Trying to load to unknown task, arg."
            },
            {
                10356,
                @"Restore warning The module arg is automatic loaded from old module format (.mod), If the module is updated after installation there is no possibility to restore the changes because format of module files is changed to .modx format."
            },
            { 10400, @"User arg logged on User arg logged on using arg." },
            { 10401, @"User arg logged off User arg using arg logged off." },
            {
                10420,
                @"New unsafe robot path The robot path has been cleared after a target has been modified in task arg."
            },
            {
                10421,
                @"Planned path not aborted A target that may be part of the planned robot path has been modified. The new target position will be used the next time the instruction with the target is executed."
            },
            {
                10451,
                @"Update of RobotWare system failed It was not possible to apply update of the current RobotWare system using Update package with ID: arg. Error code is: arg."
            },
            {
                10452,
                @"Update of RobotWare system done Update of the RobotWare system has been successful."
            },
            {
                10455,
                @"Update of RobotWare system error Update of the current RobotWare system did not complete properly."
            },
            {
                10457,
                @"Event routines are deferred The arg event routine arg in task arg could not start. Executions of event routines are deferred until next start order for this task."
            },
            {
                10458,
                @"System state could not be restored after RobotWare system update Under normal circumstances, previous system state is automatically reloaded after the system has been updated."
            },
            {
                10459,
                @"System restored from a snapshot System state has been restored from a snapshot."
            },
            {
                11020,
                @"Backup error An error occurred while preparing to create a backup. Unknown error."
            },
            {
                11024,
                @"Backup error An error occurred while preparing to create a backup. A directory/file couldn't be created."
            },
            {
                11025,
                @"Backup error An error occurred while preparing to create a backup. The backup directory couldn't be created."
            },
            {
                11026,
                @"Backup error An error occurred while preparing to create a backup. Error while creating the backinfo.txt file"
            },
            {
                11029,
                @"Backup error An error occurred while preparing to create a backup. The given backup path is too long."
            },
            {
                11031,
                @"Backup error An error occurred while preparing to create a backup. Error while searching for a file/entry."
            },
            {
                11036,
                @"Backup error An error occurred while preparing to create a backup. Write error."
            },
            {
                11037,
                @"Backup error An error occurred while preparing to create a backup. At least one modules name is too long."
            },
            {
                11039,
                @"Backup error An error occurred while preparing to create a backup. The drive is full."
            },
            {
                11041,
                @"Backup error An error occurred while preparing to create a backup. Error while verifying the system. system.xml isn't installed in the system."
            },
            {
                11042,
                @"Backup error An error occurred while preparing to create a backup. Error while verifying the system. system.xml isn't present in the SYSTEM directory."
            },
            { 11044, @"Backup error Error while verifying the backup path." },
            {
                11045,
                @"Backup error Error while creating the backup directory due to missing access rights."
            },
            { 11120, @"Backup error Error during the backup step Configuration. Unknown error." },
            {
                11127,
                @"Backup error Error during the backup step Configuration. Error while reading configuration parameters."
            },
            {
                11128,
                @"Backup error Error during the backup step Configuration. Error writing configuration parameters"
            },
            {
                11129,
                @"Backup error Error during the backup step Configuration. The given backup path is too long."
            },
            ...
            {
                11222,
                @"Backup error Error during the backup of Task. The backup already contains directories that are to be created."
            },
            {
                11223,
                @"Backup error Error during the backup of Task. The directory lacks at least one necessary item."
            },
            {
                11224,
                @"Backup error Error during the backup of Task. The directory does not exist."
            },
            {
                11225,
                @"Backup error Error during the backup of Task. Directory cannot be created."
            },
            {
                11226,
                @"Backup error Error during the backup of Task. Error while writing the backup."
            },
            {
                11229,
                @"Backup error Error during the backup step Prepare. The given backup path is too long"
            },
            ...
            {
                11237,
                @"Backup error Error during the backup of Task. At least one modname is too long."
            },
            ...
            {
                11263,
                @"Backup operation failed The user arg does not have the required UAS grant UAS_BACKUP for the requested backup operation."
            },
            { 12020, @"Restore error Error during the restore step Prepare. Unknown error." },
            {
                12023,
                @"Restore error Error during the restore step Prepare. The directory lacks at least one necessary item."
            },
            {
                12024,
                @"Restore error Error during the restore step Prepare. The directory does not exist."
            },
            {
                12029,
                @"Restore error Error during the restore step Prepare. The path is too long."
            },
            ...
            {
                12032,
                @"Restore error Error during the restore step Prepare. The system version doesn't match the backup."
            },
            {
                12033,
                @"Restore error Error during the restore step Prepare. Error restoring configuration parameters."
            },
            {
                12035,
                @"Restore error Error during the restore step Prepare. Mismatch between current system and the backup."
            },
            ...
            {
                12123,
                @"Restore error Error during the restore step Configuration. The directory lacks at least one necessary item."
            },
            {
                12129,
                @"Restore error Error during the restore step Prepare. The path is too long."
            ...
            {
                12130,
                @"Restore error Error during the restore step Configuration. No more objects"
            },
            {
                12131,
                @"Restore error Error during the restore step Configuration. The directory lacks at least one necessary item."
            ...
            {
                12134,
                @"Restore error Error during the restore step Configuration. Error restoring configuration parameters."
            },
            ...
            {
                12231,
                @"Restore error Error during the restore of Task. The directory lacks at least one necessary item."
            },
            ...
            {
                12323,
                @"Restore error Error during the restore of User Task. The directory lacks at least one necessary item."
            },
            ...
            {
                12350,
                @"Backup pending A backup will not be completed until the system input signal Disable Backup is set and reset."
            },
            {
                12351,
                @"Backup pending The system input signal Disable Backup is set. A backup will not be completed until the system input signal Disable Backup is reset."
            },
            {
                12510,
                @"Network subnet mask illegal The subnet mask arg for network interface arg is illegal."
            },
            {
                12511,
                @"Network interface IP address illegal The network IP address arg for interface arg is illegal/missing."
            },
            {
                12512,
                @"Network gateway IP address illegal The gateway IP address arg is illegal/missing or the destination IP address arg is illegal"
            },
            {
                12513,
                @"No parameters from the DHCP server The network interface arg has not received any parameters from the DHCP server."
            },
            {
                12514,
                @"Network interface initialization error The network interface arg could not be initialized."
            },
            {
                12515,
                @"Network interface IP addresses overlap The network IP address for 'arg' is overlapping with IP address for 'arg'"
            },
            {
                12516,
                @"Port forwarding configuration failed Attempt to setup forwarding to IP address 'arg' and port 'arg' did not succeed."
            },
            {
                12521,
                @"Network service disabled The network service arg is disabled on the arg network of the controller."
            },
            {
                12610,
                @"Available RAM memory low The available amount of RAM memory is low. Total RAM memory size: arg bytes. Free: arg bytes."
            },
            {
                12611,
                @"Available RAM memory very low The available amount of RAM memory is very low. Total RAM memory size: arg bytes. Free: arg bytes."
            },
            {
                12612,
                @"Available RAM memory too low The available amount of RAM memory is too low. Total RAM memory size: arg bytes. Free: arg bytes."
            },
            {
                12700,
                @"Missing time zone information No time zone information has been specified."
            },
            {
                12705,
                @"OPC UA Server up and running OPC UA Server up and running on arg on Endpoint url."
            },
            { 12706, @"WAN IP Address Changed Controller WAN IP Address is changed." },
            {
                20012,
                @"System failure state active Fatal non-recoverable system error. Controller restart is required"
            },
            {
                20030,
                @"Axis not commutated One or several internal drive unit axes are not commutated."
            },
            {
                20031,
                @"Axis not calibrated. One or several absolute/relative measurement axes are not calibrated."
            },
            {
                20032,
                @"Rev. counter not updated Revolution counter is not updated. One or several absolute measurement axes are not synchronized."
            },
            {
                20033,
                @"Axis not synchronized One or several relative measurement axes are not synchronized."
            },
            {
                20034,
                @"Robot memory is not OK This action or state is not allowed since data in the robot memory is not OK."
            },
            {
                20051,
                @"Not allowed command The command is only allowed when the client is in control of the resource (program/motion)."
            },
            {
                20054,
            ...
            {
                20059,
                @"Not allowed command The command is not allowed when the file containing system persistent data is invalid (the system has been started using
            ...
            {
                20066,
                @"Not allowed command The system input action arg is not allowed in Manual full speed mode."
            },
            {
                20067,
                @"Not allowed command The system input action arg is not allowed when changing to Manual full speed mode."
            },
            { 20068, @"Not allowed command The command is not allowed in current energy state." },
            {
                20069,
                @"Not allowed command The command is not allowed when the robot is manually jogged."
            },
            ...
            {
                20084,
                @"Not allowed command This command is not allowed since data in the robot memory is not OK"
            },
            {
                20088,
            ...
            {
                20089,
                @"Automatic Mode Rejected The call chain was altered to begin at a routine other than main and could not be reset to main when automatic mode was requested."
            },
            { 20092, @"Not allowed command Not allowed in state System IO Start Blocked." },
            {
                20093,
                @"Automatic Mode Rejected One or more of the NORMAL tasks were disabled and could not be enabled when automatic mode was requested."
            },
            ...
            {
                20103,
                @"Controller busy updating Task Selection Panel. The Task Selection Panel is having an update. It is not possible to do the requested command."
            },
            {
                20104,
                @"The system path is too long The system path is too long. It is not possible for the system to act in a safe way."
            },
            { 20105, @"Backup already in progress " },
            {
                20106,
                @"Backup path There are errors in the backup path or the backup name in the configuration for the System Input Backup. The directory for the backup cannot be created. Backup path: arg. Backup name: arg."
            },
            {
                20126,
                @"Load data has changed The active load arg was removed and replaced with arg. The load data was located in task: arg connected to mechanical unit arg."
            },
            {
                20127,
                @"Tool data has changed The active tool arg was removed and replaced with arg. The tool data was located in task: arg connected to mechanical unit arg."
            },
            {
                20128,
                @"Work object data has changed The active work object arg was removed and replaced with arg. The work object data was located in task: arg connected to mechanical unit arg."
            },
            {
                20131,
                @"Automatic Mode Rejected One or more logical I/O signals were blocked and could not be unblocked when automatic mode was requested."
            },
            {
                20132,
                @"Blocked I/O signals One or more logical I/O signals were blocked during startup in automatic mode."
            },
            {
                20133,
                @"Debug Settings in Auto One or more logical I/O signals were blocked during startup in automatic mode."
            },
            {
                20134,
                @"Call Chain The call chain has been altered to begin at a routine other than main."
            },
            {
                20135,
            ...
            {
                20136,
                @"Reduced Speed The system was running at reduced speed during startup in automatic mode."
            },
            {
                20137,
                @"Debug Settings in Auto One or more of the NORMAL tasks were disabled during the startup when in automatic mode"
            },
            {
                20138,
                @"Disabled Tasks The system was running at reduced speed during startup in automatic mode."
            },
            {
                20139,
                @"Debug Settings in Auto One or more of the NORMAL tasks were disabled during startup in automatic mode."
            },
            ...
            {
                20143,
                @"Start at main rejected Start of program at main, via System IO, was rejected."
            },
            ...
            {
                20146,
                @"Manual interrupt rejected Manual interrupt of program, via System IO, was rejected."
            },
            ...
            {
                20156,
                @"Undefined Argument Interrupt routine name for System IO Manual Interrupt is not defined"
            },
            { 20157, @"Undefined Argument Program name for System IO LoadStart is not defined." },
            {
                20158,
                @"No System Input signal A System Input has been configured to an I/O-signal that does not exist. System Input: arg. Signal Name: arg."
            },
            {
                20159,
                @"No System Output signal A System Output has been configured to an I/O-signal that does not exist. System Output: arg. Signal Name: arg."
            },
            {
                20161,
                @"Path not found The system module arg in task arg has a corresponding specification in the configuration for Task modules that point out a non-existing file path."
            },
            {
                20162,
                @"Write error A write error occur when the system try to save the system module arg at arg in task arg. Or the file system was full."
            },
            { 20164, @"Reconfig failed There are still some unsaved system modules." },
            {
                20165,
                @"Program Pointer lost. Restart is no longer possible from current position."
            },
            {
                20166,
                @"Refuse to save module The module arg is older than the source at arg in task arg."
            },
            ...
            {
                20172,
                @"The system has failed An error was detected, which caused the system to fail."
            },
            {
                20176,
                @"Analog System Output Outside Limits The value arg for the System Output arg, signal arg, is outside its limits (logical min: arg m/s, logical max: arg m/s)."
            },
            {
                20178,
                @"Wrong task name configured Wrong task name arg configured for System Input arg."
            },
            { 20181, @"System Reset rejected. " },
            {
                20182,
                @"The System Input Signal QuickStop is rejected QStop of program, via System IO, was rejected."
            },
            {
                20184,
                @" Incorrect argument for System Inputs  An undefined Start Mode has been declared for System IO."
            },
            {
                20188,
                @"System data is not valid The contents of the file, containing system persistent state is invalid. Internal error code: arg. The system has been started using last good auto-recovery state saved earlier at arg."
            },
            {
                20193,
                @" Robot data update warning Axis sync values and service information data (SIS) was restored from auto-recovery backup."
            },
            {
                20194,
                @"Auto-recovery backup could not be created The system state was restored successfully on startup but a auto-recovery backup of the current system state could not be created."
            },
            {
                20195,
                @"System state from last shutdown is lost Internal system file containing system persistent state was not found. Under normal circumstances, the system state is automatically stored to controller persistent memory during shutdown or restart. The system has been started using auto-recovery system data saved earlier at arg."
            },
            {
                20196,
                @"Module saved During reconfiguration of the system a changed and not saved module was found. The module was saved to arg."
            },
            {
                20271,
                @"Text files are no longer supported The file arg is of old text format that is no longer supported./>"
            },
            {
                20280,
                @"Symbol conflict The signal arg defined in the IO configuration conflict with another program symbol with the same name."
            },
            { 20282, @"Resource and index exist " },
            { 20283, @"Text database is full " },
            {
                20284,
                @"Wrong Signal Type For System Input The System Input arg is configured with an I/O-signal of wrong type. The I/O-signal arg is of type arg and this System Input requires an I/O-signal of type arg."
            },
            {
                20285,
                @"Wrong Signal Type For System Output The System Output arg is configured with an I/O-signal of wrong type. The I/O-signal arg is of type arg and this System Output requires an I/O-signal of type arg."
            },
            ...
            {
                20321,
                @"Not-a-Number Not-a-Number was found in task arg. A symbol of type 'arg' was found holding an undefined number."
            },
            {
                20322,
                @"Positive infinity Positive infinity was found in task arg. A symbol of type 'arg' was found holding positive infinity."
            },
            {
                20323,
                @"Negative infinity Negative infinity was found in task arg. A symbol of type 'arg' was found holding negative infinity."
            },
            {
                20324,
                @"Incorrect argument for System IO Signal arg set to signal arg has an incorrect argument."
            },
            {
                20326,
                @"Incorrect argument for System IO Signa arg set to signal arg has an incorrect argument. The delay must not be a negative value."
            },
            {
                20327,
                @"System Signal already installed arg will not be loaded from the I/O configuration file. It has already been installed from the Controller configuration file."
            },
            {
                20350,
                @"Not a valid task name The task name arg cannot be used as a name of a task. It is either already used as an installed symbol, a reserved word in the system or too long (max. 16 characters)."
            },
            {
                20351,
                @"Max number of tasks exceeded The maximum number of tasks, arg, of the configuration type arg is exceeded."
            },
            {
                20352,
                @"Not a valid Motion Planner name The Motion Planner name for Mechanical Unit Group arg in arg is not correct."
            },
            {
                20353,
                @"Mechanical unit not found The mechanical unit arg in arg cannot be found in the list of configured mechanical units."
            },
            {
                20354,
                @"The argument is undefined The configured argument arg for task arg is not a valid type."
            },
            {
                20355,
                @"Mechanical Unit Group name not correct The configured name of arg in task arg is not correct."
            },
            {
                20356,
                @"Maximum number of Motion tasks exceeded Only arg tasks are allowed to control mechanical units i.e. execute RAPID move instructions."
            },
            {
                20357,
                @"No configured Motion task No task is configured to control mechanical units i.e. execute RAPID move instructions."
            },
            {
                20358,
                @"No members of arg configured The configuration type is required in a multi robot system."
            },
            {
                20359,
                @"Cfg type arg is configured The type was found but not expected in a system with current options."
            },
            { 20360, @"Unknown event in cfg type arg The event arg is not a system event" },
            {
                20361,
                @"Only shared modules in the shared task The module arg is not configured shared and cannot be loaded into the shared task."
            },
            {
                20362,
                @"Not defined task name The task arg in cfg type arg is not configured in the system."
            },
            {
                20363,
                @"Module not a system module The module arg loaded from the file arg is not a system module."
            },
            {
                20364,
                @"Max number of Mechanical Unit Groups exceeded The maximum number of Mechanical Unit Groups, arg, of the configuration type arg is exceeded."
            },
            {
                20365,
                @"Update of configuration is done All tasks are reset to its main routine due to configuration changes."
            },
            {
                20366,
                @"Type error in task configuration The task arg is configured with wrong type. Task configured to control mechanical units i.e. execute RAPID move instructions must be of type arg."
            },
            {
                20367,
                @"No configured mechanical units The instance arg of configuration type arg has no mechanical unit argument."
            },
            {
                20368,
                @"Not connected Mechanical Unit Group There is no Motion task connected with the Mechanical Unit Group arg."
            },
            {
                20370,
                @"Failed to read configuration data for regain distance The system failed to read the configuration data for the type . The regain distance is the limit when the system will warn before a start with regain movement."
            },
            {
                20371,
                @"A default Mechanical Unit Group is used The configuration of task arg has no connection to arg. The attribute arg is required in a MultiMove system and is missing"
            },
            {
                20372,
                @"Failed to read configuration data. The system failed to read the configuration data for the type <arg>."
            },
            { 20373, @"Missing task name No task is given for module arg in cfg type arg." },
            {
                20380,
                @"No Motion Planner connected to mechanical unit The mechanical unit arg has no Motion Planner connected."
            },
            {
                20381,
                @"Error when recreating path after power fail The path wasn't successfully recreated."
            },
            {
                20390,
                @"Start rejected Start/restart of program, via System IO, was rejected. The reason is that write access is held by arg using arg."
            },
            {
                20391,
                @"Start at main rejected Start of program at main, via System IO, was rejected. The reason is that write access is held by arg using arg."
            },
            {
                20392,
                @"Manual interrupt rejected Manual interrupt of program, via System IO, was rejected. The reason is that write access is held by arg using arg."
            },
            {
                20393,
                @"Load and start rejected Load and start of program, via System IO, was rejected. The reason is that write access is held by arg using arg."
            },
            ...
            {
                20399,
                @"Static/Semistatic task started At least one static/semi-static task (alias background task) was not executing after startup in automatic mode."
            },
            {
                20400,
                @"Debug Settings In Auto A static/semi-static task (alias background task) has been stopped."
            },
            { 20401, @"Too many CFG instances " },
            {
                20402,
                @"Automatic Mode Rejected An active RAPID Spy session could not be deactivated when automatic mode was requested."
            },
            {
                20403,
                @"RAPID Spy deactivated RAPID Spy was deactivated after startup in automatic mode."
            },
            { 20404, @"Debug Settings In Auto RAPID Spy is active." },
            {
                20408,
                @"PP to Main rejected Setting PP to Main, via System IO, was rejected. The reason is that write access is held by arg using arg."
            },
            { 20409, @"PP to Main rejected Setting PP to Main, via System IO, was rejected." },
            {
                20410,
                @"Energy Saving has been reset Energy Saving has been reset. Before being reset, the system was in Energy Saving Mode: arg."
            },
            {
                20411,
                @"Energy saving activated The robot system has entered an energy saving state."
            },
            {
                20412,
                @"Energy saving deactivated The robot system has resumed from an energy saving state."
            },
            {
                20413,
                @"Motors On failed Motors On failed when the controller was resuming from an energy saving state."
            },
            {
                20414,
                @"Program start failed Start of program execution failed when the controller was resuming from an energy saving state."
            },
            {
                20415,
                @"Motors On/Program Start failed Motors On and/or Start of program execution failed when the controller was resuming from an energy saving state."
            },
            {
                20416,
                @"Energy saving blocked The robot system has been blocked from entering an energy saving state."
            },
            { 20417, @"Energy saving unblocked The robot system has left blocked state." },
            {
                20418,
                @"Energy saving already active The robot system has already entered energy saving state. There is no support for switching between energy saving modes.
            To enter a different energy saving mode, the robot system must first be resumed."
            },
            {
                20425,
                @"Write Access rejected Requesting Write Access, via System IO, was rejected."
            },
            {
                20426,
                @"Write Access rejected Requesting Write Access, via System IO, was rejected. The reason is that write access is held by arg using arg."
            },
            {
                20440,
                @"Failed to initialize FW upgrade framework The firmware upgrade framework for hardware boards could not be initialized."
            },
            {
                20441,
                @"Failed to initialize firmware patch Failed to initialize the firmware patch handling for hardware boards."
            },
            {
                20443,
                @"Multiple firmware upgrade restarts A new restart to firmware upgrade mode was ordered after two consecutive upgrade restarts."
            },
            {
                20573,
                @"Controller ID is Missing Controller ID is the controller's unique identity. It is by default equal to the serial number of the controller's cabinet."
            },
            {
                20578,
                @"ABB internal licenses are used icenses for ABB internal use are installed on this controller."
            },
            {
                20600,
                @"Unofficial RobotWare release The current RobotWare is not an officially supported release. Unofficial RobotWare releases may only be used for time-limited test and validation purposes."
            },
            {
                20602,
                @"Unofficial RobotWare image The current RobotWare main computer image is not the original, and is hence not officially supported."
            },
            {
                20610,
                @"Motor phase short circuit The drive unit for joint arg has reported short circuit. The joint is connected to drive module arg with unit position arg and node arg."
            },
            {
                20620,
                @"The system has entered an internal test mode A feature to perform ABB Robotics internal tests has been enabled in arg."
            },
            {
                20630,
                @"Camera job missing Output to Rapid The camera arg has a job loaded that is not created with the Use Output to Rapid functionality. The Use Output to Rapid functionality will be disabled until the next state change from program mode to run mode."
            },
            {
                20633,
                @"Integrated Vision not installed The option Integrated Vision is not installed on this system."
            },
            {
                20634,
                @"No result for current camera job The robot controller did not receive any result for camera arg."
            },
            {
                20635,
                @"Too many cameras connected Number of cameras connected to the robot controller is arg. Max number of cameras for a robot controller is arg."
            },
            {
                20636,
                @"Duplicated camera name The camera configuration is invalid. The camera name arg have been used for more than one camera."
            },
            {
                20637,
                @"Camera permission denied Permission denied to login to the camera with ip address arg using username arg."
            },
            {
                20638,
                @"Option missing You are trying to use functionality that require the RobotWare Option arg."
            },
            {
                20639,
                @"Camera connection up The robot controller communicates correctly with the camera arg with IP address arg."
            },
            {
                20640,
                @"Camera connection down The connection to camera arg with IP address arg has been lost."
            },
            { 20641, @"New camera detected A new camera with mac address arg has been detected." },
            {
                20642,
                @"DryRun configuration error Error while reading the DryRun configuration file arg."
            },
            {
                20643,
                @"DryRun configuration error Error while reading the DryRun configuration file arg."
            ...
            {
                20645,
                @"DryRun configuration error Unexpected error during the DryRun configuration."
            },
            ...
            {
                20649,
                @"DryRun configuration error Error while configuring DryRun, a signal named arg already exists."
            },
            {
                20650,
                @"DryRun aborted DryRun was aborted when program execution reached end of main without reaching position where program pointer was placed when DryRun started."
            },
            { 20651, @"Image request timed out An image request for camera arg has timed out." },
            {
                20652,
                @"Camera job is not valid The job loaded into the camera arg is not correct or is not compatible with this version of RobotWare."
            },
            { 20653, @"DryRun rejected DryRun was rejected due to unfinished movement." },
            {
                20655,
                @"No job is loaded in the camera There is no job loaded in the camera arg or the active job in the camera has not been saved."
            },
            {
                20656,
                @"Camera refresh started An update of camera information has been ordered by an external client."
            },
            {
                20657,
                @"Camera IP address changed The IP address of camera arg with MAC address arg has changed."
            },
            {
                20658,
                @"Camera updated The camera arg with IP addressarg and MAC address arg has been updated."
            },
            {
                20659,
                @"Camera instruction The camera arg is of type arg. The instruction arg is not available on a camera arg."
            },
            {
                20660,
                @"Debug service not using default values The debug service is not using default values and the system is considered to be in debug mode."
            },
            {
                20661,
                @"Debug service using default values The debug service is now using default values and the system is no longer in debug mode."
            },
            {
                20665,
                @"Error during automatic calibration Description Error locating the hall sensor. Unable to move off the sensor for joint arg."
            },
            { 20666, @"Error during automatic calibration Error locating the hall sensor." },
            {
                20667,
                @"System state is lost The file containing system persistent data cannot be found and auto-recovery backup of the previous last-good system state is not available."
            },
            {
                20668,
                @"Uas grant removed In the User Authorization System, the role arg has a grant specified that no longer exist."
            },
            {
                20669,
                @"The camera user is missing sufficient permission The camera user account arg is missing sufficient permission to communicate with camera, ip address arg . For the controller to be able to communicate to the camera, the user account on the camera requires access: Protected or Full."
            },
            {
                20670,
                @"Obsolete compression format The identified compression format is no longer in use."
            },
            {
                20671,
                @"Restricted command The script file arg contains the restricted command arg that is not allowed in untrusted scripts."
            },
            {
                20672,
                @"Restricted command This script file arg contains the restricted command arg that is not allowed in untrusted scripts."
            },
            {
                20673,
                @"No brake release function available The system has started with no available emergency brake release function."
            },
            {
                31810,
                @"DeviceNet master/slave board is missing The DeviceNet master/slave board does not work."
            },
            {
                31910,
                @"Profibus-DP master/slave board is missing The PROFIBUS master board does not work."
            },
            {
                31911,
                @"Profibus board update error The RobotWare software was not able to download new driver software to the PROFIBUS master board."
            },
            {
                31912,
                @"PROFIBUS master board failure The PROFIBUS master board did not start up correctly."
            },
            {
                31913,
                @"PROFIBUS master board internal error The PROFIBUS master board reported internal error arg"
            },
            {
                31914,
                @"PROFIBUS network startup erro ROFIBUS network startup error arg. Check cabling, terminators and modules then restart."
            },
            {
                31915,
                @"PROFIBUS network error PROFIBUS master network error. Internal error Error code arg."
            },
            ...
            {
                38108,
                @"Broken sequence order of serial measurement board (SMB) link for chain-connected drive unit "
            },
            ...
            {
                38211,
                @"Measurement functionality error The serial measurement board does not support 7 axes."
            },
            ...
            {
                40077,
                @"Reference error arg not optional parameter reference in conditional argument value"
            },
            {
                40078,
                @"Reference error arg not optional parameter reference in conditional argument value "
            ...
            {
                40163,
                @"Module error The module arg has too many lines to be loaded. Maximum number of lines allowed in a module is arg."
            },
            ...
            {
                40209,
                @"Error handler already executed The context of the RAPID instruction that has generated this event is however already consumed. No error handling is therefore possible to execute."
            },
            {
                40210,
            ...
            {
                40225,
                @"Execution error Execution could not be restarted. Execution of the program could not be continued after power failure."
            },
            {
                40226,
            ...
            {
                40247,
                @"Persistent variable size error Persistent variable arg: has changed size and must be reinitialized."
            },
            ...
            {
                40266,
                @"Reference error arg is not a data type name (object arg) The specified name identifies an object other than a type. "
            },
            {
                40267,
                @"Reference error arg is not a value data type (object arg) Only record components"
            },
            ...
            {
                40277,
                @"Undo Aborted The program was stopped while processing the UNDO statements.UNDO was not fully executed."
            },
            {
                40278,
            ...
            {
                40280,
                @"Undo Aborted The instructions BREAK, RAISE, RETURN and STOP are not allowed to use."
            },
            {
                40281,
            ...
            {
                40354,
                @"A copy of a dynamic loaded module has been saved. A dynamic loaded module has been changed. The module is lost when PP is set to main. "
            },
            {
                40355,
                @"A Stop/QStop event routine has been stopped. A arg event routines will be stopped after arg ms when controller receives second stop command."
            },
            {
                40357,
                @"Missing Error Handler There is no error handler that deals with the process error for task arg."
            },
            {
                40358,
                @"RMQ message discarded A RMQ message was discarded in task arg. arg received a RMQ message that couldn't be handled."
            },
            {
                40359,
                @"An event routine has been stopped A arg event routine has been stopped by an external stop command."
            },
            ...
            {
                40362,
                @"String contains illegal characters The string starting with arg on line arg is not correct."
            },
            ...
            {
                40530,
                @"Parameter Error The number of characters,parameter in WriteBin,is greater than size of array containing character."
            },
            {
                40531,
            ...
            {
                40593,
                @"Power Fail During Load Identification A Power Fail during load identification results in faulty load result."
            },
            ...
            {
                40632,
                @"Instruction Error No move instructions with concurrent RAPID program execution are allowed within the StorePath-RestoPath part of the program."
            },
            { 40634, @"Reference Error The signal arg is unknown in the system." },
            {
                40648,
                @"Search Error Not allowed to do StorePath while searching is active on motion base path leve"
            },
            {
                40649,
                @"Path Limitation arg is already done or executing. Instruction arg must first be executed, before a new arg can be done."
            },
            {
                40650,
                @"Wrong Combination Of Parameters Optional parameters and switches are not used in a correct combination."
            },
            { 40651, @"Use Numeric Input " },
            {
                40652,
                @"Axis Is Moving A Robot axis, an external axis or an independent axis is moving."
            },
            {
                40654,
                @"Axis Not Active The axis destination position to move to is undefined (9E9) or the axis to move is not active at present."
            },
            ...
            {
                40670,
                @"Invalid World Zone The index of world zone argument arg in arg is not a valid index defined by WZLimSup or WZDOSet."
            },
            ...
            {
                40736,
                @"Mechanical Unit Error It is not possible to define a payload on the robot with this instruction."
            },
            ...
            {
                40740,
                @"Execution Error The PERS variable specified in the instruction TriggStopProc can not be updated"
            },
            { 40741, @"Context Error " },
            {
                40742,
            ...
            {
                40746,
                @"Parameter Error arg TRUE in parameter arg in combination with conveyor coordination. "
            },
            { 40747, @"Access Error " },
            { 40748, @"Value Error " },
            {
            ...
            {
                40765,
                @"Argument Error In the instruction arg the argument arg is not an open directory."
            },
            {
                40766,
                @"Parameter Error In the instruction arg the argument arg can't be used without the argument arg."
            },
            ...
            {
                40783,
                @"Mode Error File or serial channel is not opened in a character-based mode."
            },
            ...
            {
                40793,
                @"Error Installing Text Table No or faulty text resource name or index number in the text file. "
            },
            {
                40794,
            ...
            {
                40804,
                @"Argument Error The argument type in stoppointdata may not be followtime in the instructions MoveJ, MoveAbsJ and MoveExtJ."
            },
            { 40805, @"Motion Error " },
            { 40806, @"IOF Error " },
            { 40807, @"File Error " },
            ...
            {
                40817,
                @"Symbol Definition Error The string and the used format string(s) will be too long to store in a RAPID string."
            },
            ...
            {
                41420,
                @"Parameter Error The argument type of arg is not compatible with cfg type. Expected arg."
            },
            ...
            {
                41480,
                @"UnpackRawBytes Error The number of bytes to unpack is too high, and has been reduced. Length: arg."
            },
            ...
            {
                41497,
                @"Move PP Notification Instruction arg was active in this task. Moving PP within the program can be dangerous in some cases."
            },
            {
                41498,
                @"No Defined UserFrame In Mechanical Unit arg! The workobject arg contains a coordinated mechanical unit which has no defined user frame."
            },
            ...
            {
                41524,
                @"Instruction Error The program is executing in UNDO handler. It ist allowed to execute instruction inUNDO handler."
            },
            {
                41525,
                @"Instruction Error The program is executing in EVENT routine.It ist allowed to execute instruction  in EVENT routine."
            },
            ...
            {
                41530,
                @"Instruction Error It is not possible to execute instruction while workobject has a reference to mechanical unit."
            },
            ...
            {
                41557,
                @"Mechanical Unit not stopped Not allowed to change run mode, if not all Motion tasks are stopped."
            },
            ...
            {
                41600,
                @"Socket error specified client socket is already in use. The client socket must not be created before calling SocketAccept."
            },
            ...
            {
                41626,
                @"Unexpected arg \arg Instruction arg \arg is used in independent motion mode."
            },
            ...
            {
                41640,
                @"Move PP Warning Move of program pointer when path is stored may cause problems if moved to a place after path restore."
            },
            {
                41641,
                @"Move PP Warning Move of program pointer when stop motion is active may cause problems if moved to a place after stop motion deactivation."
            },
            ...
            {
                41680,
                @"String too long The string arg exceeds the maximum number of characters allowed for a module."
            },
            ...
            {
                41884,
                @"CyclicBrakeCheck Error SafeMove option or the EPS option is a requirement if running CyclicBrakeCheck."
            },
            {
                41885,
                @"BrakeCheck Error When having a SafeMove option or the EPS option, CyclicBrakeCheck should be used to test brakes."
            },
            {
                41886,
                @"CyclicBrakeCheck Erro CyclicBrakeCheck is already active. The CyclicBrakeCheck routine cannot be executed from several tasks or execution levels at the same time."
            },
            {
                41887,
                @"BrakeCheck Error BrakeCheck is already active. The BrakeCheck routine cannot be executed from several tasksor execution levels at the same time."
            },
            {
                41888,
                @"Not allowed command The instruction/function arg cannot be used when you have an ongoing brake check."
            },
            {
                41889,
                @"Value error The value read is an integer and above the maximum integer value for num, 8388608."
            },
            ...
            {
                41896,
                @"Argument error Cannot calculate a plane because the three points are collinear."
            },
            {
                41897,
                @"Argument error Cannot calculate a line because the two points are too close."
            },
            ...
            {
                41901,
                @"Text Table Name not valid The text table name is too long. Max arg characters can be used in the name."
            },
            {
                41902,
                @"Speed override changed The speed override set by the operator from the FlexPendant has been changed. To get right performance, the speed override has to be set to 100%."
            },
            {
                41903,
                @"Brake Check, arg file renamed The Brake Check program has detected that tuning is used or has been used. Current file arg cannot be modified with the new entry arg."
            },
            {
                41905,
                @"Argument error Cannot calculate a sphere because the points are distributed along a line."
            },
            {
                41906,
                @"Path Not In Stop Point One or several mechanical units connected to task arg is not in a stop point. A path is currently active."
            },
            {
                41907,
                @"Too far from path One or several mechanical units connected to task arg is too far from the path to perform a regain movement."
            },
            { 41908, @"Instruction Error No user logged on from FlexPendant." },
            {
                41910,
                @"Collision simulated with instruction SimCollision Instruction arg has been used to simulate a collision."
            },
            {
                41911,
                @"Not valid character used in RAPID string A character used in the RAPID string arg can not be converted to an ISO 8859-1 character."
            },
            {
                41912,
                @"No ongoing cameraset parameter request There is no ongoing request to set a parameter to camera arg."
            },
            {
                41913,
                @"Preceding instruction caused set parameter to fail Preceding instruction failed and also caused set parameter to fail for camera arg."
            },
            {
                41914,
                @"Cancel set parameter for camera The ongoing set parameter arg for camera arg has been cancelled."
            },
            {
                41915,
                @"Load or Save module with old module format The filename arg cannot be saved in old module format (.mod). The file must be loaded or saved in .modx format."
            },
            {
                41916,
                @"String too long The string is too long (arg bytes). Not valid RAPID string length."
            },
            {
                41917,
                @"The number of characters does not fit in string The specified number of characters arg (argument NoOfChars) to read does not fit in a RAPID string. A RAPID string can consist of max 80 bytes."
            },
            {
                41918,
                @"Execution Error Automatic or Manual Full Speed operating mode is not used. Reduced speed affects the functionality."
            },
            { 41919, @"Undefined value The value of tan arg.is undefined." },
            {
                41920,
                @"Not accessible path The path arg is not a valid path or a path that is not accessible due to restrictions."
            },
            {
                41921,
                @"Parameter Error The argument arg is of the type arg. arg is write protected, and can not be overwritten."
            },
            {
                41922,
                @"Value error The string is arg bytes, and it exceeds the maximum number of bytes for a RAPID string."
            },
            {
                41923,
                @"Obsolete switch arg The switch arg is obsolete in arg. It will work for now, but will be removed in a later release. Use arg instead and you will have the same functionality."
            },
            {
                41924,
                @"Wrong combination of optionalarguments When using optional argument arg, optional argument arg must also be used."
            },
            ...
            {
                50033,
                @"Command not allowed An attempt was made to commutate the motors in Motors On."
            },
            {
                50035,
                @"Command not allowed An attempt was made to commutate the motors in Motors On."
            ...
            {
                50124,
                @"Zone converted to fine point Corner path executed as stop point because the calculated time margin for next segment is 0."
            },
            ...
            {
                50153,
                @"Command not allowed The given instruction, or command, was not allowed since the robot program was executing in a hold state."
            },
            ...
            {
                50184,
                @"Correction vector Y failed Sensor correction vector calculations failed due to previous error."
            },
            ...
            {
                50200,
                @"Torque error Torque calculation error due to high speed for mechanical unit arg."
            },
            ...
            {
                50225,
                @"Synchronization failed Error in synchronization data. • Controller updated with new data. • System unsynchronized."
            },
            {
                50226,
                @"Motor reference error Calculation time for motor references exceeds internal limits."
            },
            ...
            {
                50235,
                @"No Motion interrupts received The system has not generated motion interrupts within timeout."
            },
            {
                50239,
                @"Emergency Stop change Emergency Stop changed brake mode because of acceleration limitation."
            },
            {
                50240,
                @"Emergency Stop change Emergency Stop changed to brake mode because of torque limitation."
            },
            ...
            {
                50261,
                @"WZone outside work area The definition of minimum limit for the World Zone arg is outside work area for: arg arg arg..."
            },
            {
                50262,
                @"WZone outside work area The definition of maximum limit for the World Zone arg is outside work area for: arg arg arg..."
            },
            ...
            {
                50273,
                @"Motion configuration Incorrect system parameter arg for arg. The system parameter could for instance be an unknown type or a numerical value that is out of range."
            },
            {
                50274,
                @"Motion configuration Failed to read or create arg with the name: arg. If the current instance exists it is read, else it is created."
            },
            {
                50275,
                @"Motion configuration Failed to read next arg name, previous name is arg. The previous instance is ok, but the next instance cannot be read."
            },
            {
                50276,
                @"Motion configuration Standard servo queue length (arg) out of range (min=1, max=arg)."
            },
            {
                50277,
                @"Motion configuration Number of joints (arg) in dynamic group override. Allowed number is arg."
            },
            { 50278, @"Motion configuration Failed to configure servo gun (arg)." },
            {
                50279,
                @"Motion configuration Servo tool change requires option Servo Tool Change. Without this option, installation of this mechanical unit is not allowed."
            },
            ...
            {
                50349,
                @"Same synchronization ID Two consecutive synchronized move instructions in arg have the same synchronization ID value arg."
            },
            ...
            {
                50433,
                @"Position changed to inside working area The joint arg is outside its normal working area when an Independent Reset instruction is executed."
            },
            {
                50434,
                @"Position changed to inside working area The joint arg is outside its normal working area when an Independent Reset instruction is executed with argument Old."
            },
            { 50435, @"Inconsistent system parameter " },
            {
                50436,
                @"Robot configuration error It is not possible to reach the programmed position with given robot configuration."
            },
            ...
            {
                50474,
                @"Target in a singularity The robot target is near singular because joint arg is too close to arg degrees."
            },
            {
                50475,
                @"Target in a singularity The robot target is near singular because the TCP is too close to the arm-angle reference direction."
            },
            { 50476, @"AxisCal error " },
            ...
            {
                71077,
                @"Communication error from rtp1 Not possible to deliver the received message"
            },
            {
                71078,
                @"Communication error from rtp1 The response from the device has an invalid frame sequence."
            },
            ...
            {
                71163,
                @"I/O signal on internal I/O device The user-defined I/O signal arg must not be connected to the internal I/O device arg."
            },
            {
                71164,
                @"Internal I/O signal in cross connection The I/O configuration of cross connection arg is invalid. The Actor arg arg is a user-defined I/O signal whereas the resultant I/O signal arg is an internal I/O signal."
            },
            {
                71165,
            ...
            {
                71182,
                @"I/O signal undefined The I/O configuration of cross connection arg is invalid. The parameter Resultant contains a reference to an undefined I/O signal arg."
            },
            {
                71183,
                @"Cross connection with invalid operator The parameter Operator arg contains an invalid/unknown operator arg. Valid values for the logical operator are: • AND, • OR"
            },
            {
                71185,
                @"Duplicate name The identifier arg has already been used as the name of another configuration instance."
            },
            {
                71193,
                @"Invalid physical I/O mapping The I/O device uses an input size of arg bits, the controller can handle maximum arg bits."
            },
            { 71196, @"Invalid encoding type " },
            {
                71201,
                @"Unknown network The encoding type arg is not valid for signal type arg. Valid encoding types are: • UNSIGNED, • TWO_COMP"
            },
            { 71205, @"Could not mount directory " },
            {
                71241,
                @"Too many I/O devices on network The number of I/O devices on network arg must not exceed arg."
            },
            {
                71261,
                @"Transport layer failure The physical channel for transport layer arg is invalid."
            },
            {
                71262,
                @"Industrial network communication failure Communication with 'arg' master failed on I/O device with mac id arg."
            },
            { 71263, @"CAN communication failure CAN communication failed due to arg." },
            {
                71264,
                @"Conveyor tracking error Conveyor tracker 'arg' reported error message: arg."
            },
            {
                71273,
                @"I/O device configuration mismatch I/O device arg with address arg is configured in the I/O configuration, but it cannot be found in the network specific configuration."
            },
            {
                71276,
                @"Communication established with I/O device Communication established with I/O device arg with address arg on network arg."
            },
            {
                71278,
                @"Mount permission denied Permission was denied to mount device arg on the server arg."
            },
            {
                71288,
            ...
            {
                71289,
                @"Memory partition is too big The memory partition for communication purposes cannot be allocated. The requested partition arg kB. System partition will be used."
            },
            {
                71290,
                @"Could not add FTP device Adding the FTP device arg to the operating system failed. Application protocol arg."
            },
            { 71291, @"Invalid local path " },
            {
                71293,
                @"Invalid input size On DeviceNet I/O device arg the connection input size does not match the I/O device."
            },
            {
                71294,
                @"Invalid output size On DeviceNet I/O device arg the connection output size does not match the I/O device."
            },
            {
                71295,
                @"Invalid input size On DeviceNet I/O device arg the connection 2 input size does not match the I/O device"
            },
            {
                71296,
                @"Invalid output size On DeviceNet I/O device arg the connection 2 output size does not match the I/O device."
            },
            { 71297, @"Invalid connection type " },
            { 71298, @"Duplicated address " },
            {
                71299,
                @"No power on DeviceNet network The 24 V power supply from the DeviceNet power supply is missing."
            },
            {
                71300,
                @"DeviceNet network communication warning A minor number of communication errors occurred on the DeviceNet network."
            },
            ...
            {
                71397,
                @"No application protocol The application protocol arg is missing or the name is faulty."
            },
            { 71398, @"Communication error from bosv24 No response from the serial line." },
            {
                71399,
                @"Communication error from bosv24 Not possible to deliver the received message."
            },
            {
                71400,
                @"Communication error from bosv24 The response from the device has an invalid frame sequence."
            },
            ...
            {
                71404,
                @"Invalid input/output size The I/O device arg has an invalid value (zero) for the input or output size."
            },
            ...
            {
                71505,
                @"Device command syntax error Could not send device command to I/O device bcs there is a syntax error in command path string. Missing comma."
            },
            ...
            {
                71573,
                @"PROFINET configuration mismatch The I/O device arg reported a different slot configuration than configured in the system. Module in slot arg is of the wrong type."
            },
            {
                71574,
                @"PROFINET configuration mismatch The I/O device arg reported a different slot configuration than configured in the system. Module in slot arg is correct but one or several submodules indicate errors."
            },
            {
                71575,
                @"PROFINET configuration mismatch The I/O device arg reported a different slot configuration than configured in the system. There is no module present in slot arg however one is configured in the configuration."
            },
            ...
            {
                90618,
                @"Device attribute is invalid Device arg attribute arg is invalid on line arg."
            },
            ...
            {
                170002,
                @"170002, Connected Services registered Robot controller has successfully registered at ABB Connected Services Center."
            },
