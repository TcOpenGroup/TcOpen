...
namespace TcoAbbRobotics
{
    ...
    public static class TcoIrc5ControllerEvents_v_1_x_x
    {
        public static IDictionary<uint, string> Ids = new Dictionary<uint, string>()
        {
            ...
            {10092,@"(Re)start not possible (Re)start is not possible due to lost contact with IO "},
            {10093,@"(Re)start not possible (Re)start of task arg is not possible before a warm start is done."},
            {10095,@" At least one task is unchecked in the task selection panel "},
            {10096,@"arg not active "},
            {10097,@"Restart not possible arg is set in blocked state and not possible to restart "},
            {10098,@" Restart not possible  arg has been in system failure and not possible to restart "},
            {10099,@"Program start rejected "},
            {10106,@"Service Message  time for service robot arg because it is arg days since the last s."},
            {10107,@"Service Message remains arg days for robot arg until it's time for service."},
            {10108,@"Service Message   cause it's time for service hours of production since last service. "},
            {10109,@"Service Message  remains arg hours of production for robot arg to next service."},
            {10110,@"Service Message  gearbox at arg of robot arg needs service."},
            {10111,@"Service Message  gearbox at arg of robot arg has reached arg of its service interval"},
            {10112,@"Service Message The system date and time has changed"},
            {10120,@" Program stopped external or internal stop after current instruction has occurred."},
            ...
            {10127,@" Program stopped its not possible to execute backward past beginning of instruction list. "},
            {10128,@" Program stopped  its not possible to execute backward past the instruction"},
            ...
            {10152,@"Program started  start order was initiated by an action causing the UNDO handler to execute"},
            {10155,@"Program restarted  task has been restarted and  The originator could not be determined."},
            {10156,@"Program restarted The originator is an external client"},
            {10157,@"Program restarted  restart order was initiated by an action causing the UNDO handler to execute."},
            ...
            {10195,@" Protected area not done All tasks are reset and all user programs are lost"},
            {10196,@" Protected area not done A power fail did occur in the middle of a protected area for the task arg."},
            {10210,@" Execution canceled restart will clear the execution in task of a POWER ON system event routine."},
            {10211,@" Execution canceled restart will clear the execution in task arg of a STOP system event routine."},
            {10212,@" Execution canceled  rest.will clear the execution in task arg of an EMERGENCY STOP system event routine"},
            {10213,@" Execution canceled restart will clear the execution in task arg of a START system event routine."},
            {10214,@" Execution canceled  restart will clear the execution in task arg of a RESTART system event routine."},
            {10215,@" Execution canceled restart will clear the execution in task arg of a RESET system event routine."},
            {10216,@" Execution canceled restart will clear the execution in task arg of an INTERNAL system event routine."},
            {10217,@" Execution canceled  restart will clear the execution in task arg of a USER routine"},
            {10218,@" Execution canceled The restart will clear the execution in task arg."},
            {10219,@" Execution canceled restart will clear the execution in task arg of a STEP system event routine."},
            ...
            {10301,@"A P-Start is ordered The P-Start has been ordered manually or automatically during a configuration. "},
            ...
            {20051,@"Not allowed command  is only allowed when the client is in control of the resource (program/motion)."},
            ...
            {20065,@"Not allowed command The command is only allowed in Manual mode (reduced or full speed)."},
            ...
            {20084,@"Not allowed command  not allowed since data in the Serial Measurement Board (SMB) memory is not OK"},
            {20088,@"Automatic Mode Rejected The speed could not be set to 100% when automatic mode was requested."},
            {20089,@"Automatic Mode Rejected could not be reset to main when automatic mode was requested."},
            {20092,@"Not allowed command Not allowed in state System IO Start Blocked."},
            {20093,@"Automatic Mode Rejected  NORMAL tasks disabled and could not be enabled when automatic mode was requested."},
            ...
            {20133,@" Debug Settings in Auto  logical I/O signals were blocked during startup in automatic mode"},
            {20134,@" Call Chain "},
            {20135,@" Debug Settings in Auto The call chain has been altered to begin at a routine other than main."},
            {20136,@"Reduced Speed "},
            {20137,@"Debug Settings in Auto  system was running at reduced speed during startup in automatic mode."},
            {20138,@" Disabled Tasks "},
            {20139,@" Debug Settings in Auto  NORMAL tasks were disabled during startup in automatic mode."},
            ...
            {20314,@"Enable2 supervision fault The ENABLE2 circuit to drive module 1 has been broken"},
            {20315,@"Enable2 Supervision fault The ENABLE2 circuit to drive module 2 has been broken."},
            {20316,@"Enable2 Supervision fault The ENABLE2 circuit to drive module 3 has been broken"},
            {20317,@"Enable2 Supervision fault The ENABLE2 circuit to drive module 4 has been broken"},
            ...
            {32580,@"Firmware reflash started A required update of the arg firmware has started. "},
            {32581,@"Firmware reflash completed The update of arg firmware has completed successfully"},
            ...
            {32590,@"Firmware reflash started A required update of the arg firmware in drive module arg has started."},
            {32591,@"Firmware reflash completed The update of arg firmware in drive module arg has sucessfully completed."},
            {32592,@"Firmware reflash failed The update of arg firmware in drive module arg has failed."},
            {32593,@"Firmware file corrupt The firmware file [arg] is corrupt."},
            {32594,@"Firmware file not found The update of arg firmware in drive module arg has failed."},
            ...
            {37078,@"Purge timers differ Unacceptable divergence between Process nterfaceBoard and ManipulatorInterfaceBoard "},
            {37080,@"Purge configuration not valid. "},
            {37081,@"Purge timers differ Unacceptable divergence between CPLD and FPGA firmware on Manipulator Interface Board "},
            {37082,@"Divergence between PIB and MIB outputs "},
            {37090,@"Temp. too high, sensor arg System overheat detected. Sensors 1-7: motor 1-7, sensor 8: Serial measurement board."},
            {37094,@"Activate connection error "},
            {37095,@"Brake power fault ManipulatorControllerBoard has detected fault on the power signal and turned ON all brakes."},
            {37096,@"Brake power fault (MCOB/MCB)"},
            {37097,@"Brake short circuit fault "},
            {37098,@"Brake open circuit fault "},
            {37099,@"Temp. too high, sensor arg System overheat detected on motors, Serial measurement unit C789or process equipment."},
            ...
            {40077,@"Reference error not optional parameter reference in conditional argument value "},
            {40078,@"Reference error not optional parameter reference in conditional argument value "},
            ...
            {40209,@"Error context already consumed  context of  RAPID instruction that has generated this event is already consumed."},
            ...
            {40225,@" Execution error   could t be restarted Execution of the program could t be continued after power failure."},
            ...
            {40266,@"Reference error is not a data type name (object arg) The specified name identifies an object other than a type. "},
            {40267,@"Reference error is not a value data type (object arg) Only record components"},
            ...
            {40277,@"Undo Aborted program  was stopped while processing the UNDO statements.UNDO was not fully executed."},
            ...
            {40280,@"Undo Aborted instructions BREAK, RAISE, RETURN and STOP are not allowed to use "},
            ...
            {40354,@"A copy of a dynamic loaded module has been saved. loaded module has been changed. The module is lost when PP is set to main. "},
            {40355,@"A Stop/QStop event routine has been stopped. event routines will be stopped after arg ms when controller receives second stop command."},
            ...
            {40530,@"Parameter Error number of characters,parameter in WriteBin,is greater than  size of array containing character"},
            ...
            {40590,@" ParId Error "},
            {40591,@" ParId Error ParIdMove / Parameter StartIndex: Point at negative movetype. "},
            ...
            {40613,@"Argument Error Optional argument arg can only be combined with output signal "},
            ...
            {40648,@" Sensor Error Not allowed to do StorePath while searching is active on motion base path level."},
            {40649,@"Path Limitation  Instruction arg must first be executed, before a new arg can be done. "},
            ...
            {40670,@" Invalid World Zone index of world zone argument arg in arg is not a valid index defined by WZLimSup or WZDOSet"},
            ...
            {40740,@"Execution Error PERS variable specified in the instruction TriggStopProc can not be updated"},
            {40741,@"Context Error "},
            ...
            {40746,@"Parameter Error  TRUE in parameter arg in combination with conveyor coordination. "},
            {40747,@" Access Error "},
            {40748,@"Value Error "},
            ...
            {40766,@"Parameter Error In the instruction arg the argument arg can't be used without the argument "},
            {40767,@"Search Error "},
            ...
            {40793,@"Error Installing Text Table No or faulty text resource name or index number in the text file. Program Ref"},
            ...
            {40804,@"Argument Error argument in stoppointdata may not be followtime in instructions MoveJ, MoveAbsJ MoveExtJ. "},
            {40805,@"Motion Error "},
            {40806,@" IOF Error "},
            {40807,@"File Error "},
            ...
            {41420,@"Parameter Error The argument type of arg is not compatible with cfg type. Expected "},
            ...
            {41429,@"Axis Error The single axis is not init correctly. The sensor is not activated."},
            {41430,@"Axis Error The single axis is not init correctly. The sensor process is not init correctly. "},
            ...
            {41473,@"System Access Error It was not possible to send data using SCWrite to external computer."},
            ...
            {41489,@"Value Error The robot axis arg is not moveable and therefore must not be supervised."},
            ...
            {41497,@"Move PP Error Instruction arg was active in this task. Moving PP within the program can be dangerous in some cases."},
            ...
            {41524,@"Instruction Error program is executing in UNDO handler. It ist allowed to execute instruction inUNDO handler."},
            {41525,@"Instruction Error program is executing in EVENT routine.It ist allowed to execute instruction  in EVENT routine."},
            ...
            {41530,@"Instruction Error not possible to execute instruction while workobject has a reference to mechanical unit "},
            ...
            {41548,@"Module Error The module you are trying to erase, arg, is active and thus can not be removed."},
            ...
            {41600,@" Socket error specified client socket is already in use. client socket must not be created before calling SocketAccept."},
            ...
            {41640,@"Move PP Warning Moveprogrampointer when path is stored may cause problems if moved to a place after path restore."},
            ...
            {41684,@"Value Error The argument arg is outside the range of value type unsigned long."},
            ...
            {50032,@"Command not allowed An attempt was made to calibrate while in MOTORS ON state."},
            {50033,@"Command not allowed An attempt was made to commutate the motors in MOTORS ON state."},
            {50035,@"Command not allowed An attempt was made to synchronize in MOTORS ON state."},
            ...
            {50100,@"Manipulator configuration There are more configurations or numerical errors in motion domain."},
            {50101,@"Manipulator configuration 'arg' is not free for the param. 'arg' in type 'arg' named 'arg"},
            {50102,@"Manipulator configuration arg' used in the parameter 'arg' in type 'arg' named 'arg' is not defined"},
            {50103,@"Manipulator configuration The orientation defined by quaternions including 'arg' in the type 'arg' named"},
            {50104,@"Manipulator configuration The parameter 'arg' in type 'arg' named 'arg' is not 'arg'."},
            {50128,@"Manipulator configuration Terminating the topic check for manipulator due to earlier errors."},
            ...
            {50153,@"Command not allowed given instruction, or command, was not allowed since the robot program was executing in a hold state."},
            {50154,@"Command not allowed SingArea\Wrist mode interpolation is not supported for the arg robot."},
            ...
            {50184,@"Corr. vector warning Sensor correction vector calculations failed due to previous erro"},
            {50185,@"Corr. vector warning Sensor correction vector calculations failed due to previous error."},
            {50186,@"Missing function Not possible to run robot arg with coordinated base frame. Function not installed in this system."},
            {50187,@"Missing function Not possible to coordinate user frame with robot arg Function not installed in this system."},
            ...
            {50239,@"Optimal Em. Stop change Optimal Emergency Stop changed to Electrical brake mode because of acceleration limitation."},
            {50240,@"Optimal Em. Stop change Optimal Emergency Stop changed to Electrical brake mode because of torque limitation."},
            ...
            {50261,@"WZone outside work area The definition of minimum limit for the World Zone arg is outside work area for: argargarg..."},
            {50262,@"WZone outside work area The definition of maximum limit for the World Zone arg is outside work area for: argargarg..."},
            ...
            {50272,@" Manipulator configuration Failed to read arg data for arg , from the configuration file"},
            {50273,@" Manipulator configuration Incorrect configuration parameter arg for arg. "},
            {50274,@" Manipulator configuration Failed to read or create arg with the name: arg. If the current instance exists it is read, else it is created."},
            {50275,@" Manipulator configuration Failed to read next arg name. The previous instance is ok, but the next instance cannot be read."},
            {50276,@" Manipulator configuration Standard servo queue length (arg) out of range (min=1, max=arg)."},
            {50277,@" Manipulator configuration Number of joints (arg) in dynamic group override. Allowed number is arg."},
            {50278,@" Manipulator configuration Failed to configure servo gun (arg)."},
            {50279,@" Manipulator configuration Servo tool change requires option Servo Tool Change."},
            ...
            {71077,@"Communication error from rtp2 Not possible to deliver the received message"},
            {71078,@"Communication error from rtp3 The response from the device has an invalid frame sequence."},
            ...
            {71399,@"Communication error from bosv25 Not possible to deliver the received message."},
            {71400,@"Communication error from bosv26 The response from the device has an invalid frame sequence."},
            ...
            {71505,@"Device command syntax error Could´t send device command to I/O device bcs there is a syntax error in command path string. Missing comma."},
            ...
            {71573,@"PROFINET configuration mismatch  I/O device reported a different slot configuration then configured in the system.Module in slot is of wrong type"},
            {71574,@"PROFINET configuration mismatch  Module in slot  is correct but one or several submodules indicate errors."},
            {71575,@"PROFINET configuration mismatch There is no module present in slot arg however one is configured in the configuration."},
            ...
            {110203,@"Application error The maximum program number, 'DA_PROG_MAX' is above the num data type limit"},
            ...
            {110207,@"Application error Process number arg of application arg was already installed"},
            ...
            {110210,@"Application error The program number arg is above the num data type limit"},
            ...
            {110214,@"Application error arg tried to use a non existent application descriptor."},
            {110216,@"Application error Attempt to install a process number outside it's limits."},
            ...
            {110222,@"Application error The internal process data type lacks daintdata as first element."},
            {110223,@"Application error The user data type definitions exceed the maximum data storage size."},
            {110224,@"Application error The user data type definitions does not correspond to what was defined."},
            {110226,@"Application error An error occurred while attempting to reload the Power Failure area"},
            {110229,@"Application error Error from arg . The data type definitions exceed the maximum data storage size."},
            {110230,@"Application error Not possible to execute instruction in motors off state for servo tool arg ."},
            {110231,@"Application process time warning "},
            {110300,@"Parameter error The max string length of the parameter arg is 5 characters"},
            {110302,@"Parameter error The specified signal arg in the instruction arg has no reference"},
            {110303,@"Parameter error The optional signals \arg and \arg must be used together."},
            {110304,@"Parameter error The parameter arg of the instruction arg is not an array."},
            {110305,@"Parameter error The dimension of the data array arg is to big"},
            {110306,@"Parameter error The array arg of the instruction arg is not right defined."},
            {110307,@"Parameter error The event time array element arg.arg is less than 0"},
            {110308,@"Parameter error The data selector arg in the instruction arg is not valid"},
            ...
            {110415,@"Weld Off Supervision timeout The ArcEst signal was not reset at the end of the weld within the specified time"},
            {110416,@"Weld Off Supervision timeout The WeldOK signal was not reset at the end of the weld within the specified time."},
            ...
            {110435,@"User defined signal supervision User defined signal defined by USERIO1 went low during welding."},
            {110436,@"User defined signal supervision User defined signal defined by USERIO2 went low during welding"},
            {110437,@"User defined signal supervision User defined signal defined by USERIO3 went low during welding."},
            {110438,@"User defined signal supervision User defined signal defined by USERIO4 went low during welding."},
            {110439,@"User defined signal supervision User defined signal defined by USERIO5 went low during welding."},
            {110440,@"User defined signal supervision User defined signal arg defined by USERIO1 went low during welding."},
            {110441,@"User defined signal supervision User defined signal arg defined by USERIO2 went low during welding."},
            {110442,@"User defined signal supervision User defined signal arg defined by USERIO3 went low during welding."},
            {110443,@"User defined signal supervision User defined signal arg defined by USERIO4 went low during welding."},
            {110444,@"User defined signal supervision User defined signal arg defined by USERIO5 went low during welding"},
            ...
            {110460,@"Weld Error Recovery PROC Parameters was loaded by arg Configuration of Weld Error Recovery is Complete"},
            {110461,@"Weld Error Recovery PROC Parameters for Weld Error Recovery could not be loaded in task arg"},
            {110462,@"Weld Error Recovery Robot arg moved from error location. Robot will attempt to move back to the error location"},
            {110463,@"Weld Error Recovery Failed "},
            {110464,@"EquipmentClass Error The Specified EquipmentClass arg could not be unloaded."},
            {110465,@"EquipmentClass Error The Specified EquipmentClass arg could not be found at path: arg"},
            {110466,@"RW Arc Installation Weld System arg (of arg installed) started in task arg Active EquipmentClass arg"},
            {110467,@"RW Arc Installation Deactivation and Unload of EquipmentClass arg failed."},
            ...
            {110490,@"Weld Error Recovery IO Error The breakout input was left on. The external device must reset the signal."},
            {110491,@"Weld Error Recovery IO Error Invalid response arg supplied on signal agiWER_Response."},
            {110492,@"Weld Error Recovery IO Error Escape option is not available. Request has been changed to MoveOut."},
            {110493,@"Weld Error Recovery IO Error System is waiting for the diWERAck input to go low."},
            {110494,@"Weld Error Recovery IO Error Supplied value on giWER_Response (arg) is not within range: (arg)"},
            {110495,@"Weld Error Recovery IO Error The Weld Error Recovery IO Interface is successfully configured for arg and is ready for use"},
            ...
            {110509,@"Weld Repair notification Welding was interrupted in task arg at seam arg An attempt to re-weld the interrupted seam will now be made"},
            {110510,@"Weld Repair notification The weld seam arg was successfully re-welded in task arg"},
            {110511,@"Weld Repair notification weld seam  in procedure in task was skipped. maximum number of weld errors (arg) on seam arg was reached."},
            {110512,@"Weld Repair notification weld seam  in procedure in task arg was skipped. maximum number of retries (arg) on seam arg was reached."},
            ...
            {110524,@"Fronius Welding Equipment mFroniusModes.sys loaded in task: arg. Updated mFroniusModes.sys"},
            {110525,@"Fronius TPSi Welding Equipment "},
            {110526,@"Fronius Welding Equipment No communication with IO unit arg in task: arg."},
            {110527,@"Fronius TPSi Welder not ready "},
            {110600,@"Spot Startup completed "},
            {110601,@"Invalid configuration The number of configured equipments in the system are less than one(1)."},
            {110602,@"Invalid configuration The number of configured equipments are more than 10"},
            ...
            {110818,@"Dispense Error Not possible to change equipment in the middle of a string."},
            ...
            {111106,@"Trig distance warning Trig distance is too long for conveyor arg. Trig distance is set to maximum."},
            {111107,@"Trig distance warning Trig distance is too short for conveyor limitation of trig distance is depended on value for  Encoder parameter"},
            {111108,@"Failed to send data "},
            {111109,@"Failed to open signal An error occured when opening Position Generator signal: arg for itemsource: arg"},
            {111110,@"Failed to open signal An error occured when opening Trig signal: arg for itemsource: arg."},
            {111111,@"Failed to open signal An error occured when opening Strobe signal: arg for itemsource: arg."},
            {111112,@"Failed to open signal An error occured when opening Robot Execution signal: arg for itemsource: arg."},
            {111113,@"Failed to open signal An error occured when opening Queue Idle signal: arg for itemsource: arg."},
            {111114,@"Failed to open signal An error occured when opening Position Available signal: arg for itemsource: arg"},
            {111115,@"Failed to open signal An error occured when opening Conveyor Control signal: arg for itemsource: arg."},
            ...
            {111504,@"BullsEye Error RangeCheck feature does not support coordinated work objects."},
            ...
            {111509,@"BullsEye Error An error occurred while unloading the reference data module."},
            {111510,@"BullsEye Error An error occured while reading data from the stored reference data module."},
            ...
            {111519,@"BullsEye RangeCheck Failed Joint Limit Check failed for a Twist of arg and a Tilt of arg"},
            {111520,@"BullsEye RangeCheck Failed Singularity Check failed for a Twist of arg and a Tilt of arg"},
            {111521,@"BullsEye RangeCheck Failed No solution could be found within acceptable Joint Limits and Singularity checks."},
            {111522,@"BullsEye RangeCheck Failed No solution could be found within acceptable Joint Limits & Singularity checks with adequate face-plate clearance."},
            ...
            {111534,@"BullsEye Day1 TCP Updated The Day1 TCP has been updated due to a change in the beam location."},
            {111535,@"BullsEye Day1 TCP Updated The operator has permitted the Day1 TCP to be updated."},
            ...
            {111551,@"SmarTac Configuration Error Signal names supplied in PROC cannot be found in EIO"},
            {111552,@"SmarTac Configuration Error An error occurred while attempting to establish connections to I/O."},
            {111553,@"SmarTac Configuration Error SmarTac was unable to find: arg in PROC configuration."},
            {111554,@"SmarTac Configuration Error SmarTac tried to access an illegal type: arg in PROC configuration."},
            {111555,@"SmarTac Configuration Error SmarTac experienced an unknown error trying to access: arg in PROC configuration."},
            {111556,@"SmarTac Result "},
            {111557,@"SmarTac Search Override Optional limit exceeded on Search_1D!"},
            {111558,@"SmarTac Search Override Default search result selected after failed search."},
            {111559,@"SmarTac Result Part detected."},
            {111560,@"SmarTac Search Override Default search result selected. No part found during part search"},
            {111561,@"SmarTac Search Override Default search result selected. No part found during part search."},
            {111562,@"SmarTac Result Location Result: arg Width Result: arg Search Type: Groove Search Name: arg"},
            {111563,@"SmarTac Search Override Default search result was selected after a failed Groove Search. Manual override selected"},
            {111564,@"SmarTac Text Error "},
            {111565,@"SmarTac Error Recovery IO Error The breakout input arg was left on. The external device must reset the signal."},
            {111566,@"SmarTac Error Recovery IO Error External device responded with an invalid command. "},
            {111567,@"Controller Option 657-1 missing "},
            {111601,@"DB Table Creation Failed "},
            {111602,@"DB Table Created "},
            {111603,@"Production Monitor Error Configuration Error. Production Monitor was unable to find: arg in the PROC configuration"},
            {111604,@"Production Monitor Error Configuration Error. Production Monitor tried to access an illegal type: arg in the PROC configuration."},
            {111605,@"Production Monitor Error Configuration Error. Production Monitor experienced an unknown error trying to access: in the PROC configuration."},
            {111606,@"Production Monitor Error Text Resource Error"},
            {111607,@"Production Monitor DB Creating the tblCycRes table in the WebWare database"},
            {111608,@"DB Table Creation Failed "},
            {111609,@"DB Table Created The table, tblCycRes, was successfully added to the WebWare database"},
            {111610,@"Production Monitor DB Creating the tblSeamRes table in the WebWare database..."},
            {111611,@"DB Table Creation Failed "},
            {111612,@"DB Table Created The table, tblSeamRes, was successfully added to the WebWare database."},
            {111613,@"Production Monitor DB Creating the tblSeamEv table in the WebWare database..."},
            ...
            {111621,@"Production Monitor Error The reference data module for part, arg, is already loaded."},
            {111622,@"Production Monitor Error The reference data module for part, arg, is already loaded"},
            {111623,@"Production Monitor Error The reference data module for part, arg, could not be unloaded"},
            {111624,@"Production Monitor Error The reference data for part, arg, could not be read from the stored data file."},
            {111625,@"Monitor Data Saved "},
            {111626,@"Production Monitor Error An error occured while saving reference data file for part, arg."},
            {111627,@"Production Monitor Timer Reset The cycle timer has been reset to prevent a possible overflow"},
            {111628,@"Production Monitor Timer Reset The arc timer has been reset to prevent a possible overflow"},
            ...
            {111641,@"DB Table Creation Failed WebWare database tables must be created in Automatic Mode"},
            {111642,@"Production Monitor "},
            {111643,@"Production Monitor Error Seam length for seam arg is outside the specified range."},
            {111644,@"Production Monitor Error Seam length for seam arg is outside the specified range."},
            {111645,@"Production Monitor Error Seam arg was not welded or is missing. Nominal seam length is arg mm."},
            {111646,@"Production Monitor Warning Lower limit warning for seam arg. Stored reference value for lower limit is -arg mm."},
            {111647,@"Production Monitor Warning Upper limit warning for seam arg. Stored reference value for upper limit is +arg mm."},
            {111648,@"Production Monitor Warning Comparision factor warning for seam arg. Stored reference value for the comparision factor is arg %"},
            {111649,@"Production Monitor Warning The specified seam number arg for seam arg can not be found in the reference file."},
            {111650,@"Production Monitor Warning No seam local data is specified for the current seam."},
            {111651,@"Production Monitor Warning Stored reference value for seam number is arg but programmed seam number is arg."},
            {111701,@"Torch Services Error Torch services MechClean configuration error. IO arg NOT found"},
            {111702,@"Torch Services Error Torch services MechClean configuration error. Check PROC cfg domain."},
            {111703,@"Torch Services Error Torch Services was unable to find: arg/arg in PROC configuration."},
            {111704,@"Torch Services Error Torch Services tried to access an illegal type: arg/arg in PROC configuration."},
            {111705,@"Torch Services Error Torch Services experienced an unknown error trying to access: arg/arg in PROC configuration."},
            {111706,@"Torch Services Error Torch Services was unable to find: arg/arg in PROC configuration."},
            {111707,@"Torch Services Error Torch Services tried to access an illegal type: arg/arg in PROC configuration."},
            {111708,@"Torch Services Error Torch Services experienced an unknown error trying to access: arg/arg in PROC configuration."},
            {111709,@"Torch Services Error Torch services Wirecut configuration error. IO arg NOT found."},
            {111710,@"Torch Services Error Torch services MechClean configuration error. Check PROC cfg domain."},
            {111711,@"Torch Services Error Torch services Spray configuration error. Check PROC cfg domain."},
            {111712,@"Torch Services Error Torch services Spray configuration error. Torch Services was unable to find: arg/arg in PROC configuration."},
            {111713,@"Torch Services Error Torch services Spray configuration error. Torch Services tried to access an illegal type: arg/arg in PROC configuration."},
            {111714,@"Torch Services Error Torch services Spray configuration error. Torch Services experienced an unknown error trying to access: arg/arg in PROC configuration."},
            ...
            {111751,@"Navigator Configuration Error Navigator configuration error. IO arg NOT found."},
            {111752,@"Navigator Configuration Error Navigator configuration error. Navigator was unable to find: arg/arg in PROC configuration."},
            {111753,@"Navigator Configuration Error Navigator configuration error. Navigator tried to access an illegal type: arg/arg in PROC configuration."},
            {111754,@"Navigator Configuration Error Navigator experienced an unknown error trying to access: arg/arg in PROC configuration."},
            ...
            {111957,@"No active project Instruction/function arg has detected that the project has been stopped."},
            ...
            {112201,@"Failed to Open Signal An error occurred when opening the Error Source Signal."},
            {112202,@"Failed to Open Signal An error occurred when opening the Event Message Signal."},
            ...
            {112503,@"WDM Failed to Read WDM_SETTINGS The 'chart' setting in the WDM_SETTINGS section of the PROC could not be read."},
            {112504,@"WDM Failed to Read WDM_SETTINGS The IO signal setting in the WDM_SETTINGS section of the PROC could not be read."},
            {112505,@"WDM Failed to Read WDM_STABILITY WDM_STABILITY section of the PROC could not be found. Default values have been applied."},
            {112506,@"WDM Failed to Read WDM_STABILITY WDM_STABILITY section of the PROC could not be read."},
            {112507,@"WDM Failed to Read WDM_SIGNATURE The WDM_SIGNATURE or WDM_SIGNATURE_DATA section of the PROC could not be found."},
            {112508,@"WDM Failed to Read WDM_SIGNATURE The WDM_SIGNATURE or WDM_SIGNATURE_DATA section of the PROC could not be read"},
            ...
            {112513,@"WDM Signature File Inaccessible The stored signature could not be written to."},
            ...
            {112520,@"WDM File Access Error Could not open the binary data file described below"},
            {112521,@"WDM File Access Error Could not close a binary data file."},
            {112522,@"WDM File Access Error Could not seal the binary data file described below"},
            ...
            {132700,@"Dip in main power voltage, additional energy pack in PDB has been activated "},
            ...
            {133000,@"IPS Cfg Error Error accessing IPS config file arg. This config file is stored on one of the installed IPS nodes."},
            {133001,@"IPS Cfg Error Error in IPS config file arg in line arg. This IPS config file is located on one of the IPS nodes."},
            {133002,@"IPS Cfg Error Faulty argument: arg, in IPS config file arg in line arg. This IPS config file is located on one of the IPS nodes"},
            {133003,@"IPS Cfg Error Error in IPS config file arg in line arg. This IPS config file is located on one of the IPS nodes."},
            {133004,@"IPS Cfg Error Error in token arg, in IPS config file arg in line and character position .  IPS config file is located on one of the IPS nodes."},
            {133005,@"IPS License Error License server is not found. Could not obtain option: arg"},
            ...
            {133009,@"IPS License Error License file is not found. File name must be 'option.lic'. Could not obtain option: arg"},
            ...
            {133013,@"IPS License Error Protocol error in communication towards license server."},
            {133014,@"IPS License Error Communication fault. License server has been found, but communication is lost."},
            {133200,@"Trig error "},
            {133201,@"arg:Locked "},
            {133202,@"arg:Disabled "},
            {133203,@"arg:Disconn "},
            ...
            {133341,@"Sms board comm. lost SDI board has lost contact with the serial measurement board,"},
            {133342,@"Sms board comm. lost SDI board has lost contact with the serial measurement board,"},
            {133343,@"Sms board comm. lost SDI board has lost contact with the serial measurement board,"},
            ...
            {134055,@"Configuration error Could not add arg.xml into the configuration settings. There are too many configuration files."},
            ...
            {134060,@"XML-parser error Third dimension passed to XML-parser was not big enough."},
            ...
            {134065,@"CSV-parser error Encountered a row number that was not a positive integer in"},
            ...
            {134210,@"Move cartridge error. There is already a cartridge at the 'To' address: arg"},
            {134211,@"Move cartridge error. There is already a cartridge at the 'From' address: arg"},
            {134212,@"Move cartridge error. An impossible to reach 'From' address was specified: arg"},
            {134213,@"Move cartridge error. An impossible to reach 'To' address was specified: arg"},
            {134214,@"Move cartridge error. The cartridge at 'From' address is not allowed at the 'To' address. Cartridge: arg Address: arg"},
            {134215,@"Exchange cartridge error There is no cartridge to get at delivery address."},
            {134216,@"Exchange cartridge error Cannot find suitable station to put returned cartridge in."},
            {134217,@"Exchange cartridge error There is no cartridge at the 'From' address: arg"},
            {134218,@"Exchange cartridge error An impossible to reach 'From' address was specified: arg"},
            ...
            {134230,@"Integrity check error. An unexpected cartridge was found during integrity check at address: arg"},
            {134231,@"Integrity check error. Did not find expected cartridge during integrity check at address: arg"},
            {134240,@"Maintenance operation error Unknown maintenance operation specified: arg"},
            {134241,@"Maintenance operation error Unknown cartridge process operation specified: arg"},
            {134242,@"Maintenance operation error Not possible to move a cartridge from or to a hole"},
            {134243,@"Maintenance operation error Unknown cartridge specified: arg"},
            {134244,@"Maintenance operation error No IFS solution for the cartridge specified: arg"},
            ...
            {134501,@"Parking unit move error Unable to move parking unit to applicator arg. Timeout while waiting for semaphore."},
            {134502,@"Parking unit move error Unable to move parking unit to applicator arg. Manipulator is still in material change position."},
            {134503,@"Parking unit move error Unable to move parking unit to applicator arg. Cleaning unit is not in lower position."},
            {134504,@"Parking unit move error Unable to move parking unit to applicator arg. CBS arm is not in upper position."},
            {134505,@"Parking unit move error Unable to move parking unit to applicator arg. Timeout while waiting for sensor feedback."},
            {134511,@"Cleaning unit move error. Unable to move cleaning unit up. Timeout while waiting for semaphore."},
            {134512,@"Cleaning unit move error. Unable to move cleaning unit up. Parking unit is not in a valid position."},
            {134513,@"Cleaning unit move error. Unable to move cleaning unit up. Timeout while waiting for sensor feedback."},
            {134514,@"Cleaning unit move error. Unable to move cleaning unit down. Timeout while waiting for semaphore"},
            {134515,@"Cleaning unit move error. Unable to move cleaning unit down. Timeout while waiting for sensor feedback."},
            ...
            {134523,@"Applicator chucking failed Manipulator is not in material change position"},
            ...
            {134528,@"Applicator un-chucking failed. Manipulator is not in material change position."},
            ...
            {134735,@"Inkjet image loading error. The image file 'arg' could not be found. Either the image file or folder is missing."},
            {134736,@"Inkjet image loading error. persistent variable 'arg' could not be found. Controller and external image loading application will not communicate"},
            {134737,@"Inkjet image loading error. External image loading application failed to create the default configuration file."},
            {134738,@"Inkjet image loading error. The print engine serving the printer head failed to start."},
            {134739,@"Inkjet image loading error. Setting bits per pixel to 'arg' returned error code 'arg'."},
            {134740,@"Inkjet image loading error. Setting bits per pixel to 'arg' returned error code 'arg'."},
            {134741,@"Inkjet image loading error. Setting the FIFO for image id 'arg' returned error code 'arg'"},
            {134742,@"Inkjet image loading error. API failed to load the bitmap image 'arg' from path 'arg'"},
            {134743,@"Inkjet image loading error. PI failed to set image 'arg' to inkjet controller board and returned error code 'arg'."},
            {134744,@"Inkjet image loading error. API failed sending the 'EndDoc' command for image id 'arg' to inkjet controller board and returned error code 'arg'."},
            {134745,@"Inkjet image loading error. API failed sending the 'arg' command and returned error code 'arg"},
            ...
            {134767,@"Safety signal for the pump is switched off. This occurred in a state that it is possible to recover from"},
            {134768,@"Safety signal for the pump is switched off. This happened in a state where there is great uncertainty about what is in the cavities of the head or the process."},
            ...
            {135010,@"Material change initialization error Unable to subscribe to interface signals."},
            {135011,@"Material change initialization error Unable to open material change configuration file: arg"},
            {135012,@"Material change initialization error The file 'arg' is missing the 'arg' tag."},
            {135013,@"Material change initialization error The file 'arg' contains an invalid system type: arg"},
            {135021,@"Material change index file error Unable to open index file: arg"},
            {135022,@"Material change index file error. The file 'arg' contains an invalid index: arg"},
            {135031,@"Material change system index error "},
            {135041,@"Material change cavity index error. Material index arg on cavity 'arg' does not have a cleaning sequence."},
            {135042,@"Material change cavity index error. Material index arg on cavity 'arg' does not have a filling sequence."},
            {135051,@"Material change sequence error. Unable to open sequence file: arg"},
            {135052,@"Material change sequence error. The file 'arg' contains invalid data on line: arg"},
            {135053,@"Material change sequence error. Failed to execute python file 'arg'. Got Python exception: arg"},
            {135054,@"Material change sequence error. The file 'arg' contains an invalid signal name: arg"},
            {135055,@"Material change sequence error. Failed to execute python call 'arg' from 'arg'. Got Python exception: arg"},
            {135061,@"Material change signal error. Communcation against IPS is down."},
            {135062,@"Material change signal error. Communcation against IPS has been re-established."},
            {135063,@"Material change signal error. Failed to read signal number arg on device: arg"},
            {135064,@"Material change signal error. Failed to write signal number arg on device: arg"},
            {135071,@"Material change alarm monitor error. Invalid signal name in configuration file: arg"},
            {135072,@"Material change alarm monitor error. Failed to subscribe to signal number arg on device: arg"},
            ...
            {170002,@"Connected Services Agent started Robot controller has successfully registered at ABB Connected Services Center."},
